							...
							<div class="container-fluid">
								...
								<div class="passo" id="passo1">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<button type="button" class="btn btn-lg btn-default btn-block upload"><i class="fal fa-box-full" aria-hidden="true"></i>&nbsp; Importar Clientes</button>
										</div>
									...
									<div class="col-md-2">
										...
										<script>
											$(".tmplt").click(function(e) {
												e.preventDefault();
												location.href = "https://adm.bunker.mk/media/clientes/template_importacao_clientes_revisada_codigo.xlsx";
											});
										</script>
									</div>
									<div class="col-md-2">
		...
		$(document).ready(function() {
			...
			$('.next1').click(function() {
				...
				if ($('#FEZ_UPLOAD').val() == "N") {
					...
					$.alert({
						title: "Mensagem",
						content: "Voce precisa importar a lista de clientes(.xlsx) para poder avançar.",
					});
		...
		function uploadFile(idField, typeFile) {
			...
			if (ext == 'xlsx') {
				...
				$.ajax({
					...
					url: '../uploads/uploadImportClientes.php?acao=gravar&id=<?php echo $cod_empresa; ?>&idx=<?= $cod_persona ?>',
					type: 'POST',
					data: formData,
					processData: false,
					contentType: false,
					success: function(data) {
						...
						if (data.trim() != "") {
							$.alert({
								title: "Erro ao efetuar a importação",
								content: data,
								type: 'red'
							});
							return;
						...
						$.ajax({
							type: "POST",
							url: "../uploads/uploadImportClientes.php?acao=ler&id=<?php echo $cod_empresa; ?>&idx=<?= $cod_persona ?>",
							/*beforeSend:function(){
