        ...
        if ($opcao != '') {
            ...
            switch ($opcao) {
                ...
                case 'ALT':
                    ...
                    $sqlUpdate = "UPDATE FILTROS_CLIENTE SET
                ...
                case 'EXC':
                    ...
                    $sqlExc = "DELETE FROM FILTROS_CLIENTE
								WHERE COD_FILTRO = $cod_filtro";
                        ...
                        action: function () {
                            ...
                            $.confirm({
                                ...
                                content: function () {
                                    var self = this;
                                    return $.ajax({
                                        url: "ajxFiltrosDinamicos.do?opcao=exportar&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa)?>",
...
function reloadPage(idPage) {
        $.ajax({
            type: "POST",
            url: "ajxFiltrosDinamicos.do?opcao=paginar&id=<?php echo fnEncode($cod_empresa); ?>&idPage=" + idPage + "&itens_por_pagina=<?php echo $itens_por_pagina; ?>",
            data: $('#formulario').serialize(),
            beforeSend: function () {
                $('#relatorioConteudo').html('<div class="loading" style="width: 100%;"></div>');
            },
...
function agrupaCombo(selectObject) {
    ...
    $.ajax({
        type: "POST",
        url: "ajxFiltrosDinamicos.do?opcao=paginar&id=<?php echo fnEncode($cod_empresa); ?>&idPage=1&itens_por_pagina=<?php echo $itens_por_pagina; ?>",
        data: $('#formulario').serialize(),
        beforeSend: function () {
            $('#relatorioConteudo').html('<div class="loading" style="width: 100%;"></div>');
        },
    ...
    //$.ajax({
        //type: "POST",
        //url: "ajxFiltrosDinamicos.do?opcao=retornar&id=<?php echo fnEncode($cod_empresa);?>",
