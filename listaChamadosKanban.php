		...
		<div class="portlet portlet-bordered">
			...
			<div class="portlet-body">
				...
				<div class="login-form">
					...
					$sqlCha = "SELECT COD_CHAMADO, NOM_CHAMADO, DES_SAC, COD_USUARIO FROM SAC_CHAMADOS
					WHERE NUM_PRIORIDADE = 1 AND COD_STATUS NOT IN(10,6)
					ORDER BY NUM_ORDENAC2 DESC";
					$arrayCham = mysqli_query($connAdmSAC->connAdm(),$sqlCha);
					//fnEscreve($sqlCha);
					?>

					<section class="lists-container">
						<div class="list">
							<h3 class="list-title">Fila de Prioridades</h3>
							<ul class="list-items">
								<li class="movable"></li>
								<!-- Itens de chamados existentes -->
								<?php
								while($qrCham = mysqli_fetch_assoc($arrayCham)){

									$des_sac = $qrUsu['DES_SAC'];

									?>
									<li id="<?=$qrCham['COD_CHAMADO']?>" class="movable">
										<div class="row card-chamado">
											...
											<div class="col-xs-12">
												...
												<div class="row">
													...
													<div class="col-xs-10">
														<h4 class="title-chamado"><?=$qrCham['NOM_CHAMADO']?></h4>
													</div>

													<div class="col-xs-3 text-right">
														<small><p class="text-muted">#<?=$qrCham['COD_CHAMADO']?></p></small>
													</div>
												...
												<div class="row footer-chamado">
													...
													<div class="col-xs-7 btn-card">
														<div class="col-xs-10">
															<ul class="menu menu-up-left" data-menu data-menu-toggle="#menu-toggle_<?=$qrCham['COD_CHAMADO']?>">
																<li class="text-info">
														...
														<a href="javascript:void(0)" class="col-xs-2 text-right" id="menu-toggle_<?=$qrCham['COD_CHAMADO']?>"><span class="far fa-ellipsis-v"></span></a>
													</div>
						...
						WHERE SC.COD_STATUS NOT IN(10,6)
								...
								<div class="list">
									...
									<ul class="list-items">
										...
										while($qrUsu = mysqli_fetch_assoc($arrayUsu)){
											...
											<li id="drop_<?=$qrUsu['COD_CHAMADO']?>" class="movable" draggable="true">
