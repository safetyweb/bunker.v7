										...
										<fieldset>
											<legend>Dados Gerais</legend> 
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group">
															<label for="inputName" class="control-label">Nome do Menu</label>
															<input type="text" class="form-control input-sm" name="NOM_MENUSIS" id="NOM_MENUSIS" maxlength="29" required>
													  ...
													  {														  
														...
														echo"
															<tr>
															  ...
															  <td>".$qrBuscaModulos['COD_MENUSIS']."</td>
