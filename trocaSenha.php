...
<?php
	...
	if( $_SERVER['REQUEST_METHOD']=='POST' )
	{
		...
		else
		{
			...
			$senha_atual = fnLimpacampo($_REQUEST['SENHA_ATUAL']);
			$senha_nova = fnLimpacampo($_REQUEST['SENHA_NOVA']);
			$senha_confirma = fnLimpacampo($_REQUEST['SENHA_CONFIRMA']);
			...
			if ($opcao != ''){
				...
				$qrSenhaUsuario = mysqli_fetch_assoc($arrayQuery);

				$senha_bd = fnDecode($qrSenhaUsuario['DES_SENHAUS']);
				
				//compara senha do bd com a atual informada
				if ($senha_bd != $senha_atual){
					$confereSenhaAtual = "N";
					$msgRetorno = "Senha atual informada está <strong>incorreta!</strong>";
					$msgTipo = 'alert-danger';
				}else{
					$confereSenhaAtual = "S";
				}
				
				//compara senhas iguais
				if ($confereSenhaAtual == "S"){
				
					if ($senha_nova != $senha_confirma){
						$confereSenhaNova = "N";
						$msgRetorno = "Confirmação da nova senha <strong>não confere!</strong>";
						$msgTipo = 'alert-danger';
					}else{
						$confereSenhaNova	= "S";

						$sql3 = "update USUARIOS set DES_SENHAUS = '" .fnEncode($senha_confirma). "', SENHA_INI = 1 where COD_EMPRESA = '".$_SESSION["SYS_COD_EMPRESA"]."' and COD_USUARIO = '".$_SESSION["SYS_COD_USUARIO"]."'" ;
						fnEscreve($sql3);
						$arrayQuery = mysqli_query($connAdm->connAdm(),$sql3) or die(mysqli_error());
					
						$msgRetorno = "Senha alterada com <strong>sucesso!</strong>";
								...
								<div class="portlet-body">
									...
									<div class="login-form">
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm leitura" readonly="readonly" name="NOM_USUARIO" id="NOM_USUARIO" maxlength="50" data-error="Campo obrigatório" value="<?php echo $nom_usuario; ?>" required>
										...
										<fieldset>
											<legend>Dados da Senha</legend> 
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															<label for="inputName" class="control-label">Digite sua senha atual</label>
															<input type="password" class="form-control input-sm" name="SENHA_ATUAL" id="SENHA_ATUAL" maxlength="15" data-error="Campo obrigatório" value="">
															<div class="help-block with-errors"></div>
														</div>
													</div>	
													...
													<div class="col-md-3">
														<div class="form-group">
															<label for="inputName" class="control-label">Digite a nova senha</label>
															<input type="password" class="form-control input-sm" name="SENHA_NOVA" id="SENHA_NOVA" maxlength="15" data-error="Campo obrigatório" value="">
															<div class="help-block with-errors"></div>
														</div>
													</div>	
													...
													<div class="col-md-3">
														<div class="form-group">
															<label for="inputName" class="control-label">Confirme a nova senha</label>
															<input type="password" class="form-control input-sm" name="SENHA_CONFIRMA" id="SENHA_CONFIRMA" maxlength="15" data-error="Campo obrigatório" value="">
															<div class="help-block with-errors"></div>
														</div>
													</div>
										...
										<div class="form-group text-right col-lg-12">
											...
											<button type="submit" name="ALT" id="ALT" class="btn btn-primary getBtn"><i class="fa fa-unlock-alt" aria-hidden="true"></i>&nbsp; Alterar Senha</button>
