...
if(!array_key_exists('authorizationCode', $passmarka))
{
   ...
   $erroinformation='{"errors": [
    ...
    echo json_encode(json_decode($erroinformation,true),JSON_PRETTY_PRINT);
     exit();  
}
...
$Capturajson= json_decode(file_get_contents("php://input"),true);
    ...
    $senha = htmlspecialchars(mysqli_real_escape_string($conexaotmp,$Capturajson['SENHA']), ENT_QUOTES, 'UTF-8');
