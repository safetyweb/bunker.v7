							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label for="inputName" class="control-label">Laboratorio</label>
										<input type="text" class="form-control input-sm" name="LABORATORIO" id="LABORATORIO" maxlength="50" value="<?php echo $laboratorio; ?>">
...
<script type="text/javascript">
	...
	function reloadPage(idPage) {
		...
		$.ajax({
			type: "POST",
			url: "ajxListaLaboratorios.do?opcao=paginar&idPage=" + idPage + "&itens_por_pagina=<?php echo $itens_por_pagina; ?>",
					...
					action: function() {
						...
						$.confirm({
							...
							content: function() {
								var self = this;
								return $.ajax({
									url: "ajxListaLaboratorios.do?opcao=exportar&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa); ?>",
									data: $('#formulario').serialize(),
									method: 'POST'
