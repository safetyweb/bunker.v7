<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		else
		{
			...
			$des_plataforma = fnLimpaCampo($_REQUEST['DES_PLATAFORMA']);
			$abv_plataforma = fnLimpaCampo($_REQUEST['ABV_PLATAFORMA']);
			...
			if ($opcao != ''){ 
				...
				$sql = "INSERT INTO SAC_PLATAFORMA(
						DES_PLATAFORMA,
						ABV_PLATAFORMA,
						DES_COR,
						DES_ICONE) 
	    		...
	    		elseif ($opcao == 'EXC'){
	    		$sql = "DELETE FROM SAC_PLATAFORMA WHERE COD_PLATAFORMA = $cod_plataforma";
	    		...
	    		$sql = "UPDATE SAC_PLATAFORMA SET 
			    		DES_PLATAFORMA='$des_plataforma',
			    		ABV_PLATAFORMA='$abv_plataforma',
			    		DES_COR='$des_cor',
			    		DES_ICONE='$des_icone'

			    		WHERE COD_PLATAFORMA=$cod_plataforma
			    		";
...
?>
						...
						<div class="col-md12 margin-bottom-30">
							...
							<div class="portlet portlet-bordered">
								...
								<div class="portlet-body">
									...
									<?php $abaInfoSuporte = 1269; include "abasSuporteConfig.php"; ?>
												...
												<div class="row">
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm leitura" readonly="readonly" name="COD_PLATAFORMA" id="COD_PLATAFORMA" value="">
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm" name="DES_PLATAFORMA" id="DES_PLATAFORMA" maxlength="50" required>
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm" name="ABV_PLATAFORMA" id="ABV_PLATAFORMA" maxlength="20" required>
															<div class="help-block with-errors"></div>
														</div>
													</div>
													...
													while ($qrBuscaModulos = mysqli_fetch_assoc($arrayQuery))
													  ...
													  ?>
														<tr>
															...
															<td><?php echo $qrBuscaModulos['COD_PLATAFORMA']; ?></td>
															<td><?php echo $qrBuscaModulos['DES_PLATAFORMA']; ?></td>
															<td><?php echo $qrBuscaModulos['ABV_PLATAFORMA']; ?></td>
															<td align='center'><span style='color: <?php echo $qrBuscaModulos['DES_COR'];?>;' class='<?php  echo $qrBuscaModulos['DES_ICONE'];?>' ></td>
														</tr>

														<input type='hidden' id='ret_COD_PLATAFORMA_<?php echo $count; ?>' value='<?php echo $qrBuscaModulos['COD_PLATAFORMA']; ?>'>
														<input type='hidden' id='ret_DES_PLATAFORMA_<?php echo $count; ?>' value='<?php echo $qrBuscaModulos['DES_PLATAFORMA']; ?>'>
														<input type='hidden' id='ret_ABV_PLATAFORMA_<?php echo $count; ?>' value='<?php echo $qrBuscaModulos['ABV_PLATAFORMA']; ?>'>
	...
	<script type="text/javascript">
		...
		function retornaForm(index){
			$("#formulario #COD_PLATAFORMA").val($("#ret_COD_PLATAFORMA_"+index).val());
			$("#formulario #DES_PLATAFORMA").val($("#ret_DES_PLATAFORMA_"+index).val());
			$("#formulario #ABV_PLATAFORMA").val($("#ret_ABV_PLATAFORMA_"+index).val());
