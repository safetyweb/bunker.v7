...
//ofertasTicket 
    ...
    if($arraybusca['COD_CLIENTE']==''){$cod_client=0;}else{$cod_client=$arraybusca['COD_CLIENTE'];}
...
/////////ARRAY PARA GRAVA TKT
    ...
    if($LOG_EMISDIA=="S"){$DAT_VALIDADE="'".date('Y-m-d')."',";}else{$DAT_VALIDADE='NULL,';}
...
//FIM DO IF DA FLAG ATIVA OU DESATIVA  
 ...
 return array('url_ticketdeofertas'=>'http://ticket.fidelidade.mk/?tkt='.$id,
