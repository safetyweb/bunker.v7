...
class nusoap_server extends nusoap_base {
    ...
    */
    function configureWSDL($serviceName,$namespace = false,$endpoint = false,$style='rpc', $transport = 'http://schemas.xmlsoap.org/soap/http', $schemaTargetNamespace = false)
    {
        ...
        if ($style == 'document') {
	        $this->wsdl->schemas[$schemaTargetNamespace][0]->schemaInfo['elementFormDefault'] = 'unqualified';
        }
	...
	*/
	function addOperation($name, $in = false, $out = false, $namespace = false, $soapaction = false, $style = 'rpc', $use = 'encoded', $documentation = '', $encodingStyle = ''){
		...
		if ($style == 'document') {
			...
			$this->addComplexType($name . '', 'complexType', 'struct', 'all', '', $elements);
			...
			$this->addComplexType($name . 'Response', 'complexType', 'struct', 'all', '', $elements);
