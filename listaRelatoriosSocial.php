			...
			<div class="portlet portlet-bordered">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="text-primary"><?= $NomePg; ?></span>
					</div>
										...
										<div class="col-sm-6 col-md-4">
											<div class="service-block" style="visibility: visible;">
												...
												<div class="text-block">
													<h4><?= $envolvidos ?></h4>
													<div class="text">Controle sua Rede</div>
													<div class="push10"></div>

													<?php if (fnAutRelatorio("1551", $arrayParamAutorizacao) === true) { ?>
														<a href="action.do?mod=<?= fnEncode(1551) . "&id=" . fnEncode($cod_empresa) ?>" target="_blank">&rsaquo; Cadastros Alterados</a> <br />
													<?php } ?>

													<?php if (fnAutRelatorio("1426", $arrayParamAutorizacao) === true) { ?>
														<a href="action.do?mod=<?= fnEncode(1426) . "&id=" . fnEncode($cod_empresa) ?>" target="_blank">&rsaquo; Cadastros de <?= $envolvidos ?></a> <br />
													<?php } ?>

													<?php if (fnAutRelatorio("1427", $arrayParamAutorizacao) === true) { ?>
														<a href="action.do?mod=<?= fnEncode(1427) . "&id=" . fnEncode($cod_empresa) ?>" target="_blank">&rsaquo; Cadastros por Indicadores</a> <br />
													<?php } ?>

													<?php // if(fnAutRelatorio("1428",$arrayParamAutorizacao) === true) { 
													?>
													<!-- <a href="action.do?mod=<?= fnEncode(1428) . "&id=" . fnEncode($cod_empresa) ?>" target="_blank">&rsaquo; Cadastros por Usuários</a> <br/> -->
													<?php // } 
													?>

													<?php if (fnAutRelatorio("1526", $arrayParamAutorizacao) === true) { ?>
														<a href="action.do?mod=<?= fnEncode(1526) . "&id=" . fnEncode($cod_empresa) ?>" target="_blank">&rsaquo; Eleições</a> <br />
													<?php } ?>

													<?php if (fnAutRelatorio("1522", $arrayParamAutorizacao) === true) { ?>
														<a href="action.do?mod=<?= fnEncode(1522) . "&id=" . fnEncode($cod_empresa) ?>" target="_blank">&rsaquo; Performance de Indicadores</a> <br />
													<?php } ?>

													<?php if (fnAutRelatorio("1432", $arrayParamAutorizacao) === true) { ?>
														<a href="action.do?mod=<?= fnEncode(1432) . "&id=" . fnEncode($cod_empresa) ?>" target="_blank">&rsaquo; Projeção de Cadastros</a> <br />
													<?php } ?>

													<?php if (fnAutRelatorio("1593", $arrayParamAutorizacao) === true) { ?>
														<a href="action.do?mod=<?= fnEncode(1593) . "&id=" . fnEncode($cod_empresa) ?>" target="_blank">&rsaquo; Cadastros por Região</a> <br />
													<?php } ?>

													<?php if (fnAutRelatorio("1776", $arrayParamAutorizacao) === true) { ?>
														<a href="action.do?mod=<?= fnEncode(1776) . "&id=" . fnEncode($cod_empresa) ?>" target="_blank">&rsaquo; Entidades</a> <br />
													<?php } ?>

													<?php if ($_SESSION["SYS_COD_SISTEMA"] == 3) { ?>
														<a href="action.do?mod=<?php echo fnEncode(1592) . "&id=" . fnEncode(136) . "&idC=" . fnEncode(68); ?>" target="_blank">&rsaquo; Cadastro Provisório</a> <br />
													<?php } ?>

													<?php if (fnAutRelatorio("1777", $arrayParamAutorizacao) === true) { ?>
														<a href="action.do?mod=<?= fnEncode(1777) . "&id=" . fnEncode($cod_empresa) ?>" target="_blank">&rsaquo; Cadastro de Apoiadores por Região</a> <br />
													<?php } ?>

													<?php if (fnAutRelatorio("1780", $arrayParamAutorizacao) === true) { ?>
														<a href="action.do?mod=<?= fnEncode(1780) . "&id=" . fnEncode($cod_empresa) ?>" target="_blank">&rsaquo; Altera Responsável Distrito</a> <br />
													<?php } ?>
