							...
							<div class="passo" id="passo1">
								...
								<div class="row">
											...
											<ul class="vTab nav nav-tabs tabs-left text-center">
												...
												<li class="vTab">
													<a href="action.do?mod=<?= fnEncode(2102) ?>&id=<?= fnEncode($cod_empresa) ?>">
														...
														<div class="notify-badge text-center <?= $bgPassoCinco ?>" id="notificaPasso4"><span class="<?= $passoCinco ?>"></span></div>
									...
									<div class="form-group text-right col-lg-12">
										...
										<a href="action.do?mod=<?= fnEncode(2102) ?>&id=<?= fnEncode($cod_empresa) ?>" class="btn btn-primary next next1" name="next">Próximo&nbsp;&nbsp;<i class="fas fa-arrow-right"></i></a>
									</div>
