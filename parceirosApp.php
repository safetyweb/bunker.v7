				...
				<div class="portlet-body">
					...
					<div class="login-form">
						...
						<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="inputName" class="control-label required">Nome do Parceiro</label>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" name="IMAGEM" id="IMAGEM" class="form-control input-sm required" style="border-radius: 0 3px 3px  0;" value="">
											</div>
							...
							<input type="hidden" name="LOG_LINKWHATS" id="LOG_LINKWHATS" value="N">
							<input type="hidden" name="DES_LINK" id="DES_LINK" value="">
