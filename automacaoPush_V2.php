...
.no-padding-sides{
												...
												<div class="row">
													...
													<div class="col-md-6 col-sm-6 col-xs-8">
														<div class="col-md-10 col-md-offset-2 col-sm-10 col-sm-offset-2 col-xs-12 col-xs-offset-6">
															<h4 style="font-size: 17px;">Composição do Push da campanha</h4>
														</div>
													</div>
												    ...
												    <div class="col-md-7 col-md-offset-1 col-sm-7 col-sm-offset-1 col-xs-8 col-xs-offset-1">
												    	...
												    	<div class="col-md-12 col-sm-12 col-xs-12" id="drop-target">
												    		...
												    		<?php
												    			...
												    			$sqlGtlh = "SELECT * FROM GATILHO_PUSH WHERE COD_CAMPANHA = $cod_campanha AND COD_EMPRESA = $cod_empresa";
																...
																switch ($qrBuscaGtlh['TIP_GATILHO']) {
																	...
																	case 'cadPush':
																		$tip_gatilho = "Boas Vindas (Push)";
																	break;

																	case 'resgPush':
																		$tip_gatilho = "Confirmação de resgate (Push)";
																	break;

																	case 'credPush':
																		$tip_gatilho = "Crédito ganho no momento da compra (Push)";
																	break;
												    		...
												    		<div class="row not-movable" id="trigger">
														    	...
														    	<div class="col-md-3 col-xs-3 no-padding-sides">
														    		<a href="javascript:void(0)" class="btn btn-info btn-xs transparency" data-url="action.php?mod=<?php echo fnEncode(1878)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_campanha)?>&pop=true" data-title="Gatilho" onclick='try {parent.abreModalPai($(this).attr("data-url"),$(this).attr("data-title"),"sm")} catch(err) {}'>
												    		...
												    		<?php
												    			...
												    			$sql = "SELECT * FROM TEMPLATE_AUTOMACAO_PUSH TA
																...
																while($qrTempl = mysqli_fetch_assoc($arrayQuery)){
																	...
																	switch($qrTempl['COD_BLTEMPL']){
																		...
																		case 25:
																			...
																			$sqlTplt = "SELECT TS.NOM_TEMPLATE FROM TEMPLATE_PUSH TS 
																				        LEFT JOIN MENSAGEM_PUSH ME ON ME.COD_TEMPLATE_PUSH = TS.COD_TEMPLATE
	...
	<script type="text/javascript">
		...
		function refreshBloco(cod_empresa,cod_template) {
			jQuery.ajax({
				type: "GET",
				url: "ajxAutomacaoPush_v2.php?opcao=refresh",
		...
		function excBloco(id,tipo){
			...
			jQuery.ajax({
				type: "POST",
				url: "ajxAutomacaoPush_v2.php?opcao=exc&tp="+tipo,
