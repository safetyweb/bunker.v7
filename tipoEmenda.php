...
<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		else
		{
			...
			$cod_objeto = fnLimpaCampoZero($_REQUEST['COD_TIPO']);
			$des_objeto = fnLimpaCampo($_REQUEST['DES_TIPO']);
			$abv_objeto = fnLimpaCampo($_REQUEST['ABV_TIPO']);
			...
			if ($opcao != ''){ 				
				...
				switch ($opcao)
				{
					...
					case 'ALT':
						...
						$sql = "UPDATE TIPO_EMENDA SET 
					    		DES_TIPO='$des_objeto',
					    		ABV_TIPO='$abv_objeto'

					    		WHERE COD_TIPO=$cod_objeto
							...
							<?php } ?>
								...
								<div class="login-form">
									...
									<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
										...
										<!--<input type="hidden" name="COD_TIPO" id="COD_TIPO" value="<?php echo $cod_plataf; ?>">-->
