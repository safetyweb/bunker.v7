									...
									<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
										...
										<div  class="col-sm-12"	style="padding-left: 0;">
											...
											<div class="col-xs-2" style="padding-left: 0;"> <!-- required for floating -->
											  ...
											  <ul class="vTab nav nav-tabs tabs-left text-center">
												...
												<li class="active vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1407)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1500)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1496)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1497)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1517)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1519)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
											...
											<div class="col-xs-10 no-scroll">
												...
												<iframe frameborder="0" id="conteudoAba" src="action.php?mod=<?php echo fnEncode(1407)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" style="width: 100%; min-height: 25vh;"></iframe>
					...
					action: function () {
						...
						$.confirm({
							...
							content: function(){
								var self = this;
								return $.ajax({
									url: "ajxResultadoEmails.do?opcao="+opcao+"&nomeRel="+nome+"&id=<?php echo fnEncode($cod_empresa); ?>",
