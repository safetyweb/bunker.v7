...
margin-top: 5px;
                ...
                <div class="login-form" style="padding: 0 10px 30px 10px; background: #34495e;"> 
					<div class="row" id="#fullPage" style="background: #34495e;">
                    ...
                    <form data-toggle="validator" role="form2" method="post" id="formulario" style="background: #34495e;" action="<?php echo $cmdPage; ?>">
