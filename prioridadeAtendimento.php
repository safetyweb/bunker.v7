<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		else
		{
			...
			$des_prioridade = fnLimpaCampo($_REQUEST['DES_PRIORIDADE']);
			$abv_prioridade = fnLimpaCampo($_REQUEST['ABV_PRIORIDADE']);
			...
			if ($opcao != ''){ 
				...
				$sql = "INSERT INTO ATENDIMENTO_PRIORIDADE(
						DES_PRIORIDADE,
						ABV_PRIORIDADE,
						COD_EMPRESA,
						DES_COR,
	    		...
	    		$sql = "DELETE FROM ATENDIMENTO_PRIORIDADE WHERE COD_PRIORIDADE = $cod_prioridade";
	    		...
	    		$sql = "UPDATE ATENDIMENTO_PRIORIDADE SET 
			    		DES_PRIORIDADE='$des_prioridade',
			    		ABV_PRIORIDADE='$abv_prioridade',
			    		DES_COR='$des_cor',
			    		DES_ICONE='$des_icone'
...
?>
						...
						<div class="col-md12 margin-bottom-30">
							...
							<div class="portlet portlet-bordered">
								...
								<div class="portlet-body">
									...
									<?php $abaInfoAtendimento = 1438; include "abasAtendimentoConfig.php"; ?> 
								...
								<div class="login-form">
									...
									<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
												...
												<div class="row">
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm leitura" readonly="readonly" name="COD_PRIORIDADE" id="COD_PRIORIDADE" value="">
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm" name="DES_PRIORIDADE" id="DES_PRIORIDADE" maxlength="50" required>
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm" name="ABV_PRIORIDADE" id="ABV_PRIORIDADE" maxlength="20" required>
															<div class="help-block with-errors"></div>
														</div>
													</div>
										...
										<!--<input type="hidden" name="COD_PRIORIDADE" id="COD_PRIORIDADE" value="<?php echo $cod_plataf; ?>">-->
										...
										<div class="col-lg-12">
											...
											<div class="no-more-tables">
												...
												<tbody>
													...
													$sql = "SELECT * FROM ATENDIMENTO_PRIORIDADE WHERE COD_EMPRESA = $cod_empresa";
													...
													while ($qrBuscaModulos = mysqli_fetch_assoc($arrayQuery))
													  ...
													  ?>
														<tr>
															...
															<td><?php echo $qrBuscaModulos['COD_PRIORIDADE']; ?></td>
															<td><?php echo $qrBuscaModulos['DES_PRIORIDADE']; ?></td>
															<td><?php echo $qrBuscaModulos['ABV_PRIORIDADE']; ?></td>
															<td align='center'><span style='color: <?php echo $qrBuscaModulos['DES_COR'];?>;' class='<?php  echo $qrBuscaModulos['DES_ICONE'];?>' ></td>
														</tr>

														<input type='hidden' id='ret_COD_PRIORIDADE_<?php echo $count; ?>' value='<?php echo $qrBuscaModulos['COD_PRIORIDADE']; ?>'>
														<input type='hidden' id='ret_DES_PRIORIDADE_<?php echo $count; ?>' value='<?php echo $qrBuscaModulos['DES_PRIORIDADE']; ?>'>
														<input type='hidden' id='ret_ABV_PRIORIDADE_<?php echo $count; ?>' value='<?php echo $qrBuscaModulos['ABV_PRIORIDADE']; ?>'>
	...
	<script type="text/javascript">
		...
		function retornaForm(index){
			$("#formulario #COD_PRIORIDADE").val($("#ret_COD_PRIORIDADE_"+index).val());
			$("#formulario #DES_PRIORIDADE").val($("#ret_DES_PRIORIDADE_"+index).val());
			$("#formulario #ABV_PRIORIDADE").val($("#ret_ABV_PRIORIDADE_"+index).val());
