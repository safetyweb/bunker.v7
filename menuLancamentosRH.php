												...
												<div class="row" style="margin: 0 0 0 1px;">
													...
													<div class="col-sm-6 col-md-4">
														<div class="service-block" style="visibility: visible;">
															<div class="ico fal fa-money-check-edit-alt highlight"></div>
															<div class="text-block">
																<h4>Lançamentos </h4>
																<div class="text">Facilidade no controle do dia a dia</div>
																<div class="push10"></div>
														
																<?php if(fnControlaAcesso("1706",$arrayParamAutorizacao) === true) { ?>
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1706)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Lançamentos <small>Mensal</small> </a> <br/>
																<?php } ?>
																
																<?php if(fnControlaAcesso("1709",$arrayParamAutorizacao) === true) { ?>
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1709)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Lançamentos <small>Mensal (Lista)</small> </a> <br/>
																<?php } ?>
													...
													<?php if ($_SESSION["SYS_COD_TPUSUARIO"] == 16){ ?>	
													...
													<div class="col-sm-6 col-md-4">
														<div class="service-block" style="visibility: visible;">
															<div class="ico fal fa-lightbulb-dollar text-danger"></div>
															<div class="text-block">
																<h4>Bonificações </h4>
																<div class="text">Controle o incetivo dos colaboradores</div>
																<div class="push10"></div>
														
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1718)."&id=".fnEncode($cod_empresa); ?>" target="_blank" class="text-danger">&rsaquo; Tipo de Lançamentos </a> <br/>
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1717)."&id=".fnEncode($cod_empresa); ?>" target="_blank" class="text-danger">&rsaquo; Lista de Bonificação </a> <br/>																
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1719)."&id=".fnEncode($cod_empresa); ?>" target="_blank" class="text-danger">&rsaquo; Lançamentos <small>Bônus (Lista)</small> </a> <br/>																
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1722)."&id=".fnEncode($cod_empresa); ?>" target="_blank" class="text-danger">&rsaquo; Relatório <small>Bônus</small> </a> <br/>																
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1761)."&id=".fnEncode($cod_empresa); ?>" target="_blank" class="text-danger">&rsaquo; Relatório de Lançamento <small>(por perído/colaborador)</small> </a> <br/>																
																<!--<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1735)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Relatório <small>Bônus Tipo</small> </a> <br/> -->
