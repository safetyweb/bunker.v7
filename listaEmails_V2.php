<?php
	...
	if( $_SERVER['REQUEST_METHOD']=='POST' )
	{
		...
		else
		{
			...
			if ($opcao != ''){
				...
				$sql = "SELECT COD_GATILHO, TIP_GATILHO FROM GATILHO_EMAIL WHERE COD_CAMPANHA = $cod_campanha";
				...
				$sql = "CALL SP_RELAT_EMAIL_CLIENTE($cod_empresa, $cod_campanha, '$pct_reserva', '$cod_personas', '$tipo')";
				// fnEscreve($sql);
				...
				// $sql2 = "DELETE FROM EMAIL_PARAMETROS WHERE COD_EMPRESA = $cod_empresa AND COD_CAMPANHA = $cod_campanha; ";

				$sql2 = "INSERT INTO EMAIL_PARAMETROS(
										COD_EMPRESA,
										COD_CAMPANHA,
										COD_PERSONAS,
										PCT_RESERVA,
										...
										'".fnLimpaCampoZero($qrTot['CLIENTES_UNICOS_EMAIL'])."',
										'".fnLimpaCampoZero($qrTot['CLIENTES_UNICO_PERC'])."',
										'".fnLimpaCampoZero($qrTot['TOTAL_CLIENTE_EMAIL_NAO'])."',
				...
				$sqlControle = "UPDATE EMAIL_LISTA_CONTROLE
								SET COD_LISTA = (
				...
				switch ($opcao)
				{
					case 'CAD':
						...
						$des_campanha = "$cod_empresa_$qrCamp[COD_CAMPANHA]_$qrCamp[DES_CAMPANHA]";
						$cod_ext_campanha = $qrCamp['COD_EXT_CAMPANHA'];

						// fnEscreve($des_campanha);
						...
						if($cod_ext_campanha != ""){
							...
							AltualizaCampanha("$_SESSION[AUTH_DINAMIZE]", $cod_ext_campanha, $des_campanha);

						}else{

							$retornoListaVer = ListaCampanha("$_SESSION[AUTH_DINAMIZE]",$des_campanha);

							$retornoListaVer = json_decode($retornoListaVer,true);

							$cod_ext_campanha = $retornoListaVer[body][items][0][code];
							...
							if($cod_ext_campanha != ""){
								...
								$retornoAdd = AddCampanha("$_SESSION[AUTH_DINAMIZE]", $des_campanha);

								$cod_ext_campanha = $retornoAdd[body][code];
	...
	//fnescreve($clientes_unicos_email);
					          ...
					          <div class="portlet-body">
								...
								<div class="push20"></div>						
									...
									<div class="login-form">
												...
												<div class="col-xs-2 col-xs-offset-8">
													...
													<div class="dropdown">
														...
														<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
															<li><a tabindex="-1" href="javascript:void(0);" onclick="parent.exportaLista('sent',0)">Lista de Envio</a></li>
										...
										<input type="hidden" name="CLIENTES_UNICOS_EMAIL" id="CLIENTES_UNICOS_EMAIL" value="<?=0?>">
										<input type="hidden" name="CLIENTES_UNICO_PERC" id="CLIENTES_UNICO_PERC" value="<?=0?>">
										<input type="hidden" name="TOTAL_CLIENTE_EMAIL_NAO" id="TOTAL_CLIENTE_EMAIL_NAO" value="<?=0?>">
