<?php
	...
	if (is_numeric(fnLimpacampo(fnDecode($_GET['idT'])))){
		...
		$sql = "SELECT * FROM TEMPLATE_SMS WHERE COD_TEMPLATE = ".$cod_template;	
							...
							<div class="row">
								...
								<div class="col-md-10">
									<div class="form-group">
										...
										<textarea type="text" class="form-control input-sm" rows="3"  name="DES_TEMPLATE" id="DES_TEMPLATE" maxlength="159" value="" required><?php echo $des_template;?></textarea>
									</div>
									<div class="help-block with-errors"></div>
								</div>
								...
								<div class="col-md-2">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control input-sm leitura" readonly="readonly" name="nType" id="nType" value="159">
									</div>
								</div>							
