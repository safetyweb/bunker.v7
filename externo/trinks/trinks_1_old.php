...
$busca='select * from LOG_TRINKS where data_hora >="2020-03-01 00:00:00";';
...
while ($row = mysqli_fetch_assoc($rw)) {
   ...
   $update="UPDATE log_trinks SET PDV='".$array2['IdDaTransacao']."',CPF='".$array2['CPFDoCliente']."' WHERE  ID=".$row['ID']; 
                                                 ...
                                                 <SOAP-ENV:Body>
                                                     <ns1:InserirVenda>
                                                         <venda>
                                                             ...
                                                             <ns1:datahora>'.date('d/m/Y H:i:s').'</ns1:datahora>
