...
include '../../_system/_functionsMain.php';
 // Definindo o intervalo de tempo
    $startTime = date('Y-m-d\TH:i:s\Z', strtotime('-24 hour'));
...
$empresa = "SELECT * FROM empresas emp
             ...
             WHERE emp.log_ativo = 'S' AND par.COD_TPCOM = '2' AND apar.LOG_ATIVO = 'S' and emp.COD_EMPRESA=7";

$rwempresa = mysqli_fetch_assoc(mysqli_query($connAdm->connAdm(), $empresa));
