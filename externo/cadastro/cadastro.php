		...
		<?php
			...
			if( $_SERVER['REQUEST_METHOD']=='POST' )
			{
				...
				else
				{
					...
					if (empty($_REQUEST['LOG_TROCAPROD'])) {$log_trocaprod='N';}else{$log_trocaprod=$_REQUEST['LOG_TROCAPROD'];}
					...
					if($num_cartao == 0 || $num_cartao == ""){ $num_cartao = fnLimpacampoZero(fnLimpaDoc($_REQUEST['NUM_CGCECPF'])); }
					...
					if ($opcao != ''){
						...
						switch ($opcao)
						{
							case 'CAD':
								...
								$diaMesAno = explode("/", $dat_nascime);

								$idade = (date("md", date("U", mktime(0, 0, 0, $diaMesAno[0], $diaMesAno[1], $diaMesAno[2]))) > date("md")
								    ? ((date("Y") - $diaMesAno[2]) - 1)
								    : (date("Y") - $diaMesAno[2]));
								...
								$msgRetorno = "Obrigado! <br/> Seu registro foi realizado com <strong>sucesso!</strong>";	
			...
			if (is_numeric(fnLimpacampo(fnDecode($_GET['idi'])))){
				$cod_indicad = fnLimpacampo(fnDecode($_GET['idi']));

				$sqlIndica = "SELECT NOM_CLIENTE FROM CLIENTES WHERE COD_CLIENTE = $cod_indicad";
				$qrIndica = mysqli_fetch_assoc(mysqli_query(connTemp($cod_empresa,''),trim($sqlIndica)));

				$nom_indicador = $qrIndica['NOM_CLIENTE'];
			}else{
				$cod_indicad = 0;
				$nom_indicador = "";
			}
		...
		<html lang="pt">
								...
								<div class="portlet" style="padding: 0 20px 20px 20px;" >
									...
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="text-primary">Cadastro de Apoiador</span>
										</div>
										...
										<div class="portlet-body">
											...
											<div class="login-form">
												...
												<form data-toggle="validator" role="form2" method="post" id="formulario" action="cadastro.do?id=<?=fnEncode($cod_empresa)?>">

													<!-- <div id="stepper"> -->
																			
													<fieldset id="passo1">
														<legend>Informe seus dados básicos</legend> 
															...
															<div class="row">
																...
																<div class="col-xs-12 col-md-6">
																	<div class="form-group">
																		...
																		<input type="text" class="form-control input-sm" name="NOM_INDICADOR" id="NOM_INDICADOR" maxlength="200" value="<?=$nom_indicador?>">
																		<div class="help-block with-errors"></div>
																	</div>
																</div>
												...
												<fieldset id="passo2">
													<legend>Informe como entrar em contato com você</legend> 
														...
														<div class="row">
															...
															<div class="col-xs-12 col-md-4">
																<div class="form-group">
																	<label for="inputName" class="control-label">Tel. Principal</label>
															...
															<div class="col-xs-12 col-md-4">
																<div class="form-group">
																	<label for="inputName" class="control-label">Tel. Comercial</label>
														...
														<div class="row">
															...
															<div class="col-xs-12 col-md-4 text-center">
																<div class="form-group">
																	<label for="inputName" class="control-label">Receber e-Mail</label><br/>
																	<label class="switch">
															...
															<div class="col-xs-12 col-md-4 text-center">
																<div class="form-group">
																	<label for="inputName" class="control-label">Receber SMS</label><br/>
																	<label class="switch">
															...
															<div class="col-xs-12 col-md-4 text-center">
																<div class="form-group">
																	<label for="inputName" class="control-label">Receber Telemarketing</label><br/>
																	<label class="switch">
													...
													<legend>Informe seu endereço</legend> 
														...
														<div class="row">
															...
															<div class="col-xs-6 col-md-1">
																...
																<a href="javascript:void(0)" class="btn btn-info btn-block btn-sm addBox" data-url="buscaCep.do?id=<?php echo fnEncode($cod_empresa); ?>&pop=true" data-title="Busca CEP/Logradouro" data-toggle='tooltip' data-placement='top' data-original-title='Busca CEP/Logradouro'><i class="fal fa-map-marked-alt f16" aria-hidden="true"></i></a>
														...
														<div class="row">
															...
															<div class="col-xs-12 col-md-4" id="relatorioCidade">
																<div class="form-group">
												...
												<div class="form-group col-xs-12 col-md-12">
													<a href="javascript:void(0)" class="btn btn-info prev btn-block pull-left" id="prev1" onclick="proximoPasso(this)"><span class="fal fa-arrow-left"></span> &nbsp; Voltar</a>													
												</div>
												
												<div class="form-group col-xs-12 col-md-12">
													<a href="javascript:void(0)" class="btn btn-primary btn-block next" id="next2" onclick="proximoPasso(this)">Continuar Cadastro &nbsp; <span class="fal fa-arrow-right"></span></a>
												</div>
												
												<div class="form-group col-xs-12 col-md-12">
													<button type="submit" name="CAD" id="CAD" class="btn btn-success btn-block getBtn"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Finalizar Cadastro</button>					
												</div>
												
												<input type="hidden" name="DES_COMENT" id="DES_COMENT" value="" >
												...
												<input type="hidden" name="NOM_ENTIDAD" id="NOM_ENTIDAD" value="" />
			...
			<script type="text/javascript">
				...
				$(document).ready(function(){
					...
					let frame = document.getElementById('frameExterno');
			...
			function carregaComboCidades(cod_estado){
				$.ajax({
					method: 'POST',
					url: 'https://adm.bunker.mk/ajxComboMunicipio.php?id=<?=fnEncode($cod_empresa)?>',
			...
			function proximoPasso(botao){
				...
				var passo = $(botao).attr('id').slice(-1),
					op = $(botao).attr('id').slice(0,-1),
					num = Number(passo),
					next = num+1,
					prev = num-1;					
				...
				if(op == "next"){
					...
					if ($("#passo"+(passo-1)).validator('validate').has('.has-error').length === 0) {

						$("#passo"+(passo-1)).fadeOut('fast',function(){
							$("#passo"+passo).fadeIn('fast');
							$(".next").removeAttr('id').attr('id',"next"+next);
							$(".prev").removeAttr('id').attr('id',"prev"+passo);
							if(passo == 2){
								$("#prev1").fadeIn('fast');
							}else if(next == 4){
								$("#next4").fadeOut('fast',function(){
									$("#CAD").fadeIn('fast');
								});
							}
						});
					...
					$("#passo"+passo).fadeOut('fast',function(){
						$("#passo"+prev).fadeIn('fast');
						$(".next").removeAttr('id').attr('id',"next"+passo);
						$(".prev").removeAttr('id').attr('id',"prev"+prev);
						if(prev == 1){
							$(".prev").fadeOut('fast');
						}else if(next == 4){
							$("#CAD").fadeOut('fast',function(){
								$(".next").fadeIn('fast');
							});
						}
					});
