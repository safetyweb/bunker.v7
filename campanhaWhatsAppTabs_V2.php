						...
						<div class="col-md12 margin-bottom-30">
							...
							<div class="portlet portlet-bordered">
								...
								<div class="portlet-body">
									...
									$sql1 = "SELECT COUNT(1) AS TEMACESSO FROM SENHAS_WHATSAPP apar
									...
									<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
										...
										<div  class="col-sm-12"	style="padding-left: 0;">
											...
											<div class="col-xs-2" style="padding-left: 0;"> <!-- required for floating -->
											  ...
											  <ul class="vTab nav nav-tabs tabs-left text-center">
												...
												<li class="active vTab">				
													<a href="javascript:void(0)" id="TEMPLATES" data-url="action.php?mod=<?php echo fnEncode(1915)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" id="AUTOMACAO" data-url="action.php?mod=<?php echo fnEncode(1911)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" id="LISTA" data-url="action.php?mod=<?php echo fnEncode(1906)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" id="APROVACAO" data-url="action.php?mod=<?php echo fnEncode(1910)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" id="ATIVACAO" data-url="action.php?mod=<?php echo fnEncode(1909)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<!-- <li class="vTab">				
													<a href="javascript:void(0)" id="RESULTADOS" data-url="action.php?mod=<?php echo fnEncode(1876)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
											...
											<div class="col-xs-10 no-scroll">
												...
												<iframe frameborder="0" id="conteudoAba" src="action.php?mod=<?php echo fnEncode(1915)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" style="width: 100%; min-height: 25vh;"></iframe>
					...
					action: function () {
						...
						$.confirm({
							...
							content: function(){
								var self = this;
								return $.ajax({
									url: "ajxResultadoWhatsApp_V2.do?opcao="+opcao+"&nomeRel="+nome+"&id=<?php echo fnEncode($cod_empresa); ?>",
					...
					action: function () {
						...
						$.confirm({
							...
							content: function(){
								var self = this;
								return $.ajax({
									url: "ajxListaWhatsApp_V2.do?opcao="+opcao+"&nomeRel="+nome+"&id=<?php echo fnEncode($cod_empresa); ?>",
									data: {COD_DISPARO: cod_disparo, COD_CAMPANHA: "<?=$cod_campanha?>"},
									method: 'POST'
								}).done(function (response) {
									self.setContentAppend('<div>Exportação realizada com sucesso.</div>');
