<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		else
		{
			...
			$abv_status = fnLimpaCampo($_REQUEST['ABV_STATUS']);
			...
			if ($opcao != ''){ 
				...
				$sql = "INSERT INTO ATENDIMENTO_STATUS(
						DES_STATUS,
						ABV_STATUS,
						COD_EMPRESA,
						DES_COR,
	    		...
	    		$sql = "DELETE FROM ATENDIMENTO_STATUS WHERE COD_STATUS = $cod_status";
	    		...
	    		$sql = "UPDATE ATENDIMENTO_STATUS SET 
						...
						<div class="col-md12 margin-bottom-30">
							...
							<div class="portlet portlet-bordered">
								...
								<div class="portlet-body">
									...
									<?php $abaInfoAtendimento = 1437; include "abasAtendimentoConfig.php"; ?> 
