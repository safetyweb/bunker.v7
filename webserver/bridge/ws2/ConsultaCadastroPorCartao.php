...
function ConsultaCadastroPorCartao($DADOSLOGIN)
{
    ...
    if (!empty($msg)) {
        return  array('ConsultaCadastroPorCartaoResult' => array('msgerro' => $msg));
    }
    ...
    if ($row['COD_CHAVECO'] == 2 || $row['COD_CHAVECO'] == 5) {
        ...
        if ($dadosbase[0]['contador'] == 1) {
            ...
            if ($dadosbase[0]['tipocliente'] == 'F') {
                $tipoclient = 'Pessoa Física';
            } else {
                $tipoclient = 'Pessoa Juridica';
            }
            //=====================
            // if($dadosbase[0]['sexo']=='M'){$sexo=1;}else{$sexo=2;}
            if ($dadosbase[0]['sexo'] == '1') {
                $sexo = 'Masculino';
            } else {
                $sexo = 'Feminino';
            }
            ...
            return array('ConsultaCadastroPorCartaoResult' => array(
                'msgerro' => 'Nenhum cadastro encontrado',
                'retornodnamais' => '0'
            ));
        }
    } else {
