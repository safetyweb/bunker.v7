...
function FnCadAuto($arraydadosCli)
{
  ...
  //atualiza 
        ...
        curl_close($curl);
          ...
          {
            sleep(0.3);  
            $busca="select count(COD_CLIENTE) as contador,cod_cliente,NOM_CLIENTE,
                                                DAT_NASCIME,COD_SEXOPES,NUM_CGCECPF,
                                                NUM_CARTAO,NUM_CELULAR from clientes where 
            ...
            array_push($arraydadosBase, array(
                                            ...
                                            'datanascimento'=>$row['DAT_NASCIME'],
                                            'sexo'=>$row['COD_SEXOPES'],
                                            'cpf'=>$row['NUM_CGCECPF'],
                                            'cartao'=>$row['NUM_CARTAO'],
                                            'telefone'=>$row['NUM_CELULAR']    
                                        )
                );
