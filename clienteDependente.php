	...
	if (is_numeric(fnLimpacampo(fnDecode($_GET['id'])))){
		...
		if (isset($qrBuscaCliente)){
			...
			if($cod_cliente !=0){ 
				...
				if ($qrBuscaCliente['LOG_TROCAPROD']=='S') {$check_troca='checked';}else{$check_troca='';}
										...
										<fieldset>
											...
											<div class="col-xs-10">
												...
												<div class="row">		
													...
													<div class="col-xs-3">
														<div class="form-group">
															<label for="inputName" class="control-label required lbl_req">Igreja</label>
															<input type="text" class="form-control input-sm" name="DES_IGREJA" id="DES_IGREJA" value="<?php echo $des_igreja ?>" maxlength="60" data-error="Campo obrigatório" required>
															<div class="help-block with-errors"></div>
														</div>
													</div>
													...
													<div class="col-xs-3">
														<div class="form-group">
															<label for="inputName" class="control-label required lbl_req">Localidade</label>
															<input type="text" class="form-control input-sm" name="DES_LOCAL" id="DES_LOCAL" value="<?php echo $des_local ?>" maxlength="60" data-error="Campo obrigatório" required>
															<div class="help-block with-errors"></div>
														</div>
													</div>
												...
												<?php if($master == 'N' && $cod_indicad == 0 && $cod_cliente != 0){ ?>
													<div class="col-xs-4">
														<label for="inputName" class="control-label required">Nome do Indicador</label>
														<div class="input-group">
														<span class="input-group-btn">
															...
															<input type="text" name="NOM_INDICA" id="NOM_INDICA" value="" maxlength="50" readonly="" class="form-control input-sm" style="border-radius:0 3px 3px 0;" data-error="Campo obrigatório" required>
												...
												<?php }else if($master == 'S' && $cod_indicad != 0 && $cod_cliente != 0){ ?>
													<div class="col-xs-4">
														...
														<span class="input-group-btn">
															...
															<input type="text" name="NOM_INDICA" id="NOM_INDICA" value="<?php echo $nom_indicad; ?>" maxlength="50" readonly="" class="form-control input-sm" style="border-radius:0 3px 3px 0;" data-error="Campo obrigatório" required>
													...
													<div class="col-xs-2">
														<div class="form-group">
															<label for="inputName" class="control-label">Tipo de Pessoa </label>
                                                                ...
                                                                <script>$("#formulario #TIP_CLIENTE").val("<?php echo $tip_cliente; ?>").trigger("chosen:updated"); </script>                                                       
															<div class="help-block with-errors"></div>
														</div>
													</div>
