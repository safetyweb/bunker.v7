...
.no-padding-sides{
												...
												<div class="row">
													...
													<div class="col-md-4 col-sm-4 col-xs-4">
													    ...
													    <?php
													    	...
													    	$sql = "SELECT * FROM BLOCO_COMUNICACAO WHERE COD_TPCOM = 3 ORDER BY NUM_ORDENAC";
													    	$arrayQuery = mysqli_query($connAdm->connAdm(),$sql) or die(mysqli_error());
												    ...
												    <div class="col-md-7 col-md-offset-1 col-sm-7 col-sm-offset-1 col-xs-8 col-xs-offset-1">
												    	...
												    	<div class="col-md-12 col-sm-12 col-xs-12" id="drop-target">
												    		...
												    		<?php
												    			...
												    			$sqlGtlh = "SELECT * FROM GATILHO_WHATS WHERE COD_CAMPANHA = $cod_campanha AND COD_EMPRESA = $cod_empresa";
												    		...
												    		<div class="row not-movable" id="trigger">
														    	...
														    	<div class="col-md-3 col-xs-3 no-padding-sides">
														    		<a href="javascript:void(0)" class="btn btn-info btn-xs transparency" data-url="action.php?mod=<?php echo fnEncode(1578)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_campanha)?>&pop=true" data-title="Gatilho" onclick='try {parent.abreModalPai($(this).attr("data-url"),$(this).attr("data-title"),"sm")} catch(err) {}'>
												    		...
												    		<?php
												    			...
												    			$sql = "SELECT * FROM TEMPLATE_AUTOMACAO_WHATS TA
																...
																while($qrTempl = mysqli_fetch_assoc($arrayQuery)){
																	...
																	switch($qrTempl['COD_BLTEMPL']){
																		...
																		case 28:
																			...
																			$sqlTplt = "SELECT TS.NOM_TEMPLATE FROM TEMPLATE_WHATS TS 
																				        LEFT JOIN MENSAGEM_WHATS ME ON ME.COD_TEMPLATE_WHATS = TS.COD_TEMPLATE
	...
	<script type="text/javascript">
		...
		function refreshBloco(cod_empresa,cod_template) {
			jQuery.ajax({
				type: "GET",
				url: "ajxAutomacaoWhats.php?opcao=refresh",
		...
		function excBloco(id,tipo){
			...
			jQuery.ajax({
				type: "POST",
				url: "ajxAutomacaoWhats.php?opcao=exc&tp="+tipo,
