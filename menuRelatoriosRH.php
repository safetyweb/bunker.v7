													...
													<div class="col-sm-6 col-md-4">
														<div class="service-block" style="visibility: visible;">
															...
															<div class="text-block">
																<h4>Relatórios </h4>
																<div class="text">Visão completa dos colaboradores e lançamentos</div>
																<div class="push10"></div>
														
																<?php if(fnControlaAcesso("1713",$arrayParamAutorizacao) === true) { ?>
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1713)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Lançamentos </a> <br/>
																<?php } ?>
																
																<?php if(fnControlaAcesso("1760",$arrayParamAutorizacao) === true) { ?>
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1760)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Lançamentos <small>(por período/colaborador)</small></a> <br/>
																<?php } ?>

																<?php if(fnControlaAcesso("1715",$arrayParamAutorizacao) === true) { ?>
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1715)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Colaboradores </a> <br/>
																<?php } ?>
																
																<?php if(fnControlaAcesso("1716",$arrayParamAutorizacao) === true) { ?>
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1716)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Dependentes </a> <br/>
																<?php } ?>

																<?php if(fnControlaAcesso("2074",$arrayParamAutorizacao) === true) { ?>
																	<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(2074)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Atestados </a> <br/>
																<?php } ?>
