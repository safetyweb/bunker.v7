...
<div class="row">				
																...
																<select data-placeholder="Selecione a unidade de atendimento" name="COD_UNIVEND" id="COD_UNIVEND" class="chosen-select-deselect" required>
																	...
																	<?php 																	
																		...
																		while ($qrListaUnidades = mysqli_fetch_assoc($arrayQuery))
																		  ...
																		  if($qrListaUnidades['LOG_ESTATUS'] == 'N'){ $disabled = "disabled"; }else{ $disabled = " "; }				
																			echo"
	...
	<script type="text/javascript">
		...
		function retornaForm(index){
			...
			if ($("#ret_LOG_SALDO_"+index).val() == 'S'){$('#formulario #LOG_SALDO').prop('checked', true);} 
			else {$('#formulario #LOG_SALDO').prop('checked', false);}
