<?php
	...
	if( $_SERVER['REQUEST_METHOD']=='POST' )
	{
		...
		else
		{
			...
			//funcionarios
			if (empty($_REQUEST['BL1_FUNCIONARIO'])) {$bl1_funcionario='N';}else{$bl1_funcionario=$_REQUEST['BL1_FUNCIONARIO'];}

			if (empty($_REQUEST['BL1_FUNCIONAFEM'])) {$bl1_funcionafem='N';}else{$bl1_funcionafem=$_REQUEST['BL1_FUNCIONAFEM'];}
			//jurídico
			if (empty($_REQUEST['BL1_JURIDICO'])) {$bl1_juridico='N';}else{$bl1_juridico=$_REQUEST['BL1_JURIDICO'];}

			if (empty($_REQUEST['BL1_LOGNSEXO'])) {$bl1_lognsexo='N';}else{$bl1_lognsexo=$_REQUEST['BL1_LOGNSEXO'];}
			
			//array - idades
			$bl1_idades = $_REQUEST['BL1_IDADES'][0];
			if (empty($_REQUEST['BL1_LOGIDADE'])) {$bl1_logidade='N';}else{$bl1_logidade=$_REQUEST['BL1_LOGIDADE'];}
			...
			//Aceite LGPD
			if (empty($_REQUEST['BL1_LOG_LGPD'])) {$bl1_log_lgpd='N';}else{$bl1_log_lgpd=$_REQUEST['BL1_LOG_LGPD'];}
			//Sem Aceite LGPD
			if (empty($_REQUEST['BL1_LOG_SEMLGPD'])) {$bl1_log_semlgpd='N';}else{$bl1_log_semlgpd=$_REQUEST['BL1_LOG_SEMLGPD'];}
	...
	if (!empty(fnLimpacampo(fnDecode($_GET['id'])))){
		...
		if (empty($qrBuscaRegra) != 1){
			...
			if ($bl1_funcionario == "S") {$check_funcionario = "checked";} else{$check_funcionario = "";}
			$bl1_funcionafem = $qrBuscaRegra['BL1_FUNCIONAFEM'];
			if ($bl1_funcionafem == "S") {$check_funcionafem = "checked";} else{$check_funcionafem = "";}
			...
			if ($bl1_lognsexo == "S") {$check_lognsexo = "checked";} else{$check_lognsexo = "";}
			
			$bl1_idades = explode(';', $qrBuscaRegra['BL1_IDADES']);
			$bl1_logidade = $qrBuscaRegra['BL1_LOGIDADE'];
			if ($bl1_logidade == "S") {$check_idade = "checked";} else{$check_idade = "";}
			...
			if ($bl1_log_lgpd == "S") {$check_log_lgpd = "checked";} else{$check_log_lgpd = "";}
			$bl1_log_semlgpd = $qrBuscaRegra['BL1_LOG_SEMLGPD'];
			if ($bl1_log_semlgpd == "S") {$check_log_semlgpd = "checked";} else{$check_log_semlgpd = "";}
			...
			if (!empty($bl3_ucompdias_ini)){$bl3_ucompdias_ini = ($bl3_ucompdias_ini);} else {$bl3_ucompdias_ini = "";}
			$bl3_ucompdias_fim = $qrBuscaRegra['BL3_UCOMPDIAS_FIM'];
			if (!empty($bl3_ucompdias_fim)){$bl3_ucompdias_fim = ($bl3_ucompdias_fim);} else {$bl3_ucompdias_fim = "";}

			$bl3_inativo_ini = $qrBuscaRegra['BL3_INATIVO_INI'];
			if (!empty($bl3_inativo_ini)){$bl3_inativo_ini = $bl3_inativo_ini;} else {$bl3_inativo_ini = "";}
			$bl3_inativo_fim = $qrBuscaRegra['BL3_INATIVO_FIM'];
			if (!empty($bl3_inativo_fim)){$bl3_inativo_fim = $bl3_inativo_fim;} else {$bl3_inativo_fim = "";}
	...
	if (@$bl1_funcionario == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_funcionafem == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_juridico == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_lognsexo == "S") {$bl1_total = $bl1_total + 1;}
	// fnEscreve($bl1_total);
	if (@$bl1_endereco == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_celular == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_email == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_telefone == "S") {$bl1_total = $bl1_total + 1;}
	// fnEscreve($bl1_total);
	if (@$bl1_log_fidelizado == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_log_email == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_log_sms == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_log_telemark == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_log_whatsapp == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_log_push == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_log_lgpd == "S") {$bl1_total = $bl1_total + 1;}
	if (@$bl1_log_semlgpd == "S") {$bl1_total = $bl1_total + 1;}
	// fnEscreve($bl1_total);
	if (@$bl1_logidade == "N") {$bl1_total = $bl1_total + 1;}
	// fnEscreve($bl1_total);
	...
	if (!empty($bl3_ucompdias_ini)){$bl3_total = $bl3_total + 1;}
	if (!empty($bl3_ucompdias_fim)){$bl3_total = $bl3_total + 1;}
	if (!empty($bl3_inativo_ini)){$bl3_total = $bl3_total + 1;}
	if (!empty($bl3_inativo_fim)){$bl3_total = $bl3_total + 1;}
	...
	if (!empty($bl6_freq_cliente)){$bl6_total = $bl6_total + 1;}
	if (!empty($bl6_freq_cliente_u)){$bl6_total = $bl6_total + 1;}

	if (!empty($bl6_tip_ticket)){$bl6_total = $bl6_total + 1;}
	if (!empty($bl6_ticket_ini)){$bl6_total = $bl6_total + 1;}
	if (!empty($bl6_ticket_fim)){$bl6_total = $bl6_total + 1;}
						...
						<div class="col-md12 margin-bottom-30">
							...
							<div class="portlet portlet-bordered">
								...
								<div class="portlet-body">
									...
									<?php 
										// $abaCampanhas = 1035; include "abasCampanhasConfig.php"; 
									?>
											...
											<div class="col-xs-10">
											  ...
											  <div class="tab-content">
												...
												<div class="tab-pane active" id="perfil">
													<h4 style="margin: 0 0 5px 0;"><span class="bold">Configuração de Perfil</span></h4>
													...
													<div class="row">
														...
														<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 bloco-int">
													...
													<div class="row">
														...
														<script type="text/javascript">
															$(function(){
																$("#BL1_TPNIVER_N,#BL1_LOGIDADE,#BL1_TPNIVER_C").change(function(){
																	if($("#BL1_TPNIVER_N").is(':checked')){
																		$("#BL1_ANIVERSARIO").prop('disabled',false).trigger("chosen:updated");
																	}else{
																		$("#BL1_ANIVERSARIO").prop('disabled',true);
																		$("#BL1_ANIVERSARIO").val('').trigger("chosen:updated");
																	}

																	if($("#BL1_LOGIDADE").is(':checked')){
																		$("#BL1_ANIVERSARIO").prop('disabled',true);
																		$("#BL1_ANIVERSARIO").val('').trigger("chosen:updated");
																	}
																...
																<div class="widget-data">
																	...
																	<div class="widget-subtitle" style="padding: 10px 10px 0 0;">
																		...
																		<?php
																			...
																			if($check_idade == "" && $check_tpniver_n == "checked" && $check_tpniver_c == ""){
																				$disableAniv = "";
																			}else{
																				$disableAniv = "disabled";
																			}

																		?>
																			
																		<select data-placeholder="Escolha os aniversariantes" name="BL1_ANIVERSARIO[]" id="BL1_ANIVERSARIO" multiple="multiple" class="chosen-select-deselect" style="width:100%;" tabindex="1" <?=$disableAniv?>>
