...
?>  
    ...
    <div class="container">
        ...
        <?php if($msgRetorno != "" && $cod_empresa == 19){ ?>
            <div class="alert alert-warning" role="alert">
            Após o recebimento da sua mensagem, o prazo para retornarmos é de 48 horas úteis. Até breve!
            </div>          
        <?php }?>

        <form id="formulario" class="form-signin" method="post" action="faleConosco.do?key=<?=fnEncode($cod_empresa)?>">
