...
@media (max-device-width: 737px) and (max-height: 416px) {
	...
	<?php } ?>
		...
		<div class="col-md-12 col-xs-12">
			...
			?>
						...
						<div id="relatorioToken">
							<button href="javascript:void(0)" class="btn btn-primary btn-lg btn-block" onclick='ajxTokenAlt()'><i class="fal fa-user-unlock" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp; Enviar Token</button>
						</div>
	...
	<!--
		...
		(
		    ...
		    [estado] => 
		    [cep] => 
		    [datanascimento] => 07/12/1993
		    [telresidencial] => 
		    [telcelular] => 15981146246
		    [saldo] => SimpleXMLElement Object
		        (
		            [0] => 0,00
		        )
		    ...
		    [profissao] => 0
		    [codatendente] => 
		    [localizacaocliente] => SimpleXMLElement Object
		        (
		            [0] => 14
		        )
