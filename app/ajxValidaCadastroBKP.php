...
$parametros = fnDecode($_POST['KEY']);
$arrayCampos = explode(";", $_SESSION["KEY"]);

// print_r($arrayCampos);

// $nom_cliente = $_POST['NOM_CLIENTE'];
// $dt_nascimento = $_POST['c6'];
// $cod_sexopes = $_POST['c7'];
// $des_email = $_POST['c3'];
// $des_senhaus = $_POST['c5'];
// $des_telefone = $_POST['c4'];
// $cpf = fnLimpaDoc($_POST['CPF']);
...
$des_senhaus = $_REQUEST['DES_SENHAUS'];
...
// fnEscreve($linha);
	...
	}else if($atualiza == "Cadastro Atualizado !"){
