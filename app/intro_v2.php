...
?>
    ...
    <div class="container" style="background-color: <?= $cor_backpag ?>; height: 100vh; width: 100%; padding: 0; margin: 0;">
	    
        <div class="row" style="margin-bottom: 0px;">
            <div class="col-md-12" style=" padding: 0; margin-left: auto; margin-right: auto; margin-bottom: 0px; min-height: 510px; width: 100%;">
                <img src="./images/nova_duque.png" width="100%" alt="" >
            </div>

        </div>

        <div class="row" style="border-radius: 15px 15px 0px 0px; margin: 0 auto; background-color: <?= $cor_fullpag ?>;">
