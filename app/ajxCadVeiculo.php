...
// $num_cgcecpf = $_SESSION[usuario];

$sqlCli = "SELECT COD_CLIENTE FROM CLIENTES WHERE COD_EMPRESA = $cod_empresa AND NUM_CARTAO = $num_cgcecpf";
$arrCli=mysqli_query(connTemp($cod_empresa,''),$sqlCli);
$qrCli = mysqli_fetch_assoc($arrCli);
...
switch($opcao){
	...
	case 'excluir':
                    $log_placa="INSERT INTO veiculos_exec( 
                    										COD_VEICULOS,
															COD_EXTERNO,
															DAT_CADASTR,
															COD_CLIENTE,
													...
													SELECT  COD_VEICULOS,
				                                            ...
				                                            NOW() 
								                    from veiculos  
								                    WHERE COD_VEICULOS = $cod_veiculos;";                    
