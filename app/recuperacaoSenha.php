...
$cpfPesquisa = str_replace("-", "", str_replace(".", "", base64_decode($_GET[cpf])));
...
$linkValida = "validaDados.do?key=".$_GET[key]."&t=$rand";

if($log_recupera == "S"){
	$linkValida = "validaDados_v2.do?key=".$_GET[key]."&t=$rand";
}

?>

<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?=$linkValida?>">
								...
								?>
									<div class="col-md-12 col-xs-12">
										<div class="form-group">
											...
											<input type="text" style="font-size: 36px;" class="form-control input-hg input-lg text-center campo2 int" name="KEY_NUM_CARTAO" id="KEY_NUM_CARTAO" value="<?=$cpfPesquisa?>" required>
								...
								?>
									...
									<div class="col-md-12 col-xs-12">
										<div class="form-group">
											...
											<input type="tel" style="font-size: 36px;" class="form-control input-hg input-lg text-center campo1 cpfcnpj" name="KEY_NUM_CGCECPF" id="KEY_NUM_CGCECPF" value="<?=$cpfPesquisa?>" required>
											<div class="help-block with-errors"></div>
										</div>
									</div>
							...
							default:
								...
								?>
									<div class="col-md-12 col-xs-12">
										<div class="form-group">
											<label for="inputName" class="control-label required">CPF/CNPJ</label>
											<input type="tel" style="font-size: 38px;" class="form-control input-hg input-lg text-center campo1 cpfcnpj" name="KEY_NUM_CGCECPF" id="KEY_NUM_CGCECPF" value="<?=$cpfPesquisa?>" required>
											<div class="help-block with-errors"></div>
										</div>
									</div>
