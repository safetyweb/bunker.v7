<?php 
        ...
        $cartao="select COD_CLIENTE,NUM_CARTAO,NOM_CLIENTE from clientes where num_cartao='".$usuario."' AND COD_EMPRESA = $cod_empresa";
        $rcartao=mysqli_fetch_assoc(mysqli_query(connTemp($cod_empresa,''), $cartao));

        $sqlproc="CALL SP_VERIFICA_TOKEN('".$cod_empresa."', '".$rcartao['COD_CLIENTE']."')";
        $returnproc=mysqli_fetch_assoc(mysqli_query(connTemp($cod_empresa,''), $sqlproc));
         //fnEscreve($sqlproc);
        if($returnproc['v_RESULTADO']=='S' && $rcartao['NUM_CARTAO'] != 0 && $rcartao['NUM_CARTAO'] != ""){    
          ...
          $sqlToken = "SELECT * FROM TOKEM 
                       ...
                       AND LOG_USADO = 'N'";
          $arrayToken = mysqli_query(connTemp($cod_empresa,''), $sqlToken);
        ...
        $img='';
        $msg_placa = "";
        $tpAtendente = "atendente";
        if($cod_empresa == 19){
          $tpAtendente = "frentista";
        ...
        <div class="container text-center">
          ...
          <div class="col-xs-12 text-center shadow2 fundoCel1" style=" color: <?=$cor_textfull?>; background-color: <?=$cor_fullpag?>;  border-radius: 30px 30px 5px 5px;">
            ...
            <div class="col-md-12 textoCel1">
                ...
                <span class="f21">
                    <strong style="font-size: 36px;"><?php echo $qrToken['des_tokem']; ?></strong>
                </span>
            </div>
          ...
          <?php if($msg != "Limite excedido!"){ ?>
            ...
            <div class="row">
              <div class="col-xs-12 text-center">
                <p class="f14">Token de desconto gerado para</p>
            ...
            <div class="col-xs-12">
              <p>Para obter seu desconto no momento do pagamento, apresente este código ao <?=$tpAtendente?></p>
            </div>
