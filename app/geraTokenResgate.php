<?php 
    ...
    $cartao="SELECT COD_CLIENTE, NUM_CGCECPF, NOM_CLIENTE FROM CLIENTES WHERE NUM_CARTAO='".$usuario."' AND COD_EMPRESA = $cod_empresa";
    ...
    if(1==1){
      // $linkCode = "$senha";
        $cpf = fnCompletaDoc($rcartao['NUM_CGCECPF'],"F");
        $linkCode = "$cpf\t$senha";
    }
  ...
  .f20{
    font-size: 20px;
        ...
        <div class="container text-center">
          ...
          <div class="col-xs-12">
            <p class="f16">Para obter seu resgate no momento do pagamento, apresente este código ao <?=$tpAtendente?>, junto com um <b>comprovante de identidade</b></p>
          </div>
