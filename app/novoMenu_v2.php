...
*/
    ...
    <div class="container" style="background-color: <?= $cor_fullpag ?>;">
        ...
        <!-- <div class="col-xs-12 text-center outline fundoCel1" style=" color: <?= $cor_textfull ?>; background-color: <?= $cor_fullpag ?>;  border-radius: 30px 30px 5px 5px;">
        ...
        <div class="row" style="border-radius: 15px 15px 0px 0px; margin-bottom: 0; margin-top:35px; background-color: <?= $cor_backpag ?>;">
