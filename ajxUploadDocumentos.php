...
function upload() {
	...
	$cod_objetoanexo = fnLimpaCampoZero($_REQUEST["ido"]);
	...
	$nom_origem = $cod_empresa.".".$cod_cliente.".".date("Ymdhis").".".$num_contador;
	$diretorio = "/media/clientes/".$cod_empresa."/documentos/documento.".$cod_cliente."/";
