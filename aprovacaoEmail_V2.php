											...
											<div class="form-group text-right col-lg-12" style="<?=$hideBtn?>">
												...
												<?php
													...
													if($cadastrar == 'N'){
														...
														if($dat_envio_global == "" && $qtd_email >= $lista_envio){ 
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$('#loadMore').click(function(){
				...
				$.ajax({
					type: "GET",
					url: "ajxAprovacaoEmail_V2.php?opcao=loadMore&itens="+cont+"&id=<?=fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>",
					beforeSend:function(){	
		...
		function okCliente(cod_controle,count){
			...
			$.ajax({
				type: "POST",
				url: "ajxAprovacaoEmail_V2.php?opcao=okCliente&id=<?=fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>",
		...
		function enviarAprovacao(){
			...
			$.ajax({
				type: "POST",
				url: "ajxEnvioTeste_V2.php?id=<?=fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>",
