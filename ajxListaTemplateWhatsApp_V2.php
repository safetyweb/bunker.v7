...
if ($_REQUEST['LOG_ALL'] == 'N') {
	$joinTempl = "INNER JOIN TEMPLATE_WHATSAPP_CAMPANHA TEC ON TEC.COD_TEMPLATE = TE.COD_TEMPLATE AND TEC.COD_CAMPANHA = $cod_campanha
...
if($cod_template != 0){
	...
	if($clone == 'true'){
		...
		$sqlExc = "UPDATE TEMPLATE_WHATSAPP SET 
		LOG_ATIVO = 'N',
