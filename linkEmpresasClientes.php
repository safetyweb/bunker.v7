									...
									<div class="form-group">
										...
										<select data-placeholder="Selecione uma empresa" name="COD_EMPRESA" id="COD_EMPRESA" class="chosen-select-deselect requiredChk" required="required">
											...
											while ($qrListaEmpresa = mysqli_fetch_assoc($arrayQuery)) {
												...
												echo "
																				  <option value='" . fnEncode($qrListaEmpresa['COD_EMPRESA']) . "' " . $desabilitado . " >" . $qrListaEmpresa['NOM_FANTASI'] . " " . $qrListaEmpresa['COD_EMPRESA'] . "</option> 
																				";
											}
											?>
										</select>
										...
										<script>
											$("#formulario #COD_EMPRESA").val("<?php echo $cod_empresaCode; ?>").trigger("chosen:updated");
										</script>
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" class="form-control input-sm sp_celphones" name="NUM_CELULAR" value="<?php $num_celular ?  fnCorrigeTelefone($num_celular) : ''; ?>" id="NUM_CELULAR" maxlength="20">
										<div class="help-block with-errors"></div>
									</div>
								</div>
