		...
		?>
			...
			<div class="col-md-12 col-xs-12">
				<div class="form-group">
					...
					<input type="password" value="" class="form-control input-sm input-hg <?=$inteiro?>" name="DES_SENHAUS" id="DES_SENHAUS" maxlength='<?=$maxSenha?>' required>
			...
			<div class="col-md-12 col-xs-12">
				<div class="form-group">
					...
					<input type="password" value="" class="form-control input-sm input-hg <?=$inteiro?>" name="DES_SENHAUS_CONF" id="DES_SENHAUS_CONF" maxlength='<?=$maxSenha?>' data-match="#DES_SENHAUS" data-match-error="Senhas diferentes" required>
