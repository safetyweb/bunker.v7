...
// busca dados campanha 22
	...
	if($qrCamp){
		...
		$txt_bannercad = $qrCamp['TXT_BANNERCAD'];
	}else{
		$img_bannercad = "";
		$txt_bannercad = "";
	}
...
<body>
	...
	<div class="row" id="corpoForm">
		...
		<form data-toggle="validator" role="form2" method="post" id="formulario" action="cadastro_V2.do?id=<?=fnEncode($cod_empresa)?>&pop=true&campanha=<?=$chaveCampanha?>" autocomplete="off">
			...
			<div class="col-md-6 col-xs-12" id="caixaImg">
				...
				<img id="img-banner-desktop" src="https://img.bunker.mk/media/clientes/<?php echo $cod_empresa; ?>/<?=$des_img_g?>" class="img-responsive desktop" style="margin-left: auto; margin-right: auto;">
				<img id="img-banner-tablet" src="https://img.bunker.mk/media/clientes/<?php echo $cod_empresa; ?>/<?=$des_img?>" class="img-responsive tablet" style="margin-left: auto; margin-right: auto;">
				<img id="img-banner-mobile" src="https://img.bunker.mk/media/clientes/<?php echo $cod_empresa; ?>/<?=$des_imgmob?>" class="img-responsive mobile" style="margin-left: auto; margin-right: auto;">
			...
			<div class="col-md-6 col-xs-12" id="caixaForm" style="background-color: #FFF;">
				...
				<?php if ($txt_bannercad != "") { ?>
					<div id="camp22" class="row">
						<div class="col-md-12">
				...
				switch ($qrCampos[COD_CHAVECO]) {
					...
					$label = "CPF/CNPJ";
					$charLenght = "18";
					$bloqueiaPj = $qrCampos['LOG_BLOQUEIAPJ'];
					...
					<div class="col-md-12 col-xs-12">
						<div class="form-group">
							...
							<input type="tel" style="font-size: 38px;" class="form-control input-hg input-lg text-center campo1 cpfcnpj" maxlength="<?=$charLenght?>" name="KEY_NUM_CGCECPF" id="KEY_NUM_CGCECPF" required>
							<div class="help-block with-errors"></div>
						</div>
					</div>
				...
				<div class="col-xs-12">
					<button type="submit" name="CAD" id="CAD" class="btn btn-primary btn-lg btn-block getBtn validaCPF" tabindex="5"><i class="fa fa-search" aria-hidden="true"></i>&nbsp; Entrar</button>
				</div>
...
<!-- <script src="https://bunker.mk/js/plugins/jquery.tablesorter.min.js" type="text/javascript"></script>
	...
	<script type="text/javascript">
		...
		//chosen
			...
			$(".campo1,.campo2").keydown(function(){
				...
				if(campo1 != "" || campo2 != ""){
					...
					$(".campo1,.campo2").prop("required", false);
					$(".control-label").removeClass("required");

				}else{

					$(".campo1,.campo2").prop("required", true);
