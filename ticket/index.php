...
include "../_system/_functionsMain.php";
	...
	$sql1 = "SELECT CL.*, UV.NOM_FANTASI FROM CLIENTES CL
							...
							<div class="bloco">
								...
								<div style="display: flow-root;">
									<div class="bloco" style="font-size: 14px;">							
										<?php
										if($log_emisdia!= 'N'){$param="and LOG_EMISDIA='S' and DAT_VALIDADE >= '".date('Y-m-d')."'";}
											else{$param="and LOG_EMISDIA='N'";}  
							...
							?>
								<div class="bloco">
									<center>
	                                    ...
	                                    if ($qrListaModelos['COD_BLTEMPL']==15){echo "<br/><span style='font-size: 18px;'>".$num_cgcecpf."</span>";}
										?>								
									...
									<div class="bloco" style="font-size: 14px;">							
										...
										$alinha == "right";
											...
											foreach($OFERTASTKT as $row) {
												$PRDAGRUPO[$row['desconto']][$row['categoria']][]= array(   'categoria'=>$row['categoria'],
...
?>
			...
			<center><h2>Não há template configurada.</h2></center>
<?php 
