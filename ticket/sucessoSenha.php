...
$sqlSenha = "UPDATE CLIENTES SET DES_SENHAUS = '$des_senhaus' 
			...
			<form data-toggle="validator" role="form2" method="post" id="formulario" autocomplete="off">
				...
				<div class="col-md-6 col-xs-12" id="caixaForm" style="background-color: #FFF;">
					...
					<div class="text-center">
						...
						<p>Faça o <b>login</b> para <b>atualizar seu cadastro</b> e visualizar seu extrato!</p>
						<a href="javascript:void(0)" class="btn btn-info btn-block" onclick='
																						parent.loginCliente("<?=$keyCli?>", "<?=$senha?>");
																						// parent.$("#<?=$campoLogin?>").val("<?=$dadoLogin?>"); 
