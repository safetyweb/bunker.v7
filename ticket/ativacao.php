	...
	#blocker div
	{
		...
		<section id="contact">
				...
				<div class="row" id="relatorioToken" style="overflow: hidden;">
							...
							<div class="col-md-6 col-md-offset-3 col-xs-12"><!--  TOKEN ----------------------------------------------------------------------------------------------------------------------------------------------------- -->
					        	...
					        	<div class="col-md-8 col-xs-12 text-left p-r-0">
									<div class="form-group">
										...
										<input type="<?=$type?>" placeholder="Digite o token" name="DES_TOKEN" id="DES_TOKEN" value="" maxlength="<?=$qtd_chartkn?>" class="form-control input-lg" style="border-radius:0 3px 3px 0; height:66px;" data-error="Campo obrigatório">
								...
								<div class="col-md-4 col-xs-12 p-l-0">
									<!-- <label>&nbsp;</label> -->
									<a href="javascript:void(0)" style="width: 100%; border-radius: 0!important; height:66px; padding-top: 20px;" class="btn btn-info btn-lg f18 tkn" onclick="ajxAtivacao(this, 'TKN')">Clique aqui para validar o token</a>
								</div>
					...
					<div class="col-xs-12 text-center" id="erroValidado" style="display: none;">
						<div class="push10"></div>
						<p class="f18 text-success">Seu cadastro <b>já está validado</b>.</p>
						<p class="f18 text-success"><a href="https://<?=$des_dominio.$extensaoDominio?>"><b>Clique aqui</b></a> para se <b>logar</b> e consultar seu saldo ou atualizar seu cadastro.</p>
					</div>
					...
					$.ajax({
						...
						success:function(data){
							...
							if(data == '000999000'){
								...
								$('#erroValidado').show();
								$("#blocker").hide();
							}else if(data != '000999000' && data != '0'){
								// 22/11/2021 - Rone pediu pra tirar validação dos dados
								window.location.replace("https://<?=$des_dominio.$extensaoDominio?>/active.do?idC="+data+"&atv=true");
								// if(tipo == 'KEY'){
								// 	window.location.replace("https://<?=$des_dominio.$extensaoDominio?>/confirmaDadoCadastro.do?id=<?=fnEncode($cod_empresa)?>&idc="+data+"&atv=true");
								// }else{
								// 	window.location.replace("https://<?=$des_dominio.$extensaoDominio?>/active.do?idC="+data+"&atv=true");
								// }
							}else{
...
<html lang="en">
    ...
    <!-- Scrollspy set in the body -->
    <body id="home" data-spy="scroll" data-target=".main-nav" data-offset="73" style="height: 100vh;">
