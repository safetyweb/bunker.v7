			...
			<div class="col-md-6 col-xs-12" id="caixaForm" style="background-color: #FFF;">
				...
				<div class="col-md-12 col-xs-12">
					<div class="form-group">
						...
						<input type="password" placeholder="Nova Senha" style="font-size: 36px;" class="form-control input-hg input-lg text-center <?= $wizardSenha ?>" name="DES_SENHAUS" id="DES_SENHAUS" minlength="<?= $min_senha ?>" maxlength="<?= $max_senha ?>" autocomplete="new-password" required>
						<span toggle="#DES_SENHAUS" class="fa fa-fw fa-eye field-icon toggle-password"></span>
						<div class="help-block with-errors"><?= $helpSenha ?></div>
					</div>
				</div>
				...
				<div class="col-md-12 col-xs-12">
					<div class="form-group">
						<label style="font-size: 11px;"><?= $tipo ?></label>
						<input type="password" placeholder="Confirmar Senha" style="font-size: 36px;" class="form-control input-hg input-lg text-center <?= $wizardSenha ?>" name="DES_SENHAUS_CONF" id="DES_SENHAUS_CONF" minlength="<?= $min_senha ?>" maxlength="<?= $max_senha ?>" data-match="#DES_SENHAUS" data-match-error="Senhas diferentes" required>
