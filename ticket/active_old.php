												...
												<div class="col-md-<?=$colMd?> col-xs-<?=$colXs?>">
													<div class="form-group">
														...
														<label for="inputName" class="control-label <?=$required?>">Sexo</label>
															...
															<script type="text/javascript">$(function(){$("#COD_SEXOPES").val("<?=$buscaconsumidor[sexo]?>").trigger('chosen:updated')});</script>    
														<div class="help-block with-errors"></div>
													</div>
												</div>
												...
												<div class="col-md-<?=$colMd?> col-xs-<?=$colXs?>">
													<div class="form-group">
														...
														<label for="inputName" class="control-label <?=$required?>">Profissão </label>
															...
															<script type="text/javascript">$(function(){$("#COD_PROFISS").val("<?=$dado?>").trigger('chosen:updated')});</script>                                                    
														<div class="help-block with-errors"></div>
													</div>
												</div>
												...
												<div class="col-md-<?=$colMd?> col-xs-<?=$colXs?>">
													<div class="form-group">
														...
														<label for="inputName" class="control-label <?=$required?>">Estado Civil</label>
															...
															<script type="text/javascript">$(function(){$("#COD_ESTACIV").val("<?=$dado?>").trigger('chosen:updated')});</script>
															<div class="help-block with-errors"></div>
													</div>
												</div>
									...
									?>
											<div class="col-md-<?=$colMd?> col-xs-<?=$colXs?>">
												<div class="form-group">
			                                        ...
			                                        <script>$(function(){$("#formulario #COD_ESTADOF").val("<?php echo $dado; ?>").trigger("chosen:updated")}); </script>
													<div class="help-block with-errors"></div>
												</div>
											</div>
