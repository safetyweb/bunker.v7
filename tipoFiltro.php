...
?>
				...
				case 'ALT':
					...
					$sqlUpdate = "UPDATE TIPO_FILTRO SET
...
<?php
				...
				case 'EXC':
					...
					$sqlExc = "DELETE FROM TIPO_FILTRO
								WHERE COD_TPFILTRO = $cod_tpfiltro;
					...
					$arrayExc = mysqli_multi_query(conntemp($cod_empresa, ""), $sqlExc);
					// echo "<pre>";
					// print_r(conntemp($cod_empresa,""));
					// echo "</pre>";
					if (!$arrayExc) {

						$cod_erro = Log_error_comand($connAdm->connAdm(), conntemp($cod_empresa, ""), $cod_empresa, $actual_link, $MODULO, $COD_MODULO, $sqlExc, $nom_usuario);
					}
							...
							<form name="formLista">
								...
								<table class="table table-bordered table-striped table-hover table-sortable tableSorter">
									...
									<tbody>
										...
										$sql = "SELECT COD_TPFILTRO, DES_TPFILTRO, LOG_REQUIRED FROM TIPO_FILTRO WHERE COD_EMPRESA = $cod_empresa ORDER BY NUM_ORDENAC";
