<?php
	...
	if (!empty(fnLimpacampo(fnDecode($_GET['id'])))){
		...
		*/
		...
		$sqlPers = "select DES_PERSONA, LOG_BLOQUEA from persona where cod_persona = '".$cod_persona."' and COD_EMPRESA = '".$cod_empresa."' 		
		";
								...
								<div class="portlet-body">
									...
									<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
										...
										<div  class="col-sm-12"	style="padding-left: 0;">
											...
											<div class="col-xs-2" style="padding-left: 0;"> <!-- required for floating -->
											  ...
											  <ul class="vTab nav nav-tabs tabs-left text-center">
												...
												<li class="vTab">				
													<a href="#filtros" data-toggle="tab">
													<?php if ($bl3_total>0) { ?>
													<div class="notify-badge text-center" id="notificaFrequencia"><span><?php echo $bl3_total; ?></span></div>
													<?php } ?>
													<i class="fal fa-tags fa-2x" style="margin: 10px 0 2px 0"></i>
													<h5 class="hidden-xs" style="margin: 3px 0 0 0">Filtros <br> Dinâmicos</h4>												
													</a>
												</li>
												...
												<li class="vTab">				
													...
													<?php } ?> 
													<i class="fal fa-map-marked-alt fa-2x" style="margin: 10px 0 2px 0"></i>
													<h5 class="hidden-xs" style="margin: 3px 0 0 0">Localização</h4>												
													</a>
												</li>
												...
												<li class="vTab">				
													...
													<?php } ?>
													<i class="fal fa-calendar-alt fa-2x" style="margin: 10px 0 2px 0"></i>
													<h5 class="hidden-xs" style="margin: 3px 0 0 0">Agenda</h4>											</a>
												</li>
											...
											<div class="col-xs-10">
											  ...
											  <div class="tab-content">
												...
												<div class="tab-pane active" id="perfil">
													<h3 style="margin: 0 0 5px 0;"><span class="bolder">Configuração de Perfil</span></h3>
													...
													<div class="row">
														...
														<h5 style="margin: 0 0 5px 15px;"><span class="bold">Seleção do Perfil</span></h5>
														<div class="push20"></div> 
												...
												<h3 style="margin: 0 0 5px 0;"><span class="bolder">Filtros Dinâmicos</span> </h3>

													<?php /////// Bloco Filtros //////// ?>	
													<?php include "perfilFiltros.php"; ?>
													
												</div>
												
												<!-- aba localizacao-->
												<div class="tab-pane" id="localizacao">
												<h3 style="margin: 0 0 5px 0;"><span class="bolder">Localização</span></h3>
												
													<?php //////// Bloco Localização /////// ?>	
													<?php include "perfilLocalizacao.php"; ?>
												
												</div>
												
												<!-- aba agenda-->
												<div class="tab-pane" id="agenda">
												<h3 style="margin: 0 0 5px 0;"><span class="bolder">Agenda</span></h3>
										...
										<div class="form-group text-right col-lg-12">
											...
											<button type="submit" name="CAD" id="CAD" class="btn btn-lg btn-primary getBtn"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Cadastrar Perfil</button>
											<?php } else { ?>
											<button type="submit" name="ALT" id="ALT" class="btn btn-lg btn-primary getBtn atualizaPersona" <?php echo $bloqueiaAlt; ?> ><i class="fa fa-repeat" aria-hidden="true"></i>&nbsp; Atualizar Perfil</button>
											<?php } ?>
										</div>
									...
									<div class="scrollPersona">
										<div class="widget widget-primary widget-item-icon">
											...
											<div class="widget-data">
												...
												<div class="widget-title" style="text-align: center;">Perfis Selecionados</div>
											</div>													                        
										</div>	
									</div>
