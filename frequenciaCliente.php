	...
	if (isset($_SESSION['last_request']) && $_SESSION['last_request'] == $request) {
		...
		if ($opcao != '') {
			...
			switch ($opcao) {
				...
				case 'ALT':
					$sqlUpdate = "UPDATE FREQUENCIA_CLIENTE SET							
					...
					if (!$arrayUpdate) {
						...
						$cod_erro = Log_error_comand($connAdm->connAdm(), conntemp($cod_empresa, ''), $cod_empresa, $actual_link, $MODULO, $COD_MODULO, $sqlUpdate, $nom_usuario);
					}
				...
				case 'EXC':
					$sql = "DELETE FROM FREQUENCIA_CLIENTE WHERE COD_FREQUENCIA = $cod_frequencia;";
...
$sql = "SELECT * FROM FREQUENCIA_CLIENTE WHERE COD_EMPRESA = $cod_empresa";
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label for="inputName" class="control-label required">Ciclo de Recompra <small>(em dias)</small></label>
								...
								<div class="col-md-3">
									<div class="form-group">
										<label for="inputName" class="control-label required">Momento da Classificação</label>
								...
								<div class="col-md-3">
									<div class="form-group">
										<label for="inputName" class="control-label required">Período de Inatividade <small>(em dias)</small></label>
										<input type="text" class="form-control text-center input-sm int" name="QTD_INATIVO" id="QTD_INATIVO" maxlength="3" value="<?php echo $qtd_inativo ?>" required>
										<div class="help-block with-errors">para uso no relatório analytics</div>
									</div>
								</div>
						...
						<fieldset>
							...
							<div class="row">
								...
								<div class="col-md-2" style="width: 20%!important">
									<div class="form-group">
										<label for="inputName" class="control-label">% Casual</label>
										<input type="text" class="form-control input-sm text-center money" name="PCT_CASUAIS" id="PCT_CASUAIS" maxlength="6" value="<?= $pct_casuais ?>">
								...
								<div class="col-md-2" style="width: 20%!important">
									<div class="form-group">
										<label for="inputName" class="control-label">% Frequente</label>
										<input type="text" class="form-control input-sm text-center money" name="PCT_FREQUENTES" id="PCT_FREQUENTES" maxlength="6" value="<?= $pct_frequentes ?>">
										<div class="help-block with-errors"></div>
									</div>
								</div>
								...
								<div class="col-md-2" style="width: 20%!important">
									<div class="form-group">
										<label for="inputName" class="control-label">% Fiel</label>
										<input type="text" class="form-control input-sm text-center money" name="PCT_FIEIS" id="PCT_FIEIS" maxlength="6" value="<?= $pct_fieis ?>">
										<div class="help-block with-errors"></div>
									</div>
								</div>
								...
								<div class="col-md-2" style="width: 20%!important">
									<div class="form-group">
										<label for="inputName" class="control-label">% Fã</label>
										<input type="text" class="form-control input-sm text-center money" name="PCT_FANS" id="PCT_FANS" maxlength="6" value="<?= $pct_fans ?>">
										<div class="help-block with-errors"></div>
									</div>
								</div>
								...
								<div class="col-md-2" style="width: 20%!important">
									<div class="form-group">
										...
										<input type="text" class="form-control input-sm text-center money leitura" readonly="readonly" name="TOT_CLIENTE" id="TOT_CLIENTE" maxlength="20" value="<?= fnValor(($pct_fans + $pct_fieis + $pct_frequentes + $pct_casuais), 2) ?>">
	...
	<div class="modal-dialog" style="">
		<div class="modal-content">
			...
			<div class="modal-body">
				<iframe frameborder="0" style="width: 100%; height: 90%" id="iframe"></iframe>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
