												...
												<div class="row">
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm leitura" readonly="readonly" name="COD_PROFISS" id="COD_PROFISS" value="">
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm" name="DES_PROFISS" id="DES_PROFISS" maxlength="20" required>
												...
												<table class="table table-bordered table-striped table-hover">
												  <thead>
													<tr>
													  ...
													  <th class="bg-primary">Nome do Menu</th>
													</tr>
												  </thead>
												<tbody>
