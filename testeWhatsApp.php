<?php
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => "v4.chatpro.com.br/chatpro-8e47haohde/api/v1/status",
										...
										<fieldset>
											<legend>Dados Gerais</legend> 
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group">
															<label for="inputName" class="control-label">Nome do Grupo</label>
															<input type="text" class="form-control input-sm" name="DES_GRUPOTR" id="DES_GRUPOTR" maxlength="50" required>
