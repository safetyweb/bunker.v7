  ...
  //echo fnDebug('true');
	...
	if (!empty(fnLimpacampo(fnDecode($_GET['id'])))){
		...
		*/
		...
		$percIdade1 = ($valor1/$totIdade)*100;
		$percIdade2 = ($valor2/$totIdade)*100;
		$percIdade3 = ($valor3/$totIdade)*100;
		$percIdade4 = ($valor4/$totIdade)*100;
		$percIdade5 = ($valor5/$totIdade)*100;
		$percIdade6 = ($valor6/$totIdade)*100;
		$percIdade7 = ($valor7/$totIdade)*100;
