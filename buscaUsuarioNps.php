...
<div class="row">
				...
				<div class="portlet-body">
					...
					<div class="login-form">
						...
						<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
							...
							<?php
							if (isset($RedirectPg) && !is_null($RedirectPg)) {
	...
	<script type="text/javascript">
		...
		function downForm(index) {
			...
			var cod_usuario = $("#ret_COD_USUARIO_" + index).val();

			$.ajax({
				method: 'POST',
				url: 'ajxUsuarioNps.do?id=<?= fnEncode($cod_empresa) ?>&idc=<?= fnEncode($cod_campanha) ?>',
				data: {
