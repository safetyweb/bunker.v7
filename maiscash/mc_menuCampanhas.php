								...
								<div class="row" style="margin: 0 0 0 1px;">
									...
									<div class="col-sm-6 col-md-4">
										<div class="service-block" style="visibility: visible;">
											<div class="ico fal fa-cart-plus highlight"></div>
											<div class="text-block">
												<h4>Campanhas</h4>
												<div class="text">Interaja e crie relacionamento com seus clientes</div>
												<div class="push10"></div>

												<span class="disabled-link"><a href="">&rsaquo; Cadastro de Boas Vindas</a> </span><br />

												<span class="disabled-link"><a href="">&rsaquo; Aniversariantes</a> </span><br />

												<span class="disabled-link"><a href="">&rsaquo; Vencimento de Crédito</a> </span><br />

												<span class="disabled-link"><a href="">&rsaquo; Vencimento de Crédito / Recuperação de Inativos</a> </span><br />

												<span class="disabled-link"><a href="">&rsaquo; Pesquisa de Satisfação</a> </span><br />

												<?php if (fnControlaAcesso("1485", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1485) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Compra de Créditos </a> <br />
												<?php } ?>
