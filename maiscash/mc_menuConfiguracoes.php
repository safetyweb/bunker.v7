								...
								<div class="row" style="margin: 0 0 0 1px;">
									...
									<div class="col-sm-6 col-md-4">
										<div class="service-block" style="visibility: visible;">
											<div class="ico fal fa-cogs highlight"></div>
											<div class="text-block">
												<h4>Configurações</h4>
												<div class="text">Personalize o seu programa</div>
												<div class="push10"></div>

												<?php if (fnControlaAcesso("1017", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1017) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Logins e Usuários</a> <br />
												<?php } ?>

												<?php if (fnControlaAcesso("1101", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1101) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Campos Obrigatórios <br />
													<?php } ?>

													<?php if (fnControlaAcesso("1698", $arrayParamAutorizacao) === true) { ?>
														<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1698) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Empresa </a> <br />
													<?php } ?>

													<?php if (fnControlaAcesso("1686", $arrayParamAutorizacao) === true) { ?>
														<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1686) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Regras do Programa </a> <br />
													<?php } ?>

													<?php if (fnControlaAcesso("1340", $arrayParamAutorizacao) === true) { ?>
														<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1340) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Personalização </a> <br />
													<?php } ?>

													<?php if (fnControlaAcesso("1683", $arrayParamAutorizacao) === true) { ?>
														<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1683) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Script de Abordagem </a> <br />
													<?php } ?>

													<?php if (fnControlaAcesso("1165", $arrayParamAutorizacao) === true) { ?>
														<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1165) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Hot Site </a> <br />
													<?php } ?>

													<?php if (fnControlaAcesso("1674", $arrayParamAutorizacao) === true) { ?>
														<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1674) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Termos de Aceite </a> <br />
													<?php } ?>

													<?php if (fnControlaAcesso("1188", $arrayParamAutorizacao) === true) { ?>
														<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1188) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Totem </a> <br />
													<?php } ?>
