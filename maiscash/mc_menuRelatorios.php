									...
									<div class="col-sm-6 col-md-4">
										<div class="service-block" style="visibility: visible;">
											...
											<div class="text-block">
												<h4>Relatórios </h4>
												<div class="text">Controle detalhado do seu programa</div>
												...
												<?php if (fnControlaAcesso("1303", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1303) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Cadastro Geral </a> <br />
												<?php } ?>
												...
												<?php if (fnControlaAcesso("1139", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1139) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Vendas</a> <br />
												<?php } ?>
												...
												<?php if (fnControlaAcesso("1135", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1135) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Vendas Vinculadas a Resgates</a> <br />
												<?php } ?>

												<?php if (fnControlaAcesso("1218", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1218) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Consolidado Mensal</a> <br />
												<?php } ?>
												...
												<?php if (fnControlaAcesso("1202", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1202) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Vendas Estornadas</a> <br />
												<?php } ?>

												<?php if (fnControlaAcesso("1191", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1191) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Vendas Bloqueadas <small><small>(ADM)</small></small></a> <br />
												<?php } ?>

												<?php if (fnControlaAcesso("1223", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1223) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Créditos a Expirar</a> <br />
												<?php } ?>
												...
												<?php if ($cod_empresa == 276) {  //pet shop patinho 
												?>
												...
												<?php if (fnControlaAcesso("1896", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1896) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Aniversariantes</a> <br />
												<?php } ?>
										...
										<div class="service-block" style="visibility: visible;">
											...
											<div class="text-block">
												...
												<?php if (fnControlaAcesso("1490", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1490) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Analytics</a> <br />
												<?php } ?>

												<?php if (fnControlaAcesso("1342", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1342) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Índice de Performance </a> <br />
												<?php } ?>

												<?php if (fnControlaAcesso("1773", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1773) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Concedidos X Resgatados </a> <br />
												<?php } ?>
										...
										<div class="service-block" style="visibility: visible;">
											...
											<div class="text-block">
												...
												<?php if (fnControlaAcesso("1233", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1233) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Comunicações Geradas</a> <br />
												<?php } ?>
												...
												<?php if (fnControlaAcesso("1671", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1671) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Dash de Entregabilidade</a> <br />
												<?php } ?>

												<?php if (fnControlaAcesso("1685", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1685) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Tokens</a> <br />
												<?php } ?>
