				...
				<div class="portlet-body">
					...
					<div class="login-form">
						...
						<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<select data-placeholder="Selecione um estado civil" name="TIP_PONTUACAO" id="TIP_PONTUACAO" class="chosen-select-deselect requiredChk" required>
												<option value="">...</option>					
							...
							<input type="hidden" name="VAL_PONTUACAO" id="VAL_PONTUACAO" value="">
							...
							<table class="table table-bordered table-striped table-hover table-sortable">
								...
								<tbody>
									...
									{														  
										...
										if ($qrBuscaCampanhaExtra['COD_VANTAGE'] == 1) { $tipoVantagem = "<span class='f12'><b> por R$ </b></span>"; }
										if ($qrBuscaCampanhaExtra['COD_VANTAGE'] == 3) { $tipoVantagem = "<span class='f12'><b> por Qtd. </b></span>"; }
										...
										<td><small>".$qrBuscaCampanhaExtra['DES_SUBCATE']."</small></td>
										<td><small>".$qrBuscaCampanhaExtra['NOM_FORNECEDOR']."</small></td>
