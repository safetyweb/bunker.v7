													...
													<div class="col-sm-6 col-md-4">
														<div class="service-block" style="visibility: visible;">
															...
															<div class="text-block">
																...
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1628)."&id=".fnEncode($cod_empresa)."&idc=".fnEncode($cod_campanha); ?>" target="_blank">&rsaquo; Pesquisa</a> <br/>
																<?php } ?>

																<?php if(fnControlaAcesso("1274",$arrayParamAutorizacao) === true) { ?>
																<a href="https://adm.bunker.mk/action.do?mod=<?php echo fnEncode(1274)."&id=".fnEncode($cod_empresa)."&idc=".fnEncode($cod_campanha); ?>" target="_blank">&rsaquo; Resultados</a> <br/>
																<?php } ?>
