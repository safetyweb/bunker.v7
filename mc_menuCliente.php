										...
										<div class="service-block" style="visibility: visible;">
											...
											<div class="text-block">
												...
												<?php if (fnControlaAcesso("1685", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1685) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Tokens Enviados</a> <br />
												<?php } ?>

												<?php if (fnControlaAcesso("1102", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/action.do?mod=<?php echo fnEncode(1102) . "&id=" . fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Clientes</a> <br />
												<?php } ?>
