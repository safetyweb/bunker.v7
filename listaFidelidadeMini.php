...
<link rel="stylesheet" href="css/widgets.css" />
											           		...
											           		<small>
											           			<div class="btn-group dropdown dropleft">
																	...
																	<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
																		...
																		<li><a href="action.do?mod=<?php echo fnEncode(1863)?>&id=<?php echo fnEncode($cod_empresa)?>&idx=<?php echo fnEncode($qrListaPersonas['COD_PERSONA'])?>">Acessar </a></li>
																		<li class="divider"></li>
                                                           ...
                                                           <td class="text-center">
											           		<small>
											           			<div class="btn-group dropdown dropleft">
																	...
																	<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
																		<li><a href='javascript:void(0)' class='addBox' data-url="action.do?mod=<?php echo fnEncode(1863)?>&id=<?php echo fnEncode($cod_empresa)?>&idx=<?php echo fnEncode($qrListaPersonas['COD_PERSONA'])?>&pop=true" data-title="Persona / <?php echo $qrListaPersonas['DES_PERSONA']; ?>">Editar </a></li>
																		<li><a href="action.do?mod=<?php echo fnEncode(1863)?>&id=<?php echo fnEncode($cod_empresa)?>&idx=<?php echo fnEncode($qrListaPersonas['COD_PERSONA'])?>">Acessar </a></li>
																		<li class="divider"></li>
																		<li><a href="javascript:void(0)" onclick='RefreshPersona("<?=fnEncode($cod_empresa)?>","","<?=fnEncode($qrListaPersonas[COD_PERSONA])?>")'>Desativar </a></li>
																		<li><a href="javascript:void(0)" onclick='excluiPersona("<?=fnEncode($cod_empresa)?>","<?=fnEncode($qrListaPersonas[COD_PERSONA])?>","<?=$qrListaPersonas[qtd_campanha]?>","<?=$qrListaPersonas[DES_PERSONA]?>")'>Excluir </a></li>
	...
	//-----------------------------------------------------------------------------------
		...
		function RefreshPersona(idEmp,tipo,cod_persona) {
			...
			$.ajax({
				type: "POST",
				url: "ajxRefreshPersonaMini.do",
				data: { COD_EMPRESA:idEmp, MASTER:"<?=$CarregaMaster?>", LOG_ATIVO:log_ativo, COD_PERSONA:cod_persona, LOG_PERSONASUSU: log_personasusu},
				beforeSend:function(){
				...
				$.alert({
		            ...
		            "Sim": {
		               ...
		               action: function(){
		               		$.ajax({
								type: "POST",
								url: "ajxRefreshPersonaMini.do?opcao=EXC",
								data: { COD_EMPRESA:idEmp, MASTER:"<?=$CarregaMaster?>", COD_PERSONA:cod_persona, LOG_PERSONASUSU: log_personasusu},
								beforeSend:function(){
