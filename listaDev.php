...
.highlight {
												...
												<div class="row" style="margin: 0 0 0 1px;">
													...
													<div class="col-sm-6 col-md-4">
														<div class="service-block" style="visibility: visible;">
															<div class="ico fa fa-users-cog highlight"></div>
													...
													<div class="col-sm-6 col-md-4 col-md-4">
														<div class="service-block" style="visibility: visible;">
															<div class="ico fa fa-cloud-download highlight"></div>
															<div class="text-block">
																<h4>Importações</h4>
																
																<a href="action.do?mod=<?php echo fnEncode(1276)."&id=".fnEncode($cod_empresa); ?>">&rsaquo; Importação de Planilhas</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1336)."&id=".fnEncode($cod_empresa); ?>">&rsaquo; Importação de Produtos</a> <br/>
													...
													<div class="col-sm-6 col-md-4 col-md-4">
														<div class="service-block" style="visibility: visible;">
															...
															<div class="text-block">
																<h4>Helpdesk Clientes</h4>

																<a href="action.do?mod=<?php echo fnEncode(1280)."&id=".fnEncode($cod_empresa); ?>">&rsaquo; Lista de Chamados</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1278)."&id=".fnEncode($cod_empresa); ?>">&rsaquo; Cadastro de Helpdesk</a> <br/>
													...
													<div class="col-sm-6 col-md-4 col-md-4">
														<div class="service-block" style="visibility: visible;">
															...
															<div class="text-block">
																<h4>Sistema</h4>
																<a href="action.do?mod=<?php echo fnEncode(1283)."&id=".fnEncode($cod_empresa); ?>">&rsaquo; Modelo de Tiles</a> <br/>
													...
													<div class="col-sm-6 col-md-4 col-md-4">
														<div class="service-block" style="visibility: visible;">
															<div class="ico fa fa-unlock-alt highlight"></div>
															<div class="text-block">
																<h4>Segurança</h4>
													...
													<div class="col-sm-6 col-md-4">
														<div class="service-block" style="visibility: visible;">
															...
															<div class="text-block">
																...
																<a href="action.do?mod=<?php echo fnEncode(1282); ?>">&rsaquo; Lista de Chamados</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1267); ?>">&rsaquo; Cadastro de Helpdesk</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1269); ?>">&rsaquo; Cadastro de Plataforma</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1270); ?>">&rsaquo; Cadastro de Tipo de Solicitação</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1271); ?>">&rsaquo; Cadastro de Versão da Integração</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1272); ?>">&rsaquo; Cadastro de Status</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1275); ?>">&rsaquo; Cadastro de Prioridade</a> <br/>
	...
	</script>	enha propriedades definidas
				ctx.stroke();
			}
