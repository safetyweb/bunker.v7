  ...
  <div class="col-md12 margin-bottom-30">
          ...
          <form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
            ...
            <div>
              ...
              <div class="row">
                ...
                //paginação
                $sql = "SELECT CL.COD_CLIENTE FROM  " . connTemp($cod_empresa, 'true') . ".CLIENTES CL
          ...
          <div class="portlet-body">
            ...
            <div class="row text-center">
              ...
              <div class="form-group text-center col-md-12 col-lg-12">
                ...
                <p><span><?php echo fnValor($total_itens_por_pagina, 0); ?></span></p>
                <p><b>Total de Clientes</b></p>

                <div class="push"></div>
                <span class="f26"><i class="far fa-users text-info"></i></span>
    ...
    <script type="text/javascript">
                ...
                action: function() {
                  ...
                  $.confirm({
                    ...
                    content: function() {
                      var self = this;
                      return $.ajax({
                        url: "relatorios/ajxLojaPreferencia.do?opcao=exportar&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa); ?>",
      ...
      function reloadPage(idPage) {
        $.ajax({
          type: "POST",
          url: "relatorios/ajxLojaPreferencia.do?opcao=paginar&id=<?php echo fnEncode($cod_empresa); ?>&idPage=" + idPage + "&itens_por_pagina=<?php echo $itens_por_pagina; ?>",
          data: $('#formulario').serialize(),
          beforeSend: function() {
