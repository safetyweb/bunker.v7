								...
								<table class="table table-bordered table-hover">
									...
									<thead>
										<tr>
											...
											<th class="f14 text-center"><b><span class="fa fa-users"></span>&nbsp; Vendas <br />Identificadas</th>
						...
						action: function() {
							...
							$.confirm({
								...
								content: function() {
									var self = this;
									return $.ajax({
										url: "relatorios/ajxRelVendasRTDuque.do?opcao=exportar&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa); ?>",
