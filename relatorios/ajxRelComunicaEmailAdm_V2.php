		...
		default:
			...
			?>
						...
						<tr>
				           ...
				           <td></td>
				           <td></td>
				           <td><small><span style="font-size: 10px;"><?=$pref?></span>&nbsp;Geração do lote #<?=$qrBuscaModulos['COD_CONTROLE']?>/<?=$qrBuscaModulos['COD_LOTE']?></small>&nbsp;<span class="f10"><?=$qrBuscaModulos['COD_DISPARO']?></span></td>
