						...
						<fieldset>
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="form-group">
										<label for="inputName" id='PERSONA' class="control-label">Persona</label>
							...
							<div class="row">
								...
								<div class="col-md-2">
									...
									<div class="form-group">
										<label for="inputName" class="control-label">Tipo do Relatório</label>
										<select data-placeholder="Selecione um tipo" name="TIP_RELAT" id="TIP_RELAT" class="chosen-select-deselect" style="width:100%;">
											<option value="1">Por unidade</option>
											<option value="2">Por clientes</option>
										</select>
										<div class="help-block with-errors"></div>
									</div>
									<script>
										$("#TIP_RELAT").val("<?= $tip_relat ?>").trigger("chosen:updated")
									</script>
								</div>
			...
			<div class="portlet portlet-bordered">
				...
				<div class="portlet-body">
					...
					<div class="row text-center">
						<div class="form-group text-center col-md-3 col-lg-3"></div>

						<div class="form-group text-center col-md-3 col-lg-3">

							<div class="push20"></div>

							<p><span class="f26" id="tot_CLI_PERSONAS"></span></p>
							<p><b>Personas</b></p>
						...
						<div class="form-group text-center col-md-3 col-lg-3">
							...
							<p><span class="f26" id="tot_PES_UNICAS"></p>
							<p><b>Clientes Unicos</b></p>
										...
										<thead>
											...
											<tr>
												...
												<th class="text-center text-info">
													<div class="form-group">
														<label for="inputName" style="font-size: 15px;" class="control-label text-center text-info"><small><b>Clientes <br> &nbsp;<span id="tot_QTD_CLIENTE_P1"></span></b> </small></label>
														<input type="hidden" class="form-control input-sm" name="TOUR_CLIENTES1" id="TOUR_CLIENTES1">
													</div>
												</th>
												<th class="text-center text-info"><small><small>Engajamento<br></small><b> &nbsp; <span id="tot_PCT_CLIENTE_P1"></span>%</b></small></th>
											</tr>
											<tr>
												<th class="text-center text-info"><small><small>Ind. Frequência <br></small><b> &nbsp; <span id="tot_IND_FREQ_P1"></span>x</b></small></th>
												<th class="text-center text-info"><small><small>Resgates <br></small><b> &nbsp;R$ <span id="tot_VAL_RESGATE_P1"></span></b> <small><br /><span id="tot_QTD_RESGATE_P1"></span></small> </small></th>
												<th class="text-center text-info">
													<div class="form-group">
														<label for="inputName" style="font-size: 15px;" class="control-label text-center text-info"><small><b>VVR% <br> &nbsp;<span id="tot_TOTALPERCETO1"></span>% </b> </small></label>
														<input type="hidden" class="form-control input-sm" name="TOUR_VVR" id="TOUR_VVR">
													</div>
												</th>
												<!-- <th class="text-center text-info"><small><small>VVR% <br></small><b> &nbsp;<span id="tot_TOTALPERCETO1"></span>% </b> </small></th> -->
											</tr>
									...
									<table class="table">
										...
										<thead>
											...
											<tr>
												...
												<th class="text-center text-info">
													<div class="form-group">
														<label for="inputName" style="font-size: 15px;" class="control-label text-center text-info"><small><b>Clientes <br> &nbsp;<span id="tot_QTD_CLIENTE_P2"></span></b> </small></label>
														<input type="hidden" class="form-control input-sm" name="TOUR_CLIENTES2" id="TOUR_CLIENTES2">
													</div>
												</th>
												<th class="text-center text-info"><small><small>Engajamento<br></small><b> &nbsp; <span id="tot_PCT_CLIENTE_P2"></span>%</b></small></th>
											</tr>
											<tr>
												<th class="text-center text-info"><small><small>Ind. Frequência <br></small><b> &nbsp; <span id="tot_IND_FREQ_P2"></span>x</b></small></th>
												<th class="text-center text-info"><small><small>Resgates <br></small><b> &nbsp;R$ <span id="tot_VAL_RESGATE_P2"></span> </b> <small><br /><span id="tot_QTD_RESGATE_P2"></span></small> </small></th>
												<th class="text-center text-info">
													<div class="form-group">
														<label for="inputName" style="font-size: 15px;" class="control-label text-center text-info"><small><b>VVR% </b><br> <b> &nbsp;<span id="tot_TOTALPERCETO2"></span>% </b> </small></label>
														<input type="hidden" class="form-control input-sm" name="TOUR_VVR" id="TOUR_VVR">
													</div>
												</th>
												<!-- <th class="text-center text-info"><small><small>VVR% <br></small><b> &nbsp;<span id="tot_TOTALPERCETO2"></span>% </b> </small></th> -->
												<th></th>
											</tr>
								...
								<fieldset>
									...
									<table class="table">
										...
										<thead>
											...
											<tr>
												<th class="text-center text-info"><small><small>Ind. Frequência <br></small><b> &nbsp; <span id="tot_PCT_FREQUENCIA"></span>%</b></small></th>
												<th class="text-center text-info"><small><small>Resgates <br></small><b> &nbsp;<span id="tot_PCT_RESGATE"></span>%</b></small> </small></th>
												<!-- <th class="text-center text-info"><small><small>VVR% <br></small><b> &nbsp;<span id="tot_PCT_VVR"></span>% </b> </small></th> -->
												<th class="text-center text-info">
													<div class="form-group">
														<label for="inputName" style="font-size: 15px;" class="control-label text-center text-info"><small><b>VVR% </b><br> <b> &nbsp;<span id="tot_PCT_VVR"></span>% </b> </small></label>
														<input type="hidden" class="form-control input-sm" name="TOUR_VVR" id="TOUR_VVR">
													</div>
												</th>
												<th></th>
								...
								<table class="table table-bordered table-hover tablesorter">
									...
									<thead>
										...
										<tr>
											...
											<th colspan="<?= $colspan ?>" class="text-center p1 {sorter:false}">1º Período</th>
											<th class="{sorter:false}"></th>
											<th colspan="<?= $colspan ?>" class="text-center {sorter:false}">2º Período</th>
											<th class="{sorter:false}"></th>
									...
									<tbody id="relatorioConteudo">
										...
										@$sqldelete = "DELETE FROM PCT_VENDA_PERSONA_AUX WHERE COD_EMPRESA = $cod_empresa";

										mysqli_query(connTemp($cod_empresa, ""), trim($sqldelete));
										...
										@$totalitens_por_pagina = mysqli_num_rows($arrayQuery);
										...
										while (@$qrCupom = mysqli_fetch_assoc($arrayQuery)) {
											...
											$VAL_TICKET_MEDIO_P1 = (@$qrCupom['QTD_TRANSACAO_P1'] != 0) ? (@$qrCupom['FATURAMENTO_P1'] / @$qrCupom['QTD_TRANSACAO_P1']) : 0; // ou outro valor padrão
											$VAL_TICKET_MEDIO_P2 = (@$qrCupom['QTD_TRANSACAO_P2'] != 0) ?  (@$qrCupom['FATURAMENTO_P2'] / @$qrCupom['QTD_TRANSACAO_P2']) : 0;
											...
											@$tot_VAL_RESGATE_P1 += @$qrCupom['TOTAL_VAL_RESGATE_P1'];
											@$tot_VAL_RESGATE_P2 += @$qrCupom['TOTAL_VAL_RESGATE_P2'];

											@$tot_QTD_RESGATE_P1 += @$qrCupom['TOTAL_QTD_RESGATE_P1'];
											@$tot_QTD_RESGATE_P2 += @$qrCupom['TOTAL_QTD_RESGATE_P2'];

											@$tot_VALOR_VINCULADO_P1 += @$qrCupom['VALOR_VINCULADO_P1'];
											@$tot_VALOR_VINCULADO_P2 += @$qrCupom['VALOR_VINCULADO_P2'];
											...
											//TOTALIZADORES PERIODOS
											$tot_VAL_TICKET_MEDIO_P1 = ($tot_QTD_TRANSACAO_P1 != 0) ? $tot_FATURAMENTO_P1 / $tot_QTD_TRANSACAO_P1 : 0;
											$tot_VAL_TICKET_MEDIO_P2 = ($tot_QTD_TRANSACAO_P2 != 0) ? $tot_FATURAMENTO_P2 / $tot_QTD_TRANSACAO_P2 : 0;
											$tot_PERC_FATURAMENTO = ($tot_FATURAMENTO_P1 != 0) ? (($tot_FATURAMENTO_P2 - $tot_FATURAMENTO_P1) / $tot_FATURAMENTO_P1) * 100 : 0;
											$tot_PERC_TICKET_MEDIO = ($tot_QTD_TRANSACAO_P1 != 0) ? (($tot_VAL_TICKET_MEDIO_P2 - $tot_VAL_TICKET_MEDIO_P1) / $tot_VAL_TICKET_MEDIO_P1) * 100 : 0;

											$tot_PERC_TRANSACAO = ($tot_QTD_TRANSACAO_P1 != 0) ? (($tot_QTD_TRANSACAO_P2 - $tot_QTD_TRANSACAO_P1) / $tot_QTD_TRANSACAO_P1) * 100 : 0;
											$tot_PERC_ITENS = ($tot_QTD_ITENS_P1 != 0) ? (($tot_QTD_ITENS_P2 - $tot_QTD_ITENS_P1) / $tot_QTD_ITENS_P1) * 100 : 0;
											$tot_PERC_CLIENTE = ($tot_QTD_CLIENTE_P1 != 0) ? (($tot_QTD_CLIENTE_P2 - $tot_QTD_CLIENTE_P1) / $tot_QTD_CLIENTE_P1) * 100 : 0;

											$tot_PCT_CLIENTE_P1 = ($tot_CLI_PERSONAS != 0) ? ($tot_QTD_CLIENTE_P1 / $tot_CLI_PERSONAS) * 100 : 0;
											$tot_PCT_CLIENTE_P2 = ($tot_CLI_PERSONAS != 0) ? ($tot_QTD_CLIENTE_P2 / $tot_CLI_PERSONAS) * 100 : 0;
											$tot_PCT_CLIENTE = ($tot_PCT_CLIENTE_P1 != 0) ? (($tot_PCT_CLIENTE_P2 - $tot_PCT_CLIENTE_P1) / $tot_PCT_CLIENTE_P1) * 100 : 0;

											$tot_IND_FREQ_P1 = ($tot_QTD_CLIENTE_P1 != 0) ? $tot_QTD_TRANSACAO_P1 / $tot_QTD_CLIENTE_P1 : 0;
											$tot_IND_FREQ_P2 = ($tot_QTD_CLIENTE_P2 != 0) ? $tot_QTD_TRANSACAO_P2 / $tot_QTD_CLIENTE_P2 : 0;
											$tot_PCT_FREQUENCIA = ($tot_IND_FREQ_P1 != 0) ? (($tot_IND_FREQ_P2 - $tot_IND_FREQ_P1) / $tot_IND_FREQ_P1) * 100 : 0;

											$tot_VVR_P1 = ($count != 0) ? ($tot_VVR_P1 / $count) : 0;
											$tot_VVR_P2 = ($count != 0) ? ($tot_VVR_P2 / $count) : 0;
											$tot_PCT_VVR = ($tot_VVR_P1 != 0) ? (($tot_VVR_P2 - $tot_VVR_P1) / $tot_VVR_P1) * 100 : 0;



											$vltotalperceto1 = ($tot_VAL_RESGATE_P1 != 0) ? fnValor(((($tot_VALOR_VINCULADO_P1 / $tot_VAL_RESGATE_P1) - 1) * 100), 2) : 0;
											if ($vltotalperceto1 < '0,00') {
												$vltotalperceto1 = '0,00';
											} else {
												$vltotalperceto1 = $vltotalperceto1;
											}

											$vltotalperceto2 = ($tot_VAL_RESGATE_P2 != 0) ? fnValor(((($tot_VALOR_VINCULADO_P2 / $tot_VAL_RESGATE_P2) - 1) * 100), 2) : 0;
											if ($vltotalperceto2 < '0,00') {
												$vltotalperceto2 = '0,00';
											} else {
												$vltotalperceto2 = $vltotalperceto2;
											}

											@$tot_PCT_RESGATE = ($vltotalperceto1 != 0) ? (($vltotalperceto2 - $vltotalperceto1) / $vltotalperceto1) * 100 : 0;

											//FIM TOTALIZADORES

											if (isset($qrCupom['LOJA'])) {
												$andLoja = $qrCupom['LOJA'];
											} else {
												$andLoja = "";
											}

											if (isset($qrCupom['NOME'])) {
												$andNome = $qrCupom['NOME'];
											} else {
												$andNome = "";
											}

											if (isset($qrCupom['EMAIL'])) {
												$andEmail = $qrCupom['EMAIL'];
											} else {
												$andEmail = "";
											}

											if (isset($qrCupom['CELULAR'])) {
												$andCelular = $qrCupom['CELULAR'];
											} else {
												$andCelular = "";
											}

											$sqlInsert = "
											INSERT INTO PCT_VENDA_PERSONA_AUX (
												COD_EMPRESA,
												LOJA,
												FATURAMENTO_P1,
												VAL_TICKET_MEDIO_P1,
												...
												TOTAL_CLIENTES_UNICOS_P1,
												TOTAL_CLIENTES_UNICOS_P2,
												TOTAL_VAL_RESGATE_P1,
												TOTAL_VAL_RESGATE_P2,
												TOTAL_QTD_RESGATE_P1,
												TOTAL_QTD_RESGATE_P2,
												TOTAL_VVR_P1,
												TOTAL_VVR_P2,
												VALOR_VINCULADO_P1,
												VALOR_VINCULADO_P2,
												...
												$cod_empresa,
												'" . $andLoja . "',
												'" . $qrCupom['FATURAMENTO_P1'] . "',
												'" . $qrCupom['VAL_TICKET_MEDIO_P1'] . "',
												'" . $qrCupom['QTD_TRANSACAO_P1'] . "',
												'" . $qrCupom['QTD_ITENS_P1'] . "',
												'" . $qrCupom['QTD_CLIENTE_P1'] . "',
												'" . $qrCupom['FATURAMENTO_P2'] . "',
												'" . $qrCupom['VAL_TICKET_MEDIO_P2'] . "',
												'" . $qrCupom['QTD_TRANSACAO_P2'] . "',
												'" . $qrCupom['QTD_ITENS_P2'] . "',
												'" . $qrCupom['QTD_CLIENTE_P2'] . "',
												'" . $qrCupom['PERC_FATURAMENTO'] . "',
												'" . $qrCupom['PERC_TICKET_MEDIO'] . "',
												'" . $qrCupom['PERC_TRANSACAO'] . "',
												'" . $qrCupom['PERC_ITENS'] . "',
												'" . $qrCupom['PERC_CLIENTE'] . "',
												'" . $qrCupom['TOTAL_CLI_PERSONAS'] . "',
												'" . $qrCupom['TOTAL_CLIENTES_UNICOS'] . "',
												'" . $qrCupom['TOTAL_CLIENTES_UNICOS_P1'] . "',
												'" . $qrCupom['TOTAL_CLIENTES_UNICOS_P2'] . "',
												'" . $qrCupom['TOTAL_VAL_RESGATE_P1'] . "',
												'" . $qrCupom['TOTAL_VAL_RESGATE_P2'] . "',
												'" . $qrCupom['TOTAL_QTD_RESGATE_P1'] . "',
												'" . $qrCupom['TOTAL_QTD_RESGATE_P2'] . "',
												'" . $qrCupom['TOTAL_VVR_P1'] . "',
												'" . $qrCupom['TOTAL_VVR_P2'] . "',
												'" . $qrCupom['VALOR_VINCULADO_P1'] . "',
												'" . $qrCupom['VALOR_VINCULADO_P2'] . "',
												'" . $andNome . "',
												'" . $andEmail . "',
												'" . $andCelular . "',
												'" . $cod_usucada . "'
									...
									<script type="text/javascript">
										...
										$("#tot_IND_FREQ_P1").text('<?= fnValor($tot_IND_FREQ_P1, 2) ?>');
										$("#tot_IND_FREQ_P2").text('<?= fnValor($tot_IND_FREQ_P2, 2) ?>');
										...
										$("#tot_VAL_RESGATE_P1").text('<?= fnValor($tot_VAL_RESGATE_P1, 2) ?>');
										$("#tot_VAL_RESGATE_P2").text('<?= fnValor($tot_VAL_RESGATE_P2, 2) ?>');

										$("#tot_QTD_RESGATE_P1").text('<?= fnValor($tot_QTD_RESGATE_P1, 0) ?>');
										$("#tot_QTD_RESGATE_P2").text('<?= fnValor($tot_QTD_RESGATE_P2, 0) ?>');

										$("#tot_VVR_P1").text('<?= fnValor($tot_VVR_P1, 2) ?>');
										$("#tot_VVR_P2").text('<?= fnValor($tot_VVR_P2, 2) ?>');

										$("#tot_TOTALPERCETO1").text('<?= $vltotalperceto1 ?>');
										$("#tot_TOTALPERCETO2").text('<?= $vltotalperceto2 ?>');

										$("#tot_PCT_FREQUENCIA").text('<?= fnValor($tot_PCT_FREQUENCIA, 2) ?>');
										$("#tot_PCT_RESGATE").text('<?= fnValor($tot_PCT_RESGATE, 2) ?>');
										$("#tot_PCT_VVR").text('<?= fnValor($tot_PCT_VVR, 2) ?>');
									</script>
											...
											<th colspan="100">
												<div class="btn-group dropdown dropleft">
													...
													<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
														<li><a href='javascript:void(0)' class='exportarCSV' data-tipo="1"><span class="fal fa-store"></span>&nbsp;Por unidade </a></li>
														<li><a href='javascript:void(0)' class='exportarCSV' data-tipo="2"><span class="fal fa-users"></span>&nbsp;Por cliente </a></li>
...
<script>
	...
	$(function() {
		...
		$('#TIP_RELAT').on('change', function() {
			var tip_relat = $(this).val();
			console.log(tip_relat);

			if (tip_relat == 2) {
				$('#COD_PERSONA').prop('required', true);
				$('#PERSONA').addClass('required');
			} else {
				$('#COD_PERSONA').prop('required', false);
				$('#PERSONA').removeClass('required');
			}
		});
		...
		$(".exportarCSV").click(function() {
			...
			var selectedValue = $('#TIP_RELAT').val();

			if (selectedValue === tipo.toString()) {
							...
							action: function() {
								...
								$.confirm({
									...
									content: function() {
										var self = this;
										return $.ajax({
											url: "relatorios/ajxPercPeriodoPersonas.do?opcao=exportar&tipo=" + tipo + "&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa); ?>",
				...
				$.confirm({
					title: 'Exportação',
					content: 'Para Exportar o CSV, o tipo de relatório tem que ser o mesmo que o selecionado na lista de pesquisa. Por favor, escolha o tipo de relatório corretamente.',
					buttons: {
						ok: {
							text: 'OK',
							btnClass: 'btn-blue',
	...
	function reloadPage(idPage) {
		$.ajax({
			type: "POST",
			url: "relatorios/ajxPercPeriodoPersonas.do?opcao=paginar&id=<?php echo fnEncode($cod_empresa); ?>&idPage=" + idPage + "&itens_por_pagina=<?php echo $itens_por_pagina; ?>",
			data: $('#formulario').serialize(),
			beforeSend: function() {
