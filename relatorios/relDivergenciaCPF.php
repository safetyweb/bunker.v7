...
<script type="text/javascript">
                        ...
                        action: function() {
                            ...
                            $.confirm({
                                ...
                                content: function() {
                                    var self = this;
                                    return $.ajax({
                                        url: "relatorios/ajxDivergenciaCPF.do?opcao=exportar&nomeRel=" + nome + "&id=<?= fnEncode($cod_empresa); ?>",
    ...
    function reloadPage(idPage) {
        $.ajax({
            type: "POST",
            url: "relatorios/ajxDivergenciaCPF.do?opcao=paginar&id=<?=fnEncode($cod_empresa); ?>&idPage=" + idPage + "&itens_por_pagina=<?=$itens_por_pagina; ?>",
            data: $('#formulario').serialize(),
            beforeSend: function() {
