									...
									<table class="table table-bordered table-hover tablesorter">
									  ...
									  <thead>
										<tr>
										  ...
										  <th><small>Val. Vinculado</small></th>
                                          <th><small>Tot. Resgate</small></th>
									  ...
									  <tbody id="relatorioConteudo">
										...
										<?php
											...
											$sql = "CALL SP_RELAT_CLIENTE_VENDAS_CONSUMO ( '$dat_ini' , '$dat_fim' , '$lojasSelecionadas', $cod_empresa) ";
											...
											while ($qrMovimenta = mysqli_fetch_assoc($arrayQuery))
											  {
												...
												?>
													<tr>
													  ...
													  <td class="text-right"><small>R$ <?=fnValor($qrMovimenta['VAL_VINCULADO'],2)?></small></td>
							...
							action: function () {
								...
								$.confirm({
									...
									content: function(){
										var self = this;
										return $.ajax({
											url: "relatorios/ajxRelMovCli.do?opcao=Emigra&nomeRel="+nome+"&id=<?php echo fnEncode($cod_empresa); ?>",
