                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <label for="inputName" class="control-label">Status Envio</label>
                                        <select data-placeholder="Selecione a campanha" name="COD_ENVIADO" id="COD_ENVIADO" class="chosen-select-deselect">
                                        ...
                                        <script type="text/javascript">
                                            $("#formulario #COD_ENVIADO").val('<?= $cod_enviado ?>').trigger("chosen:updated");
                                        </script>
                                    </div>
                                </div>
                            ...
                            <table class="table table-bordered table-hover tablesorter">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Campanha</th>
                                        <th>Loja</th>
                                        <th class="text-center">Dt. Fila</th>
                                        <th>Enviado</th>
                                    </tr>
                                </thead>
...
<script>
                        ...
                        action: function() {
                            ...
                            $.confirm({
                                ...
                                content: function() {
                                    var self = this;
                                    return $.ajax({
                                        url: "relatorios/ajxListaEnvio.do?opcao=exportar&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa); ?>",
    ...
    function reloadPage(idPage) {
        $.ajax({
            type: "POST",
            url: "relatorios/ajxListaEnvio.do?id=<?php echo fnEncode($cod_empresa); ?>&idPage=" + idPage + "&itens_por_pagina=<?php echo $itens_por_pagina; ?>&opcao=paginar",
            data: $('#formulario').serialize(),
            beforeSend: function() {
