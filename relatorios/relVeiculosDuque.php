								...
								<div class="portlet-body">
									...
									<div class="login-form">
										...
										<div class="row">
													...
													<?php	
														$sql = "select count(*) as totClientes from vw_mk_veiculo";
														...
														$sql = "select max(dt_alteracao) as maxData from vw_mk_veiculo";
														$qrListaVwDuque = mysqli_fetch_assoc(mysqli_query($connDUQUE->connDUQUE(),$sql)) or die(mysqli_error());
										...
										<div class="row">
											...
											<div class="col-md-12" id="div_Produtos">
												...
												<table class="table table-bordered table-hover  ">
												  ...
												  <thead>
													<tr>
													  <th><small>id_veiciculo</small></th>
													  <th><small>id_motorista</small></th>
													  <th><small>id_marca</small></th>
                                                                                                           <th><small>id_modelo</small></th>
													...
													<?php	
														$sql = "select * from vw_mk_veiculo limit 0,200";
														  ...
														  {														
															?>
																<tr style="background-color: #fff;">
																  <td><?php echo $qrListaVwDuque['id_veiculo']; ?></td>
																  <td><?php echo $qrListaVwDuque['id_motorista']; ?></td>
																  <td><?php echo $qrListaVwDuque['id_marca']; ?></td>
                                                                                                                                   <td><?php echo $qrListaVwDuque['id_modelo']; ?></td>
                                                                                                                                    <td><?php echo $qrListaVwDuque['placa']; ?></td>
