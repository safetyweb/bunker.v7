					...
					<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
						...
						<fieldset>
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" class="form-control input-sm" name="NUM_CARTAO" id="NUM_CARTAO" value="<?php echo $numCartao; ?>">
									</div>
								</div>

								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Cód. Cupom</label>
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Tipo de Ordenação</label>
										<select data-placeholder="Selecione a ordenação" name="TIP_ORDENAC" id="TIP_ORDENAC" class="chosen-select-deselect" style="width:100%;">
											<option value=""></option>
											<option value="1">Vl. Venda: Decrescente</option>
											<option value="2">Crédito: Decrescente</option>
										</select>
										<script>
											$("#TIP_ORDENAC").val("<?= $tip_ordenac ?>").trigger("chosen:updated");
										</script>
										<div class="help-block with-errors"></div>
									</div>
								</div>
								...
								<div class="col-md-1">
									...
									<div class="radio radio-info radio-inline">
										...
										<label for="tipoVenda2"> Fidelizadas </label>
									</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								if ($cod_cupom != "" && $cod_cupom != "0") {
									$andCupom = "AND A.COD_CUPOM = $cod_cupom ";
									$cupomContador = "AND B.COD_VENDA=A.COD_VENDA";
									$dataContador = "";
									$andData = "";
									$andDataWs = "";
								} else {
									$andCupom = "";
									$andData = "AND A.DAT_CADASTR_WS BETWEEN '$dat_ini 00:00:00' AND '$dat_fim 23:59:59'";
									$dataContador = "b.dat_reproce BETWEEN '$dat_ini 00:00'AND '$dat_fim 23:59:59'  AND";
									$cupomContador = "";
									$andDataWs = "A.DAT_CADASTR_WS BETWEEN '$dat_ini 00:00'AND '$dat_fim 23:59:59'     
										  AND";
								}
								...
								$sql = "SELECT
										...
										INNER JOIN clientes c ON c.cod_cliente=b.cod_cliente
										WHERE b.COD_UNIVEND IN($lojasSelecionadas) AND 
											  b.TIP_CREDITO='C'
											  	$cupomContador AND 
										...
										sum(ROUND(truncate(A.VAL_TOTPRODU,4), 2)) VAL_TOTPRODU,
										sum(ROUND(truncate(A.VAL_TOTVENDA,4),2)) VAL_TOTVENDA
										FROM VENDAS A
										INNER JOIN CLIENTES B ON A.COD_CLIENTE=B.COD_CLIENTE
										WHERE 
										  $andDataWs A.COD_EMPRESA = $cod_empresa														
					...
					<div class="portlet-body">
						...
						<div class="row text-center">
							...
							<div class="form-group text-center col-md-3 col-lg-3">
								...
								<input type="hidden" class="form-control input-sm" name="TOUR_TOT_VENDA_LIMPO" id="TOUR_TOT_VENDA_LIMPO">
								<div class="help-block with-errors"></div>
							...
							<div class="form-group text-center col-md-3 col-lg-3">
								...
								<p>R$ <span><?php echo fnValor($totalitens_por_pagina['VAL_CREDITO'], $casasDec); ?> </span></p>
								<p><b>Total de Créditos/Pontos</b></p>
