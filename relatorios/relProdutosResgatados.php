...
?>
					...
					<div class="row">
                                            ...
                                            <form data-toggle="validator" role="form data-toggle="validatorm2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm" name="DES_PRODUTO" id="DES_PRODUTO" value="<?=$des_produto?>">
								...
								<div class="portlet-body">		
									...
									<?php
										...
										while ($qrCont = mysqli_fetch_assoc($arrayCont)) {
											$tot_produto += $qrCont[QTD_PRODUTO];
											$val_total += $qrCont[VAL_TOTPROD];
										}

										//fnEscreve($sql);
                                                                                      
										$total_itens_por_pagina = mysqli_num_rows($arrayCont);
									...
									<div class="flexrow">
										...
										<div class="form-group text-center col">
											...
											<p><span id="QTD_PRODUTO"><?=fnValor($tot_produto,0)?></span></p>
										...
										<div class="form-group text-center col">
											...
											<p><span id="VAL_TOTAL"><?=fnValor($val_total,2)?></span></p>
											<p><b>Valor Total</b></p>
														...
														while ($qrListaProd = mysqli_fetch_assoc($arrayQuery))
														  {
															...
															// $tot_produto += $qrListaProd[QTD_PRODUTO];
															// $val_total += $qrListaProd[VAL_TOTPROD];
   ...
   //      	$("#QTD_PRODUTO").text("<?=fnValor($tot_produto,0)?>");
			// $("#VAL_TOTAL").text("<?=fnValor($val_total,2)?>");
							...
							action: function () {
								...
								$.confirm({
									...
									content: function(){
										var self = this;
										return $.ajax({
											url: "relatorios/ajxProdutosResgatados.do?opcao=exportar&nomeRel="+nome+"&id=<?php echo fnEncode($cod_empresa); ?>", 
		...
		function reloadPage(idPage) {
			$.ajax({
				type: "POST",
				url: "relatorios/ajxProdutosResgatados.do?opcao=paginar&id=<?php echo fnEncode($cod_empresa); ?>&idPage="+idPage+"&itens_por_pagina=<?php echo $itens_por_pagina; ?>",
				data: $('#formulario').serialize(),
				beforeSend:function(){
