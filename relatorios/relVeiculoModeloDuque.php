								...
								<div class="portlet-body">
									...
									<div class="login-form">
										...
										<div class="row">
													...
													<?php	
														$sql = "select count(*) as totClientes from vw_mk_veiculo_modelo";
														...
														/*
														$sql = "select max(dt_alteracao) as maxData from vw_mk_clientes";
														$arrayQuery = mysqli_query($connDUQUE->connDUQUE(),$sql) or die(mysqli_error());
														$qrListaVwDuque = mysqli_fetch_assoc($arrayQuery);
											...
											<div class="col-md-12" id="div_Produtos">
												...
												<table class="table table-bordered table-hover  ">
												  ...
												  <thead>
													...
													<?php	
														$sql = "select * from vw_mk_veiculo_modelo limit 0,200";
														  ...
														  {														
															?>
																<tr style="background-color: #fff;">
																  <td><?php echo $qrListaVwDuque['cod_modelo']; ?></td>
																  <td><?php echo $qrListaVwDuque['nome']; ?></td>
																  <td><?php echo $qrListaVwDuque['marca']; ?></td>
																</tr>
															<?php
