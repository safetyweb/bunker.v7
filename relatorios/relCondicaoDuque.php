								...
								<div class="portlet-body">
									...
									<div class="login-form">
										...
										<div class="row">
													...
													<?php	
														$sql = "select count(*) as totClientes from vw_mk_condicao";
														...
														$sql = "select max(dt_alteracao) as maxData from vw_mk_condicao";
														$qrListaVwDuque =  mysqli_fetch_assoc(mysqli_query($connDUQUE->connDUQUE(),$sql)) or die(mysqli_error());
												...
												<table class="table table-bordered table-hover  ">
												  ...
												  <thead>
													<tr>
													  ...
													  <th><small>posto</small></th>
                                                                                                          <th><small>dt_alteracao</small></th>
                                                                                                        </tr>
												  </thead>
													
													<?php	
														$sql = "select * from vw_mk_condicao";
															...
															?>
																<tr style="background-color: #fff;">
																  ...
																  <td><?php echo $qrListaVwDuque['id_cliente']; ?></td>
                                                                                                                                  <td><?php echo $qrListaVwDuque['posto']; ?></td>
