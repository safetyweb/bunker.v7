							...
							<div class="col-md-12">
								...
								<table class="table table-bordered table-hover tablesorter">
									...
									<tbody id="relatorioConteudo">
										...
										$sql = "SELECT A.COD_INDICAD, (SELECT B.NOM_CLIENTE FROM CLIENTES B WHERE  B.COD_CLIENTE=A.COD_INDICAD),COUNT(*)
												FROM CLIENTES A
										...
										$sql = "SELECT A.COD_INDICAD, A.DAT_CADASTR, (SELECT B.NOM_CLIENTE FROM CLIENTES B WHERE  B.COD_CLIENTE=A.COD_INDICAD) INDICADOR,COUNT(*) QTD_INDICA
												FROM CLIENTES A
												WHERE A.COD_EMPRESA=$cod_empresa AND
												A.COD_INDICAD > 0 AND
												A.DAT_CADASTR BETWEEN '$dat_ini 00:00:00' AND '$dat_fim 23:59:59' AND 
										...
										while ($qrApoia = mysqli_fetch_assoc($arrayQuery)) {
											...
											echo "
												<tr>
												  <td>" . $qrApoia['INDICADOR'] . "</td>
												  <td class='text-center'>" . $qrApoia['QTD_INDICA'] . "</td>
												</tr>
												";
										}
									...
									<tfoot>
										...
										<tr>
											<th class="hidden-print" colspan="100">
												<center>
