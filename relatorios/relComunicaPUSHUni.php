                                        ...
                                        <table class="table table-bordered table-striped table-hover tablesorter" id="tablista">
                                            ...
                                            <tbody id="listaTemplates">
                                                ...
                                                while ($qrCampanhasEmail = mysqli_fetch_assoc($arrayQuery)) {
                                                    ...
                                                    <td class='text-right bold'><small>" . fnValor($cancelado, 0) . "<br/><span class='text-muted' style='font-size: 10px; font-weight: 100;'>" . fnValor($perc_cancela, 2) . "%</span></small></td>
                                                    </tr>                      
                                                    ";
...
<script type="text/javascript">
                    ...
                    action: function() {
                        ...
                        $.confirm({
                            ...
                            content: function() {
                                var self = this;
                                return $.ajax({
                                    url: "relatorios/ajxRelComunicaPUSHUni.do?opcao=exportar&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa); ?>",
    ...
    function RefreshCampanha(idEmp, idUnidade) {
        ...
        if (!idItem.is(':visible')) {
            $.ajax({
                type: "POST",
                url: "relatorios/ajxRelComunicaPUSHUni.do?idu=" + idUnidade,
                data: $("#formulario").serialize(),
                beforeSend: function() {
