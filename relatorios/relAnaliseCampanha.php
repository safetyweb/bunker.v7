								...
								<div class="col-md-12">
											...
											echo"
												<thead>
													<tr id='bloco_".$qrMov['COD_UNIVEND']."'>
													  ...
													  <th style='font-weight:400;' class='text-center'>".fnValor($qrMov['QTD_ANIVERSARIANTES'],0)."</th>
													  <th style='font-weight:400;' class='text-right'>R$ ".fnValor($qrMov['FATURAMENTO_ANIVERSARIANTE'],2)."</th>
													  <th style='font-weight:400;' class='text-right'>R$ ".fnValor($qrMov['FATURAMENTO_TOTAL'],2)."</th>
													  <th style='font-weight:400;' class='text-center'>".fnValor($qrMov['QTD_ANIVERSARIANTES_RESGATE'],0)."</th>
													  <th style='font-weight:400;' class='text-center'>".fnValor($qrMov['PERC_QTD_CLI_RESGATE'],2)."%</th>
													  <th style='font-weight:400;' class='text-center'>".fnValor($qrMov['PERC_CLI_FATURAMENTO'],2)."%</th>
													  <th style='font-weight:400;' class='text-right'>R$ ".fnValor($qrMov['TOTAL_RESGATE_ANIVERSARIANTE'],2)."</th>
													  <th style='font-weight:400;' class='text-right'>R$ ".fnValor($qrMov['VVR'],2)."</th>
													</tr>
												</thead>";

											$TOT_QTD_ANIVERSARIANTES += $qrMov['QTD_ANIVERSARIANTES'];
											$TOT_FATURAMENTO_ANIVERSARIANTE += $qrMov['FATURAMENTO_ANIVERSARIANTE'];
											$TOT_FATURAMENTO_TOTAL += $qrMov['FATURAMENTO_TOTAL'];
											$TOT_QTD_ANIVERSARIANTES_RESGATE += $qrMov['QTD_ANIVERSARIANTES_RESGATE'];
											$TOT_PERC_QTD_CLI_RESGATE += $qrMov['PERC_QTD_CLI_RESGATE'];
											$TOT_PERC_CLI_FATURAMENTO += $qrMov['PERC_CLI_FATURAMENTO'];
											$TOT_TOTAL_RESGATE_ANIVERSARIANTE += $qrMov['TOTAL_RESGATE_ANIVERSARIANTE'];
											$TOT_VVR += $qrMov['VVR'];	

										}

										$MED_PERC_QTD_CLI_RESGATE = $TOT_PERC_QTD_CLI_RESGATE/$count;
										$MED_PERC_CLI_FATURAMENTO = $TOT_PERC_CLI_FATURAMENTO/$count;
									...
									?>
										...
										<tfoot>
											<tr>
												<th></th>
												<th class='text-center'><b><?=fnValor($TOT_QTD_ANIVERSARIANTES,0)?></b></th>
												<th class='text-right'><b>R$ <?=fnValor($TOT_FATURAMENTO_ANIVERSARIANTE,2)?></b></th>
												<th class='text-right'><b>R$ <?=fnValor($TOT_FATURAMENTO_TOTAL,2)?></b></th>
												<th class='text-center'><b><?=fnValor($TOT_QTD_ANIVERSARIANTES_RESGATE,0)?></b></th>
												<th class='text-center'><b><?=fnValor($MED_PERC_QTD_CLI_RESGATE,2)?>%</b></th>
												<th class='text-center'><b>R$ <?=fnValor($MED_PERC_CLI_FATURAMENTO,2)?>%</b></th>
												<th class='text-right'><b>R$ <?=fnValor($TOT_TOTAL_RESGATE_ANIVERSARIANTE,2)?></b></th>
												<th class='text-right'><b>R$ <?=fnValor($TOT_VVR,2)?>%</b></th>
											</tr>
											<tr>
												<th colspan="100">
