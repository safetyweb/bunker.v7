							...
							<div class="row">
								...
								<div class="col-md-2">
									...
									<div class="radio radio-info radio-inline">
										...
										<label for="tipoVenda2"> Com Token </label>
									</div>
							...
							<div class="row">
								<div class="col-md-12" id="div_Produtos">
									...
									<table class="table table-hover">
										...
										<thead>
											<tr>
												<th class="text-info text-center">Total de Transações no Período<b> &nbsp; <?php echo fnValor($totalitens_por_pagina['contador'], 0); ?></b></th>
												<th class="text-info text-center">Total de Vendas &nbsp; <b>R$ <?php echo fnValor($totalitens_por_pagina['VAL_TOTVENDA'], 2); ?></b></th>
											</tr>
										</thead>
									...
									<table class="table table-bordered table-hover tablesorter">
										...
										<thead>
											<tr>
												...
												<th><small>Cód. Externo</small></th>
												<th><small>Loja</small></th>
												<th data-sorter="shortDate" data-date-format="ddmmyyyy"><small>Data/Hora</small></th>
										...
										<tbody id="relatorioConteudo">
											...
											while ($qrListaVendas = mysqli_fetch_assoc($arrayQuery)) {
												...
												// $ARRAY_VENDEDOR[$NOM_ARRAY_NON_VENDEDOR]['NOM_USUARIO'];
												if ($countLinha == 1) {
...
<script>
						...
						action: function() {
							...
							$.confirm({
								...
								content: function() {
									var self = this;
									return $.ajax({
										url: "relatorios/ajxVendasGeralDuque.do?opcao=exportar&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa); ?>",
	...
	function reloadPage(idPage) {
		$.ajax({
			type: "POST",
			url: "relatorios/ajxVendasGeralDuque.do?opcao=paginar&id=<?php echo fnEncode($cod_empresa); ?>&idPage=" + idPage + "&itens_por_pagina=<?php echo $itens_por_pagina; ?>",
			data: $('#formulario').serialize(),
			beforeSend: function() {
