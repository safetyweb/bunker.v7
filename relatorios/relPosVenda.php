                                        ...
                                        -->
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php } ?>
                                                    <th>Última Compra</th>
                                                    <th width="100">Val. Compra</th>
                                                    <th width="100">Créd. Total</th>
                                                    <th width="100">Créd. Expirar</th>
                                                </tr>
                                            </thead>
                                                ...
                                                if ($cod_empresa != 0) {
                                                    ...
                                                    while ($qrListaEmpresas = mysqli_fetch_assoc($arrayQuery)) {
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td class='text-right'><small>R$ " . fnValor($qrListaEmpresas['VAL_TOTVENDA'], 2) . "</small></td>     
                                                          <td class='text-right'><small>R$ " . fnValor($qrListaEmpresas['VAL_SALDO_DISPONIVEL'], 2) . "</small></td>
                                                          <td class='text-right'><small>R$ " . fnValor($qrListaEmpresas['CREDITO_EXPIRADOS'], 2) . "</small></td>
                                                        </tr>
...
<script type="text/javascript">
                        ...
                        action: function() {
                            ...
                            $.confirm({
                                ...
                                content: function() {
                                    var self = this;
                                    return $.ajax({
                                        url: "relatorios/ajxPosVenda.do?opcao=exportar&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa); ?>",
    ...
    function reloadPage(idPage) {
        $.ajax({
            type: "POST",
            url: "relatorios/ajxPosVenda.do?opcao=paginar&id=<?php echo fnEncode($cod_empresa); ?>&idPage=" + idPage + "&itens_por_pagina=<?php echo $itens_por_pagina; ?>",
            data: $('#formulario').serialize(),
            beforeSend: function() {
