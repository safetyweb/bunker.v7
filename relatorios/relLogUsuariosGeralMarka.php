...
table a:not(.btn):hover, .table a:not(.btn):hover {
								...
								<div class="row">
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<div class="help-block with-errors"></div>
											<script type="text/javascript">$("#formulario #COD_TPUSUARIO").val('<?=$cod_tpusuario?>').trigger("chosen:updated");</script>
										</div>
									</div>
									-->
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<div class="help-block with-errors"></div>
											<script type="text/javascript">$("#formulario #LOG_ESTATUS").val('<?=$log_estatus?>').trigger("chosen:updated");</script>
										</div>
									</div>
							...
							<div class="col-md-12">
								...
								<thead>
									<tr>
									  ...
									  <th><small>Nome do Usuário</small></th>
    ...
    <script>
							...
							action: function () {
								...
								$.confirm({
									...
									content: function(){
										var self = this;
										return $.ajax({
											url: "relatorios/ajxRelLogUsuariosGeralMarka.do?opcao=exportar&nomeRel="+nome,
		...
		function reloadPage(idPage) {
			$.ajax({
				type: "POST",
				url: "relatorios/ajxRelLogUsuariosGeralMarka.do?idPage="+idPage+"&itens_por_pagina=<?php echo $itens_por_pagina; ?>&opcao=paginar",
				data: $('#formulario').serialize(),
				beforeSend:function(){
