                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="no-more-tables">
                                        ...
                                        <table class="table table-bordered table-hover tablesorter" id="tablista">
                                            ...
                                            <tbody id="listaTemplates">
                                                ...
                                                if (@$_REQUEST['COD_UNIVEND'][0] == 9999){
                                                    ...
                                                    if($lojasSelecionadas == ""){
                                                        $andUnid = "AND ret.COD_UNIVEND IN(0,9999)";
                                                    }else{
                                                    $andUnid = "AND ret.COD_UNIVEND IN(0,9999,$lojasSelecionadas)";
                                                    }
                                                }

                                                //Maurce pediu para alterar

                                                $sql = "                                    

                                                SELECT tmpWhats.ID_DISPARO,
                                                           tmpWhats.NOM_FANTASI,
                                                           tmpWhats.COD_UNIVEND,
                                                           tmpWhats.COD_CAMPANHA,
                                                           tmpWhats.DAT_CADASTR DAT_ENVIO,
                                                           tmpWhats.COD_OPTOUT_ATIVO,
                                                           tmpWhats.BOUNCE,
                                                           tmpWhats.CANCELADO,
                                                           tmpWhats.COD_NRECEBIDO,
                                                           tmpWhats.COD_CCONFIRMACAO,
                                                           tmpWhats.SUB_TOTAL
                                                    FROM
                                                      (SELECT ret.ID_DISPARO,
                                                              ret.DAT_CADASTR,
                                                                 uni.NOM_FANTASI,
                                                              uni.COD_UNIVEND,
                                                              ret.COD_CAMPANHA,
                                                              SUM(CASE
                                                                      WHEN ret.COD_OPTOUT_ATIVO='1' THEN '1'
                                                                      ELSE '0'
                                                                  END) COD_OPTOUT_ATIVO,
                                                              SUM(CASE
                                                                      WHEN ret.BOUNCE='1' THEN '1'
                                                                      ELSE '0'
                                                                  END) BOUNCE,
                                                              SUM(CASE
                                                                      WHEN ret.BOUNCE='2' THEN '1'
                                                                      ELSE '0'
                                                                  END) CANCELADO,
                                                              SUM(CASE
                                                                      WHEN ret.COD_NRECEBIDO='1' THEN '1'
                                                                      ELSE '0'
                                                                  END) COD_NRECEBIDO,
                                                              SUM(CASE
                                                                      WHEN ret.COD_CCONFIRMACAO='1' THEN '1'
                                                                      ELSE '0'
                                                                  END) COD_CCONFIRMACAO,
                                                              SUM(CASE
                                                                      WHEN ret.COD_CCONFIRMACAO='0' THEN '1'
                                                                      WHEN ret.COD_NRECEBIDO='0' THEN '1'
                                                                      WHEN ret.BOUNCE='0' THEN '1'
                                                                      WHEN ret.COD_OPTOUT_ATIVO='0' THEN '1'
                                                                      ELSE '1'
                                                                  END) SUB_TOTAL
                                                       FROM whatsapp_lista_ret ret
                                                       ...
                                                       ORDER BY uni.cod_univend ASC)tmpWhats
                                                    left JOIN whatsapp_lote CP ON CP.COD_CAMPANHA = tmpWhats.COD_CAMPANHA
                                                    AND CP.COD_DISPARO_EXT = tmpWhats.ID_DISPARO
                                                    GROUP BY tmpWhats.COD_CAMPANHA,
                                                             tmpWhats.COD_UNIVEND
                                                ...
                                                while ($qrCampanhasEmail = mysqli_fetch_assoc($arrayQuery)) {
                                                    ...
                                                    <tr id='UNIVEND_" . $qrCampanhasEmail['COD_UNIVEND'] . "'>                              
                                                        <td class='text-center toggle'><a href='javascript:void(0);' onclick='abreDetail(" . $qrCampanhasEmail['COD_UNIVEND'] . ")'><i class='fal fa-angle-right' aria-hidden='true'></i></a>
                                                        </td>

                                                        <td>
                                                            <small><small>" . $qrCampanhasEmail['COD_UNIVEND'] . "</small>&nbsp;" . $qrCampanhasEmail['NOM_FANTASI'] . "</small>
                                                        </td>

                                                        <td>
                                                            <small><small>" . $dat_envio . "</small></small>
                                                        </td>

                                                        <td class='text-right bold'>
                                                            <small>" . fnValor($contatos_graph, 0) . "</small>
                                                        </td>

                                                        <td class='text-right bold' data-sort='" . fnValor($sucesso_graph, 0) . "'>
                                                            <small>" . fnValor($sucesso_graph, 0) . "<br/><span class='text-muted' style='font-size: 10px; font-weight: 100;'>" . fnValor($perc_sucesso, 2) . "%</span></small
                                                        </td>

                                                        <td class='text-right' data-sort='" . fnValor($nrecebidos_graph, 0) . "'>
                                                            <small>" . fnValor($nrecebidos_graph, 0) . "<br/><span class='text-muted' style='font-size: 10px; font-weight: 100;'>" . fnValor($perc_nrecebidos, 2) . "%</span></small>  
                                                        </td>

                                                        <td class='text-right bold' data-sort='" . fnValor($optout_graph, 0) . "'>
                                                            <small>" . fnValor($optout_graph, 0) . "<br/><span class='text-muted' style='font-size: 10px; font-weight: 100;'>" . fnValor($perc_optout, 2) . "%</span></small> 
                                                        </td>

                                                        <td class='text-right bold' data-sort='" . fnValor($falha_graph, 0) . "'>
                                                            <small>" . fnValor($falha_graph, 0) . "<br/><span class='text-muted' style='font-size: 10px; font-weight: 100;'>" . fnValor($perc_falha, 2) . "%</span></small
                                                        </td>

                                                        <td class='text-right bold' data-sort='" . fnValor($aguardo_graph, 0) . "'>
                                                            <small>" . fnValor($aguardo_graph, 0) . "<br/><span class='text-muted' style='font-size: 10px; font-weight: 100;'>" . fnValor($perc_aguardo, 2) . "%</span></small
                                                        </td>

                                                        <td class='text-right bold' data-sort='" . fnValor($cancelado, 0) . "'>
                                                            <small>" . fnValor($cancelado, 0) . "<br/><span class='text-muted' style='font-size: 10px; font-weight: 100;'>" . fnValor($perc_cancela, 2) . "%</span></small
                                                        </td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td></td>
                                                    <td>Total Unidades: <b><?= fnValor($tot_campanhas, 0) ?></b></td>
                                                    <td></td>
...
<script type="text/javascript">
                    ...
                    action: function() {
                        ...
                        $.confirm({
                            ...
                            content: function() {
                                var self = this;
                                return $.ajax({
                                    url: "relatorios/ajxRelComunicaWhatsUni.do?opcao=exportar&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa); ?>",
    ...
    function abreDetail(idUnidade, idEmp = "<?=$cod_empresa?>") {
        var idItem = $('#UNIVEND_' + idUnidade);
        console.log(idItem);

        $.ajax({
            type: "POST",
            url: "relatorios/ajxRelComunicaSMSUni.do?idu="+idUnidade,
            data: $("#formulario").serialize(),
            beforeSend: function() {
                $("#UNIVEND_" + idUnidade).append('<div class="loading" style="width: 100%;"></div>');

            },
            success: function(data) {
                $("#UNIVEND_" + idUnidade).empty().append(data);
                $('.tablesorter').trigger('update').trigger("appendCache")
                console.log(data);
            },
            error: function(data) {
                // $("#UNIVEND_" + idUnidade).html(data);
                //$("#mostraDetail_"+idCampanha).html('<p class="error" style="margin-top: 10px;"><strong>Oops!</strong> Registros não encontrados...</p>');
            }
        });
    }
