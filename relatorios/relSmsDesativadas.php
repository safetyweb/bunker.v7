...
<script>
						...
						action: function() {
							...
							$.confirm({
								...
								content: function() {
									var self = this;
									return $.ajax({
										url: "relatorios/ajxSmsDesativadas.do?opcao=exportar&nomeRel=" + nome + "&id=<?= fnEncode($cod_empresa); ?>",
	...
	function reloadPage(idPage) {
		$.ajax({
			type: "POST",
			url: "relatorios/ajxSmsDesativadas.do?id=<?= fnEncode($cod_empresa); ?>&idPage=" + idPage + "&itens_por_pagina=<?= $itens_por_pagina; ?>&opcao=paginar",
			data: $('#formulario').serialize(),
			beforeSend: function() {
