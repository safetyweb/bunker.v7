								...
								<div class="portlet-body">
									...
									<div class="login-form">
										...
										<div class="row">
													...
													<?php	
														$sql = "select count(*) as totRegistro from vw_mk_motorista";
														$qrListaVwDuque = mysqli_fetch_assoc(mysqli_query($connDUQUE->connDUQUE(),$sql));
														$totClientes = $qrListaVwDuque['totRegistro']; 
														
														$sql = "select max(dt_alteracao)as maxData from vw_mk_motorista";
														$qrListaVwDuque = mysqli_fetch_assoc(mysqli_query($connDUQUE->connDUQUE(),$sql));
												  ...
												  <thead>
													<tr>
													  ...
													  <th><small>nome</small></th>
                                                                                                          <th><small>dt_ateracao</small></th>
                                                                                                        
													</tr>
												  </thead>
													
													<?php	
														$sql = "select * from vw_mk_motorista limit 0,200";
														  ...
														  {														
															?>
																<tr style="background-color: #fff;">
																  ...
																  <td><?php echo $qrListaVwDuque['nome']; ?></td>
