								...
								<div class="portlet-body">
									...
									<div class="login-form">
										...
										<div class="row">
													...
													<?php	
														$sql = "select count(*) as totClientes from vw_mk_postos";
														...
														$sql = "select max(dt_alteracao) as maxData from vw_mk_postos";
														$qrListaVwDuque = mysqli_fetch_assoc(mysqli_query($connDUQUE->connDUQUE(),$sql)) or die(mysqli_error());
										...
										<div class="row">
											...
											<div class="col-md-12" id="div_Produtos">
												...
												<table class="table table-bordered table-hover  ">
												  ...
												  <thead>
													<tr>
													  <th><small>id_posto</small></th>
													  <th><small>razao_social</small></th>
                                                                                                          <th><small>nome_fantasia</small></th>
                                                                                                          <th><small>endereco</small></th>
														  ...
														  {														
															?>
																<tr style="background-color: #fff;">
																  <td><?php echo $qrListaVwDuque['id_posto']; ?></td>
                                                                                                                                  <td><?php echo utf8_encode($qrListaVwDuque['razao_social']); ?></td>
                                                                                                                                   <td><?php echo $qrListaVwDuque['nome_fantasia']; ?></td>
                                                                                                                                   <td><?php echo utf8_encode($qrListaVwDuque['endereco']); ?></td>
                                                                                                                                   <td><?php echo $qrListaVwDuque['numero']; ?></td>
                                                                                                                                   <td><?php echo $qrListaVwDuque['bairro']; ?></td>
                                                                                                                                   <td><?php echo $qrListaVwDuque['cidade']; ?></td>                      
																   <td><?php echo $qrListaVwDuque['estado']; ?></td>
                                                                                                                                   <td><?php echo $qrListaVwDuque['cep']; ?></td>
