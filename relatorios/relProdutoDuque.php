								...
								<div class="portlet-body">
									...
									<div class="login-form">
										...
										<div class="row">
													...
													<?php	
														$sql = "select count(*) as totClientes from vw_mk_produto";
														...
														$sql = "select max(dt_alteracao) as maxData from vw_mk_produto";
														$qrListaVwDuque = mysqli_fetch_assoc(mysqli_query($connDUQUE->connDUQUE(),$sql)) or die(mysqli_error());
														  ...
														  {														
															?>
																<tr style="background-color: #fff;">
																  <td><?php echo $qrListaVwDuque['cod_produto']; ?></td>
																  <td><?php echo $qrListaVwDuque['descricao']; ?></td>
