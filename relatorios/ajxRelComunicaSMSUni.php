...
?>
			...
			<tr>
				...
				<td class='{ sorter: false }'><small><small>(<?= $qrCampanhasEmail['COD_CAMPANHA'] ?>)</small>&nbsp;<?= $qrCampanhasEmail['DES_CAMPANHA'] ?></small>&nbsp;<span class="f10"><?= $qrCampanhasEmail['COD_DISPARO_EXT'] ?></span></td>
				<td class='{ sorter: false }'><small><?= fnDatafull($qrCampanhasEmail['DATA_CADASTRO']) ?></small></td>
				<td class='text-right { sorter: false }'><small><?= fnValor($contatos_graph, 0) ?>
				<td class='text-right { sorter: false }'><small><?= fnValor($sucesso_graph, 0) ?><br /><span class="text-muted" style="font-size: 10px;"><?= fnValor($perc_sucesso, 2) ?>%</span></small></td>
				<td class='text-right { sorter: false }'><small><?= fnValor($nrecebidos_graph, 0) ?><br /><span class="text-muted" style="font-size: 10px;"><?= fnValor($perc_nrecebidos, 2) ?>%</span></small></td>
				<td class='text-right { sorter: false }'><small><?= fnValor($optout_graph, 0) ?><br /><span class="text-muted" style="font-size: 10px;"><?= fnValor($perc_optout, 2) ?>%</span></small></td>
				<td class='text-right { sorter: false }'><small><?= fnValor($falha_graph, 0) ?><br /><span class="text-muted" style="font-size: 10px;"><?= fnValor($perc_falha, 2) ?>%</span></small></td>
				<td class='text-right { sorter: false }'><small><?= fnValor($aguardo_graph, 0) ?><br /><span class="text-muted" style="font-size: 10px;"><?= fnValor($perc_aguardo, 2) ?>%</span></small></td>
				<td class='text-right { sorter: false }'><small><?= fnValor($cancelado, 0) ?><br /><span class="text-muted" style="font-size: 10px;"><?= fnValor($perc_cancela, 2) ?>%</span></small></td>
