									...
									<div class="login-form">
										...
										<div class="row text-center">											
											...
											<?php
												...
												//total de cadastros
												$sql = "select count(*) as TOTAL_CADASTRO 
														from clientes 
														where cod_empresa = $cod_empresa 
														AND DAT_CADASTR >= '$dat_ini $hor_ini' 
														AND DAT_CADASTR <= '$dat_fim $hor_fim'															
														";
											...
											<?php
												...
												$sql = "select  A.NOM_FANTASI,
														...
														WHERE CLIENTES.COD_UNIVEND = A.COD_UNIVEND AND 
														DAT_CADASTR >= '$dat_ini $hor_ini' AND 
														DAT_CADASTR <= '$dat_fim $hor_fim' ) TOTAL_CLIENTE
														from  webtools.unidadevenda A
														WHERE 
														COD_EMPRESA = $cod_empresa
														and A.cod_exclusa =0
														order by NOM_UNIVEND															
														";
												...
												while ($qrBuscaDados = mysqli_fetch_assoc($arrayQuery))
												  {	
													...
													$pct_cadUnive = ($total_cliente*100)/$total_cadastro;
