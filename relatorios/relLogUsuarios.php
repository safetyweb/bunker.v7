							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<select data-placeholder="Selecione uma empresa" name="COD_EMPRESA" id="COD_EMPRESA" class="chosen-select-deselect requiredChk" style="width:100%;">
											<option value=""></option>
											<?php
										...
										<script type="text/javascript">
											$("#formulario #COD_EMPRESA").val('<?= $cod_empresa ?>').trigger("chosen:updated");
										</script>
									</div>
								</div>
