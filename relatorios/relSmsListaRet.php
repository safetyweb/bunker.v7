					...
					<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
						...
						<fieldset>
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Somente C/ Retorno</label>
										<div class="push5"></div>
										<label class="switch">
											<input type="checkbox" name="LOG_RETORNO" id="LOG_RETORNO" class="switch" value="S">
											<span></span>
										</label>
									</div>
								</div>
					...
					<div class="portlet-body">
						...
						<div class="row text-center">
							...
							<div class="form-group text-center col-md-4 col-md-offset-4">
								...
								if ($num_celular != '') {
									$andCelular = "AND 
									CASE WHEN LENGTH(SLR.NUM_CELULAR) = 13 THEN
									SUBSTRING(SLR.NUM_CELULAR, 3)
									ELSE SLR.NUM_CELULAR END IN ('" . fnLimpaDoc($num_celular) . "')";
								} else {
									$andCelular = "";
								}
								...
								<p><span><?php echo fnValor($totalitens_por_pagina, 0); ?></span></p>
							...
							<table class="table table-bordered table-hover tablesorter">
								...
								<thead>
									<tr>
										<th>
											<div class="form-group">
												<label for="inputName" class="control-label"><b>Cliente</b></label>
										...
										<th>
											<div class="form-group">
												<label for="inputName" class="control-label"><b>Cód. Cliente</b></label>
												<input type="hidden" class="form-control input-sm" name="CODCLIENTE" id="CODCLIENTE" maxlength="100" value="">
												<div class="help-block with-errors"></div>
											</div>
										</th>
										...
										<th>
											<div class="form-group">
												<label for="inputName" class="control-label"><b>CPF</b></label>
												<input type="hidden" class="form-control input-sm" name="CPF" id="CPF" maxlength="100" value="">
												<div class="help-block with-errors"></div>
											</div>
										</th>
										...
										<th>
											<div class="form-group">
												<label for="inputName" class="control-label"><b>Celular</b></label>
												<input type="hidden" class="form-control input-sm" name="CELULAR" id="CELULAR" maxlength="100" value="">
												<div class="help-block with-errors"></div>
											</div>
										</th>
										...
										<th>
											<div class="form-group">
												<label for="inputName" class="control-label"><b>Campanha</b></label>
												<input type="hidden" class="form-control input-sm" name="CAMPANHA" id="CAMPANHA" maxlength="100" value="">
												<div class="help-block with-errors"></div>
											</div>
										</th>
										...
										<th>
											<div class="form-group">
												<label for="inputName" class="control-label"><b>Loja</b></label>
												<input type="hidden" class="form-control input-sm" name="LOJA" id="LOJA" maxlength="100" value="">
												<div class="help-block with-errors"></div>
											</div>
										</th>
										...
										<th>
											<div class="form-group">
												<label for="inputName" class="control-label"><b>Mensagem Enviada</b></label>
												<input type="hidden" class="form-control input-sm" name="MENSAGEM_ENVIADA" id="MENSAGEM_ENVIADA" maxlength="100" value="">
												<div class="help-block with-errors"></div>
											</div>
										</th>
										...
										<th>
											<div class="form-group">
												<label for="inputName" class="control-label"><b>Retorno</b></label>
												<input type="hidden" class="form-control input-sm" name="RETORNO" id="RETORNO" maxlength="100" value="">
												<div class="help-block with-errors"></div>
											</div>
										</th>
										...
										<th class="text-center">
											<div class="form-group">
												<label for="inputName" class="control-label"><b>Dt. Envio</b></label>
												<input type="hidden" class="form-control input-sm" name="DT_ENVIO" id="DT_ENVIO" maxlength="100" value="">
												<div class="help-block with-errors"></div>
											</div>
										</th>
										...
										<th>
											<div class="form-group">
												<label for="inputName" class="control-label"><b>Status</b></label>
												<input type="hidden" class="form-control input-sm" name="STATUS" id="STATUS" maxlength="100" value="">
												<div class="help-block with-errors"></div>
											</div>
										</th>
									</tr>
								...
								<tbody id="relatorioConteudo">
									...
									while ($qrRetorno = mysqli_fetch_assoc($arrayQuery)) {
										...
										if (substr($qrRetorno['NUM_CELULAR'], 0, 2) === '55') {
											$numero = substr($qrRetorno['NUM_CELULAR'], 2);
										} else {
											$numero = $qrRetorno['NUM_CELULAR'];
										}
										...
										<td><small class='sp_celphones'>" . $numero . "</small></td>
...
<script>
						...
						action: function() {
							...
							$.confirm({
								...
								content: function() {
									var self = this;
									return $.ajax({
										url: "relatorios/ajxSmsListaRet.do?opcao=exportar&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa); ?>",
	...
	function reloadPage(idPage) {
		$.ajax({
			type: "POST",
			url: "relatorios/ajxSmsListaRet.do?id=<?php echo fnEncode($cod_empresa); ?>&idPage=" + idPage + "&itens_por_pagina=<?php echo $itens_por_pagina; ?>&opcao=paginar",
			data: $('#formulario').serialize(),
			beforeSend: function() {
