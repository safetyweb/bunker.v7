...
$sql='select STRAIGHT_JOIN  DAT_CADASTR as DATA_CADASTRO,IP,PORTA,COD_UNIVEND,COD_EMPRESA as EMPRESA,NOM_USUARIO,ID_MAQUINA as MAQUINA,NUM_CGCECPF as CPF,MSG,DES_VENDA  from msg_cadastra
        inner join origemcadastro on origemcadastro.COD_ORIGEM=msg_cadastra.ID
...
<form method="post" action="relcadastro.do">
