<?php
	...
	if( $_SERVER['REQUEST_METHOD']=='POST' )
	{
		...
		else
		{
			...
			$des_email = fnAcentos(strtolower(fnLimpaCampo($_REQUEST['DES_EMAIL'])));
				...
				switch ($opcao)
				{
					case 'CAD':
						...
						if($registros > 0){
							...
							$sql = "INSERT INTO BLACKLIST_EMAIL(
												COD_EMPRESA,
												DES_EMAIL,
												COD_USUCADA
											) VALUES(
					...
					case 'ALT':
						...
						$sql = "UPDATE BLACKLIST_EMAIL SET
									   DES_EMAIL = '$des_email'
					...
					case 'EXC':
						...
						$sql = "DELETE FROM BLACKLIST_EMAIL 
								WHERE COD_EMPRESA = $cod_empresa
								AND COD_BLKLIST = $cod_blklist";
...
<style>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control input-sm" name="DES_EMAIL" id="DES_EMAIL" maxlength="70" required>
												    ...
												    <div class="input-group activeItem">
										                <div class="input-group-btn search-panel">
										                    ...
										                    <ul class="dropdown-menu" role="menu">
										                    	...
										                    	<!-- <li class="divider"></li> -->
											                    <li><a href="#DES_EMAIL">Email</a></li>										                      
										                    </ul>
										                </div>
	...
	<script type="text/javascript">
		...
		function reloadPage(idPage) {
			$.ajax({
				type: "POST",
				url: "ajxBlacklistEmail.do?opcao=paginar&id=<?=fnEncode($cod_empresa)?>&idPage="+idPage+"&itens_por_pagina=<?php echo $itens_por_pagina; ?>",
