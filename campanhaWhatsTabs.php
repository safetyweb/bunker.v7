...
.chosen-container{
						...
						<div class="col-md12 margin-bottom-30">
							...
							<div class="portlet portlet-bordered">
								...
								<div class="portlet-body">
									...
									$sql1 = "SELECT count(cod_empresa) TEMACESSO  FROM CONFIGURACAO_ACESSO WHERE cod_parcomu='12' AND LOG_STATUS='S' AND cod_empresa = $cod_empresa ";
									...
									<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
										...
										<div  class="col-sm-12"	style="padding-left: 0;">
											...
											<div class="col-xs-2" style="padding-left: 0;"> <!-- required for floating -->
											  ...
											  <ul class="vTab nav nav-tabs tabs-left text-center">
												...
												<li class="active vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1575)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1577)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
													
													<i class="fal fa-cogs fa-2x" style="margin: 10px 0 2px 0"></i>
													<h5 class="hidden-xs" style="margin: 3px 0 0 0">Automação <br/> <small>Agendamento</small></h4>
													</a>
												</li>
												
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1574)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1582)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
													
													<i class="fal fa-clipboard-check fa-2x" style="margin: 10px 0 2px 0"></i>
													<h5 class="hidden-xs" style="margin: 3px 0 0 0">Aprovação</h4>												
													</a>
												</li>
												
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1583)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
													
													<i class="fal fa-rocket fa-2x" style="margin: 10px 0 2px 0"></i>
													<h5 class="hidden-xs" style="margin: 3px 0 0 0">Ativação</h4>												
													</a>
												</li>
												
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1572)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
													
													<i class="fal fa-chart-line fa-2x" style="margin: 10px 0 2px 0"></i>
													<h5 class="hidden-xs" style="margin: 3px 0 0 0">Resultados</h4>
													</a>
												</li>
											...
											<div class="col-xs-10 no-scroll">
												...
												<iframe frameborder="0" id="conteudoAba" src="action.php?mod=<?php echo fnEncode(1575)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" style="width: 100%; min-height: 25vh;"></iframe>
	...
	<script type="text/javascript">	
		...
		$(document).ready(function(){
			// mudaAba("action.php?mod=<?php echo fnEncode(1565)?>&id=<?php echo fnEncode($cod_empresa)?>&pop=true");
			//chosen
					...
					action: function () {
						...
						$.confirm({
							...
							content: function(){
								var self = this;
								return $.ajax({
									url: "ajxResultadoSms.do?opcao="+opcao+"&nomeRel="+nome+"&id=<?php echo fnEncode($cod_empresa); ?>",
