...
$html .= "<html>
			<head>
				<meta name=\"viewport\" content=\"initial-scale=1,zoom=100%,width=device-width,target-densitydpi=high-dpi\">
				<style>
						body {
						  margin: 0;
						  padding: 0;
...
$file = dirname(__FILE__)."/emailComponenteTeste/preview/preview_".$cod_template.".html";
