...
<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		else
		{
			...
			$cod_objeto = fnLimpaCampoZero($_REQUEST['COD_STATUS']);
			$des_objeto = fnLimpaCampo($_REQUEST['DES_STATUS']);
			$abv_objeto = fnLimpaCampo($_REQUEST['ABV_STATUS']);
			...
			if ($opcao != ''){ 				
				...
				switch ($opcao)
				{
					...
					case 'ALT':
						...
						$sql = "UPDATE STATUS_EMENDA SET 
					    		DES_STATUS='$des_objeto',
					    		ABV_STATUS='$abv_objeto'

					    		WHERE COD_STATUS=$cod_objeto
...
?>
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm" name="ABV_STATUS" id="ABV_STATUS" maxlength="20" required>
															<div class="help-block with-errors"></div>
														</div>
													</div>
													...
													while ($qrBuscaModulos = mysqli_fetch_assoc($arrayQuery))
													  ...
													  ?>
														<tr>
															...
															<td><?php echo $qrBuscaModulos['ABV_STATUS']; ?></td>
														</tr>
														...
														<input type='hidden' id='ret_ABV_STATUS_<?php echo $count; ?>' value='<?php echo $qrBuscaModulos['ABV_STATUS']; ?>'>
														<?php }?>
	...
	<script type="text/javascript">
		...
		function retornaForm(index){
			...
			$("#formulario #ABV_STATUS").val($("#ret_ABV_STATUS_"+index).val());
