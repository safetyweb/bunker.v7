												...
												<div class="passo" id="passo1">
													<div class="push100"></div>
														...
														<div class="row">
															...
															<div class="col-md-4">
																<button type="button" class="btn btn-lg btn-default btn-block upload"><i class="fal fa-box-full" aria-hidden="true"></i>&nbsp; Importar Produtos</button>
															</div>
													...
													<div class="col-md-2">
														...
														<script>
															$(".tmplt").click(function(e) {
																e.preventDefault();
															 	location.href = "https://adm.bunker.mk/media/clientes/template_importacao_produto_extra_rev.xlsx";
															});
														</script>
													</div>
													<div class="col-md-2">
	 ...
	 function uploadFile(idField, typeFile) {
        ...
        if(ext == 'xlsx'){		
	        ...
	        $.ajax({
	            ...
	            url: '../uploads/uploadImportProdExtra.php?acao=gravar&id=<?php echo $cod_empresa; ?>&idc=<?=fnEncode($cod_campanha)?>',
	            type: 'POST',
	            data: formData,
	            processData: false,
	            contentType: false,
	            success: function (data) {
	                ...
	                var duplicados = data;
	                    ...
	                    $.ajax({
							type: "POST",
							url: "../uploads/uploadImportProdExtra.php?acao=ler&id=<?php echo $cod_empresa; ?>&idc=<?=fnEncode($cod_campanha)?>",
							/*beforeSend:function(){
