...
.no-padding-sides{
												    	...
												    	<div class="col-md-12 col-sm-12 col-xs-12" id="drop-target">
												    		...
												    		<div class="row not-movable" id="trigger">
														    	...
														    	<div class="col-md-3 col-xs-3 no-padding-sides">
														    		<a href="javascript:void(0)" class="btn btn-info btn-xs transparency" data-url="action.php?mod=<?php echo fnEncode(1636)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_campanha)?>&pop=true" data-title="Gatilho" onclick='try {parent.abreModalPai($(this).attr("data-url"),$(this).attr("data-title"),"sm")} catch(err) {}'>
	...
	<script type="text/javascript">
		...
		function refreshBloco(cod_empresa,cod_template) {
			jQuery.ajax({
				type: "GET",
				url: "ajxAutomacaoEmail_V2.php?opcao=refresh",
		...
		function excBloco(id,tipo){
			...
			jQuery.ajax({
				type: "POST",
				url: "ajxAutomacaoEmail_V2.php?opcao=exc&tp="+tipo,
