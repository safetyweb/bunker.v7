...
$server->register('ConsultaCadastroPorCNPJ',
			...
			'urn:server#ConsultaConsultaCadastroPorCNPJ',  //soapaction
			'rpc', //document
			'literal', // literal
			'ConsultaCadastroPorCNPJ');  //description
 ...
 function ConsultaCadastroPorCNPJ($CNPJ,$dadoslogin) {
   ...
   // EMPRESAS.LOG_ATIVO = > S OU N ATIVA FULL WEBSERVICES,
                ...
                { 
                                //valida campo
                                   ...
                                   $profiss_ret = mysqli_fetch_assoc(mysqli_query($connAdm->connAdm(),$bus_PROFISS)); 
                                    ...
                                    }else{return array('msgerro'=>';-O Oh não! Empresa não cadastrada!');}        
                }      
                else
                {
    ...
    }else{return array('msgerro'=>'Erro Na autenticação');}
