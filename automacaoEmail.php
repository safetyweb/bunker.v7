...
.no-padding-sides{
												...
												<div class="row">
													...
													<div class="col-md-6 col-sm-6 col-xs-8">
														<div class="col-md-10 col-md-offset-2 col-sm-10 col-sm-offset-2 col-xs-12 col-xs-offset-6">
															<h4 style="font-size: 17px;">Composição do email da campanha</h4>
														</div>
													</div>
												...
												<div class="row">
													...
													<div class="col-md-4 col-sm-4 col-xs-4">
													    ...
													    <?php
													    	...
													    	$sql = "SELECT * FROM BLOCO_COMUNICACAO WHERE COD_TPCOM = 1 ORDER BY NUM_ORDENAC";
													    	$arrayQuery = mysqli_query($connAdm->connAdm(),$sql);
												    ...
												    <div class="col-md-7 col-md-offset-1 col-sm-7 col-sm-offset-1 col-xs-8 col-xs-offset-1">
												    	...
												    	<div class="col-md-12 col-sm-12 col-xs-12" id="drop-target">
												    		...
												    		<?php
												    			...
												    			$sqlGtlh = "SELECT * FROM GATILHO_EMAIL WHERE COD_CAMPANHA = $cod_campanha AND COD_EMPRESA = $cod_empresa";
												    		...
												    		<div class="row not-movable" id="trigger">
														    	...
														    	<div class="col-md-3 col-xs-3 no-padding-sides">
														    		<a href="javascript:void(0)" class="btn btn-info btn-xs transparency" data-url="action.php?mod=<?php echo fnEncode(1504)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_campanha)?>&pop=true" data-title="Gatilho" onclick='try {parent.abreModalPai($(this).attr("data-url"),$(this).attr("data-title"),"sm")} catch(err) {}'>
												    		...
												    		<?php
												    			...
												    			$sql = "SELECT * FROM TEMPLATE_AUTOMACAO 
																...
																while($qrTempl = mysqli_fetch_assoc($arrayQuery)){
																	...
																	switch($qrTempl['COD_BLTEMPL']){
																		...
																		case 22:
																			...
																			$sqlTplt = "SELECT TE.NOM_TEMPLATE FROM TEMPLATE_EMAIL TE 
	...
	<script type="text/javascript">
		...
		parent.jQuery("#conteudoAba").css("height", 1000 + "px");
		...
		function refreshBloco(cod_empresa,cod_template) {
			jQuery.ajax({
				type: "GET",
				url: "ajxAutomacaoEmail.php?opcao=refresh",
		...
		function excBloco(id,tipo){
			...
			jQuery.ajax({
				type: "POST",
				url: "ajxAutomacaoEmail.php?opcao=exc&tp="+tipo,
