...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (isset($_SESSION['last_request']) && $_SESSION['last_request'] == $request) {
		...
		$cod_categoriagrup = fnLimpaCampo($_POST['COD_CATEGOR']);
...
<?php
		...
		if ($opcao == "CAD") {
			...
			$sqlcategoria = "INSERT INTO CUPOMCATEGORIAPRODUTO (
								COD_EMPRESA,
								COD_CAMPANHA,
								QTD_CUPOMEXT,
								TIP_CUPOMEXT,
			...
			// fnTesteSql(connTemp($cod_empresa, ''), $sqlcategoria);
			// fnEscreve($sqlcategoria);
		} else if ($opcao == "ALT") {

			$sqlcategoria = "UPDATE CUPOMCATEGORIAPRODUTO SET
							QTD_CUPOMEXT = $qtd_cupomext,
							COD_CATEGORIAGRUP = $cod_categoriagrup,
...
<div class="row">
				...
				<div class="portlet-body">
					...
					<div class="login-form">
						...
						<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<!-- <script>
												$("#COD_CATEGOR").val("<?php echo $cod_categoriagrup; ?>").trigger("chosen:updated");
											</script> -->
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<script>
												//buscaSubCat(<?php //echo $cod_categor; 
																?>,<?php //echo $cod_subcate; 
																	?>,<?php //echo $cod_empresa; 
																		?>);
											</script>
											<div class="help-block with-errors"></div>
										</div>
							...
							<input type="hidden" name="COD_CATEGORIA" id="COD_CATEGORIA" value="<?php echo $cod_categoria; ?>">
								...
								<form name="formLista">
									...
									<table class="table table-bordered table-striped table-hover table-sortable buscavel">
										...
										<tbody id="relatorioConteudo">
											...
											LEFT JOIN categoria C ON A.COD_CATEGORIAGRUP = C.COD_CATEGOR
											LEFT JOIN subcategoria D ON A.COD_SUBCATE = D.COD_SUBCATE
											WHERE A.COD_EMPRESA = $cod_empresa
											AND A.COD_CAMPANHA = $cod_campanha
											AND A.COD_EXCLUSA = 0
											ORDER BY A.COD_CATEGORIA LIMIT $inicio,$itens_por_pagina";
											...
											while ($qrBuscaCampanhaExtra = mysqli_fetch_assoc($arrayQuery)) {
												...
												if ($qrBuscaCampanhaExtra['TIP_CUPOMEXT'] == "ABS") {
												...
												echo "
																<tr>
																  ...
																  <td>" . $qrBuscaCampanhaExtra['COD_CATEGORIA'] . "</td>
																...
																<input type='hidden' id='ret_COD_CATEGORIAGRUP_" . $count . "' value='" . $qrBuscaCampanhaExtra['COD_CATEGORIAGRUP'] . "'>
	...
	<script>
		...
		function retornaForm(index) {
			...
			$("#formulario #COD_CATEGOR").val($("#ret_COD_CATEGORIAGRUP_" + index).val()).trigger("chosen:updated");

			var codCat = $("#ret_COD_CATEGORIAGRUP_" + index).val();
