...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (isset($_SESSION['last_request']) && $_SESSION['last_request'] == $request) {
		...
		$cod_tipocli = fnLimpaCampoZero(@$_REQUEST['COD_TIPOCLI']);
		$des_tipocli = fnLimpaCampo(@$_REQUEST['DES_TIPOCLI']);
		...
		if ($opcao != '') {
			...
			$sql = "CALL SP_ALTERA_TIPO_CLIENTE (
				 '" . $cod_tipocli . "', 
				 '" . $des_tipocli . "', 
				 '" . $cod_externo . "', 
				 '" . $cod_empresa . "', 
							...
							<div class="row">
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" class="form-control input-sm leitura" readonly="readonly" name="COD_TIPOCLI" id="COD_TIPOCLI" value="">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputName" class="control-label required">Tipo de Cliente</label>
										<input type="text" class="form-control input-sm" name="DES_TIPOCLI" id="DES_TIPOCLI" maxlength="60" required>
										...
										while ($qrLista = mysqli_fetch_assoc($arrayQuery)) {
											...
											echo "
													<tr>
														...
														<td>" . $qrLista['COD_TIPOCLI'] . "</td>
														<td>" . $qrLista['DES_TIPOCLI'] . "</td>
														<td>" . $qrLista['COD_EXTERNO'] . "</td>
													</tr>
													<input type='hidden' id='ret_COD_TIPOCLI_" . $count . "' value='" . $qrLista['COD_TIPOCLI'] . "'>
													<input type='hidden' id='ret_DES_TIPOCLI_" . $count . "' value='" . $qrLista['DES_TIPOCLI'] . "'>
