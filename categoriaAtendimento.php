	...
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		else
		{
			...
			if ($opcao != ''){ 
				...
				$sql = "INSERT INTO ATENDIMENTO_TPSOLICITACAO(
						DES_TPSOLICITACAO,
						ABV_TPSOLICITACAO,
						COD_EMPRESA,
						DES_COR,
	    		...
	    		$sql = "DELETE FROM ATENDIMENTO_TPSOLICITACAO WHERE COD_TPSOLICITACAO = $cod_tpsolicitacao";
	    		...
	    		$sql = "UPDATE ATENDIMENTO_TPSOLICITACAO SET 
						...
						<div class="col-md12 margin-bottom-30">
							...
							<div class="portlet portlet-bordered">
								...
								<div class="portlet-body">
									...
									<?php $abaInfoAtendimento = 1439; include "abasAtendimentoConfig.php"; ?> 
