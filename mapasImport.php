											...
											<div class="container-fluid">
												...
												<div class="passo" id="passo1">
														...
														<div class="row">
															...
															<div class="col-md-4">
																<button type="button" class="btn btn-lg btn-default btn-block upload"><i class="fal fa-box-full" aria-hidden="true"></i>&nbsp; Importar Endereços</button>
															</div>
													...
													<div class="col-md-2">
														...
														<script>
															$(".tmplt").click(function(e) {
																e.preventDefault();
															 	location.href = "http://adm.bunker.mk/media/clientes/7/template_importacao_enderecos.xlsx";
															});
														</script>
													</div>
													<div class="col-md-2">
		...
		$(document).ready(function(){			
			...
			$('.next1').click(function(){
				...
				if($('#FEZ_UPLOAD').val() == "N"){
					...
					$.alert({
                        title: "Mensagem",
                        content: "Voce precisa importar a lista de endereços (.xlsx) para poder avançar.",
                    });
	 ...
	 function uploadFile(idField, typeFile) {
        ...
        if(ext == 'xlsx'){		
	        ...
	        $.ajax({
	            ...
	            url: '../uploads/uploadImportEnderecos.php?acao=gravar&id=<?php echo $cod_empresa; ?>&cod_mapa=<?=$cod_mapa?>',
	            type: 'POST',
	            data: formData,
	            processData: false,
	            contentType: false,
	            success: function (data) {
	                ...
	                var duplicados = data;
	                    ...
	                    $.ajax({
							type: "POST",
							url: "../uploads/uploadImportEnderecos.php?acao=ler&id=<?php echo $cod_empresa; ?>&cod_mapa=<?=$cod_mapa?>",
							/*beforeSend:function(){
