								...
								<div class="row" style="margin: 0 0 0 1px;">
									...
									<div class="col-sm-6 col-md-4">
										<div class="service-block" style="visibility: visible;">
											<div class="ico fal fa-file-search highlight"></div>
											<div class="text-block">
												<h4>Pesquisa</h4>
												<div class="text">Monitore o grau de satisfação dos seus clientes</div>
												<div class="push10"></div>

												<?php if (fnControlaAcesso("1628", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?= $_SERVER['HTTP_HOST'] ?>/action.do?mod=<?php echo fnEncode(1628) . "&id=" . fnEncode($cod_empresa) . "&idc=" . fnEncode($cod_campanha); ?>" target="_blank">&rsaquo; Pesquisa</a> <br />
												<?php } ?>

												<?php if (fnControlaAcesso("1274", $arrayParamAutorizacao) === true) { ?>
													<a href="https://<?= $_SERVER['HTTP_HOST'] ?>/action.do?mod=<?php echo fnEncode(1274) . "&id=" . fnEncode($cod_empresa) . "&idc=" . fnEncode($cod_campanha); ?>" target="_blank">&rsaquo; Resultados</a> <br />
												<?php } ?>
