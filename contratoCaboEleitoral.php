...
<div class="clausula">
	...
	<br/>
	<br/>
	1.1 – O presente contrato tem por objeto a prestação, pelo(a) <b>CONTRATADO(A)</b>, dos seguintes serviços para a campanha eleitoral do <b>CONTRATANTE</b>: mobilização de rua (cabo eleitoral), incluindo a panfletagem, entrega de materiais e outros serviços necessários para a campanha. 
	<br/>
	<br/>
	...
	<br/>
	<br/>
	2.2 – O pagamento será efetuado mediante transferência eletrônica – TED, DOC ou PIX, desde que pela chave PIX CPF do <b>CONTRATADO(A)</b> – para conta corrente de sua titularidade. 
	<br/>
	<br/>
	...
	<br/>
	<br/>
	6.2 – Efetuar o(s) pagamento(s) devido(s) na forma prevista neste <b>CONTRATO</b>.
	<br/>
	<br/>
