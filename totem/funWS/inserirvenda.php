...
function inserirvenda($arraydadoscad, $dadoslogin, $itensxml)
{
  ...
  $codvendedor = isset($arraydadoscad['codvendedor']) ? $arraydadoscad['codvendedor'] : '';
  $codatendente = isset($arraydadoscad['codatendente']) ? $arraydadoscad['codatendente'] : '';
                                ...
                                <soapenv:Body>
                                    <fid:InsereVenda>
                                        ...
                                        <venda>
                                            ...
                                            <codatendente>" . $codatendente . "</codatendente>
