...
function fnconsulta_V3($chave, $dado, $dadoslogin)
{
     switch ($chave) {
      case 2:
        $dado_consulta = "<cartao>$dado</cartao>";
    ...
    $options = [
        'http' => [
            ...
            'timeout' => 10,
            'content' => '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:fid="fidelidade">    
                              <soapenv:Header/>
                              <soapenv:Body>       
                                  <fid:BuscaConsumidor>       
                                      <fase>fase1</fase>       
        ...
        $response = file_get_contents("http://soap.bunker.mk?wsdl", false, $context);
