			...
			<form data-toggle="validator" role="form2" method="post" id="formulario" action="cadastro_V2.do?key=<?php echo $_GET['key'] ;?>">
				...
				<div class="col-md-6 col-xs-12 text-center" id="caixaForm" style="background-color: #FFF;">
					...
					<div class="col-md-10 col-md-offset-1">
						...
						<h5>Confira abaixo o seu saldo<?=$completaMsg?>:</h5>
					...
					?>	
						...
						<div class="col-md-10 col-md-offset-1">
							<a href="ticket_V2.do?key=<?php echo $_GET['key']; ?>&idc=<?=fnEncode($cod_cliente)?>&ch=3" name="TKT" id="TKT" <?=$disable?> class="btn btn-info btn-lg btn-block <?php echo $tktOff; ?> <?=$disable?>" tabindex="5"><i class="fa fa-ticket fa-2x" aria-hidden="true"></i>&nbsp; Visualizar Minhas Ofertas</a>
						</div>
