	...
	*/
	...
	<!-- end top nav bar -->
		...
		<div class="row" id="corpoForm">
			...
			<form data-toggle="validator" role="form2" method="post" id="formulario" action="cadastro_V2.do?key=<?php echo $_GET['key'] ;?>&v=<?=fnEncode(1)?>" autocomplete="off">
								...
								?>
									<div class="col-md-12 col-xs-12">
										<div class="form-group">
											...
											<input type="text" style="color: #34495E!important;" class="form-control input-hg input-lg text-center input-chave campo2 int" name="KEY_NUM_CARTAO" id="KEY_NUM_CARTAO" required>
								...
								?>
									<div class="col-md-12 col-xs-12">
										<div class="form-group">
											...
											<input type="tel" style="color: #34495E!important;" class="form-control input-hg input-lg text-center input-chave campo1 cpfcnpj" maxlength="<?=$charLenght?>" name="KEY_NUM_CGCECPF" id="KEY_NUM_CGCECPF" required>
											<div class="help-block with-errors"></div>
										</div>
									</div>
				...
				<div class="col-xs-12">
					<button type="submit" name="CAD" id="CAD" class="btn btn-primary btn-lg btn-block getBtn validaCPF" tabindex="5"><i class="fa fa-search" aria-hidden="true"></i>&nbsp; Acessar</button>
				</div>
