...
include_once './funWS/TKT.php';
	...
	$sqlNome = "SELECT NUM_CGCECPF, NUM_CARTAO FROM CLIENTES 
	...
	$dadosatualiza[cpf] = $qrNom['NUM_CGCECPF'];
	$dadosatualiza[cartao] = $qrNom['NUM_CARTAO'];
		...
		<div class="row" id="corpoForm">
			...
			<form data-toggle="validator" role="form2" method="post" id="formulario" action="cadastro_V2.do?key=<?php echo $_GET['key'] ;?>" autocomplete="off">
				...
				<div class="col-md-6 col-xs-12" id="caixaImg">
					<!-- <img src="https://img.bunker.mk/media/clientes/<?php echo $cod_empresa; ?>/<?=$des_img?>" class="img-responsive" style="margin-left: auto; margin-right: auto;"> -->
				</div>
					...
					<div class="row text-center">
						...
						<div class="bloco bloco-pai">
							...
							<div class="bloco" style="opacity: 0.9;">
								...
								echo getter($urlTKT[url][0].'&print=no');
								?>
								</center>
							</div>
							...
							<div class="col-md-10 col-md-offset-1 col-xs-12">
								<a href="<?=$urlTKT[url][0]?>&print=yes" target="_blank" class="btn btn-info btn-lg btn-block" style="color: #fff;">Visualização de impressão</a>
							</div>
