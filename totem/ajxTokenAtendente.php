...
?>
		...
		<div class="col-md-12 col-xs-12" id="reenvioToken">
			<a href="javascript:void(0)" class="btn btn-info btn-block" onclick='ajxTokenAlt()'><i class="fal fa-user-unlock" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp; Reenviar Token</a>
		</div>
		...
		?>
			...
			<div class="col-md-12 col-xs-12 text-left">
				...
				<div class="alert alert-warning" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<b>Token não enviado</b>, pois não há celular/email de destino. É necessário configurar a matriz de campos.
				</div>
		...
		?>
			...
			<div class="col-md-12 col-xs-12 text-left">
				...
				<div class="alert alert-danger" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					Usuário/senha da webservice inválido(s).<br>Contate o suporte.
				</div>
		...
		?>
			...
			<div class="col-md-12 col-xs-12 text-left">
				...
				<div class="alert alert-success" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					O token já enviado. Verifique o SMS recebido, e digite o token no campo abaixo. Caso não tenha recebido, por favor aguarde <b>5 minutos</b> e tente enviar o token novamente.
				</div>
				...
				?>
						<div class="col-md-<?= $colMd ?> col-xs-<?= $colXs ?>">
							<div class="form-group">
								...
								<input type="text" value="<?= $dado ?>" class="form-control input-sm input-hg <?= $qrCampos[CLASSE_INPUT] ?> data" name="<?= $qrCampos[DES_CAMPOOBG] ?>" id="<?= $qrCampos[DES_CAMPOOBG] ?>" maxlenght="10" <?= $dataError ?> <?= $required ?>>
								<div class="help-block with-errors"></div>
							</div>
						</div>
						...
						?>
							<div class="col-md-<?= $colMd ?> col-xs-<?= $colXs ?>">
								<div class="form-group">
									...
									<input type="text" value="<?= $dado ?>" class="form-control input-sm input-hg <?= $qrCampos[CLASSE_INPUT] ?> <?= $mask ?>" name="<?= $qrCampos[DES_CAMPOOBG] ?>" id="<?= $qrCampos[DES_CAMPOOBG] ?>" <?= $dataError ?> <?= $required ?>>
									<div class="help-block with-errors"></div>
								</div>
							</div>
					...
					default:
						...
						<div class="col-md-<?= $colMd ?> col-xs-<?= $colXs ?>">
							<div class="form-group">
								<label>&nbsp;</label>
								<label for="inputName" class="control-label <?= $required ?>"><?= $qrCampos[NOM_CAMPOOBG] ?></label>
								<input type="text" value="<?= $dado ?>" class="form-control input-sm input-hg <?= $qrCampos[CLASSE_INPUT] ?>" name="<?= $qrCampos[DES_CAMPOOBG] ?>" id="<?= $qrCampos[DES_CAMPOOBG] ?>" <?= $dataError ?> <?= $required ?>>
								<div class="help-block with-errors"></div>
							</div>
						</div>
