			...
			<div class="portlet portlet-bordered">
				...
				<div class="portlet-body">
					...
					<div class="push30"></div> 
						...
						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1366)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="fal fa-usd-circle fa-2x"></span>
							</div>
								<p style="height: 60px;">Créditos</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>

						<div class="col-md-2">  
							<a href="action.php?mod=<?php echo fnEncode(1792)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?php echo fnEncode($cod_conveni)?>"  class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="notify-badge">0</span> 
								<span class="fal fa-file-contract fa-2x"></span>
							</div>
								<p style="height: 60px;">Subprojetos</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>
						
						<?php 
						if ($cod_tpconveni == 1 || $cod_tpconveni == 3 ){
						?>
						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1359)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="fal fa-file-invoice fa-2x"></span>
							</div>
								<p style="height: 60px;">Controle de Entrega</p>
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>	
						<?php 
						...
						<div class="col-md-2">
							...
							<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1358)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow " style="color: #2c3e50; border: none">
							<div class="item">
								<span class="fal fa-ruler-combined fa-2x"></span>
							</div>
								<p style="height: 60px;">Autorização de Medição</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>
						-->
						...
						?>
						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1358)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="fal fa-ruler-combined fa-2x"></span>
							</div>
								<p style="height: 60px;">Boletim de Medição</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>						
						<?php 
						...
						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1363)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="notify-badge" style="background: green;">1</span>
								<span class="fal fa-money-check-alt fa-2x"></span>
							</div>
								<p style="height: 60px;">Movimentação Financeira</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>
						
						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1365)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="notify-badge" style="background: green;">1</span>
								<span class="fal fa-hand-holding-usd fa-2x"></span> 
							</div>
								<p style="height: 60px;">Pagamento</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>
						
						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1368)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="fal fa-money-bill fa-2x"></span>
							</div>
								<p style="height: 60px;">Controle de Despesas</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>

						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1769)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="fal fa-chart-line fa-2x"></span>
							</div>
								<p style="height: 60px;">Estatística de Cumprimento</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>

						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1345)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>"  class="tile tile-default shadow"style="color: #2c3e50; border: none">
							<div class="item">
								<span class="fal fa-file-invoice-dollar fa-2x"></span>
							</div>
								<p style="height: 60px;">Extrato Financeiro</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>
