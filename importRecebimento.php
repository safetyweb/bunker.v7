                            ...
                            <div class="container-fluid">
                                ...
                                <div class="passo" id="passo1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <button type="button" class="btn btn-lg btn-default btn-block upload"><i class="fal fa-box-full" aria-hidden="true"></i>&nbsp; Importar Produtos da Empresa</button>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <script>
                                            $(".tmplt").click(function(e) {
                                                e.preventDefault();
                                                location.href = "https://adm.bunker.mk/media/clientes/7/template_recebimento.xlsx";
                                            });
                                        </script>
                                    </div>
                                    <div class="col-md-2">
        ...
        function uploadFile(idField, typeFile) {
            ...
            if (ext == 'xlsx') {
                ...
                $.ajax({
                    ...
                    url: '../uploads/uploadImportRecebimento.php?acao=gravar&id=<?=fnencode($cod_empresa)?>&idC=<?= fnencode($cod_conveni) ?>&idCT=<?= fnencode($cod_contrat) ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(data) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "../uploads/uploadImportRecebimento.php?acao=ler&id=<?=fnencode($cod_empresa)?>",
                            /*beforeSend:function(){
                            	$("#passo1").html('<div class="loading" style="width: 100%;"></div>');
                            },*/

                            success: function(data) {
                                if ($.isNumeric(duplicados) || duplicados == "") {
                                    $('#FEZ_UPLOAD').val('S');
                                    $('#passo1').hide();
                                    $('#passo2').show();
                                    $("#passo2").html(data);
