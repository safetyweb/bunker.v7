							...
							<div class="row">
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" class="form-control input-sm leitura" readonly="readonly" name="COD_TIPOREG" id="COD_TIPOREG" value="">
									</div>
								</div>

								<div class="col-md-4">
									<div class="form-group">
										<label for="inputName" class="control-label required">Grupo da Região</label>
										<input type="text" class="form-control input-sm" name="DES_TIPOREG" id="DES_TIPOREG" maxlength="60" required>
										...
										while ($qrLista = mysqli_fetch_assoc($arrayQuery)) {
											...
											echo "
													<tr>
														...
														<td>" . $qrLista['COD_TIPOREG'] . "</td>
														<td>" . $qrLista['DES_TIPOREG'] . "</td>
														<td>" . $qrLista['COD_EXTERNO'] . "</td>
													</tr>
													<input type='hidden' id='ret_COD_TIPOREG_" . $count . "' value='" . $qrLista['COD_TIPOREG'] . "'>
													<input type='hidden' id='ret_DES_TIPOREG_" . $count . "' value='" . $qrLista['DES_TIPOREG'] . "'>
