	...
	<script type="text/javascript">
		...
		$("#ATRIBUTO13").chosen({ width: "100%" });		
			...
			$("#addProdutos").click(function() {
				...
				parent.$("#MULTI_PROD").val(JSON.stringify(listaProdutos));
				parent.$("#divProduto").html("<div class='form-group text-center'><label>&nbsp;</label><b>"+$cont+"</b> Produtos Selecionados</div>");
