													...
													<div class="col-sm-6 col-md-3">
														<div class="service-block" style="visibility: visible;">
															...
															<div class="text-block">
																<h4>Cadastros e Vendas</h4>
																<div class="text">Informações detalhadas do seu programa</div>
																<div class="push10"></div>
																<a href="action.do?mod=<?php echo fnEncode(1210)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Cadastros <small>RT</small> </a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1266)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Índice de Fidelização <small>RT</small></a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1216)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Índice de Fidelização <small>(por vendedor)</small></a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1139)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Vendas <small>RT</small></a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1245)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Vendas Estornadas</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1320)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Vendas Manuais</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1323)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Créditos Manuais</a> <br/>
															</div>
														</div>
													</div>
													...
													<div class="col-sm-6 col-md-3">
														<div class="service-block" style="visibility: visible;">
															...
															<div class="text-block">
																...
																<div class="push10"></div>
																<a href="action.do?mod=<?php echo fnEncode(1209)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Inconsistências</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1303)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Cadastros Geral</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1460)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Troca de Cartões</a> <br/>
															</div>
														</div>
													</div>																										
													<div class="col-sm-6 col-md-3">
														<div class="service-block" style="visibility: visible;">
															...
															<div class="text-block">
																...
																<div class="push10"></div>
																<a href="action.do?mod=<?php echo fnEncode(1191)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Vendas Bloqueadas</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1472)."&id=".fnEncode($cod_empresa); ?>" target="_blank">&rsaquo; Logins de Usuários</a> <br/>
															</div>
														</div>
													</div>											
													...
													<div class="col-sm-6 col-md-3">
														<div class="service-block" style="visibility: visible;">
															...
															<div class="text-block">
																...
																<a href="action.do?mod=<?php echo fnEncode(1202)."&id=".fnEncode($cod_empresa); ?>">&rsaquo; Estorno de Vendas WS</a> <br/>
																<a href="action.do?mod=<?php echo fnEncode(1370)."&id=".fnEncode($cod_empresa); ?>">&rsaquo; Dash XML Vendas</a> <br/>
															</div>
														</div>
													</div>	
