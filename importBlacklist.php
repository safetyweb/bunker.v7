													...
													<div class="col-md-2">
														...
														<script>
															$(".tmplt").click(function(e) {
																e.preventDefault();
															 	location.href = "https://adm.bunker.mk/media/clientes/7/Template_Importacao_Blacklist.xlsx";
															});
														</script>
													</div>
													<div class="col-md-2">
	 ...
	 function uploadFile(idField, typeFile) {
        ...
        if(ext == 'xlsx'){		
	        ...
	        $.ajax({
	            ...
	            url: '../uploads/uploadImport.php?acao=gravar&id=<?php echo $cod_empresa; ?>',
	            type: 'POST',
	            data: formData,
	            processData: false,
	            contentType: false,
	            success: function (data) {
	                ...
	                var duplicados = data;
	                    ...
	                    $.ajax({
							type: "POST",
							url: "../uploads/uploadImport.php?acao=ler&id=<?php echo $cod_empresa; ?>",
							/*beforeSend:function(){
