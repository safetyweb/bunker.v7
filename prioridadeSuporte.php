	...
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		else
		{
			...
			if ($opcao != ''){ 
				...
				$sql = "INSERT INTO SAC_PRIORIDADE(
						DES_PRIORIDADE,
						ABV_PRIORIDADE,
						DES_COR,
						DES_ICONE) 
	    		...
	    		$sql = "DELETE FROM SAC_PRIORIDADE WHERE COD_PRIORIDADE = $cod_prioridade";
						...
						<div class="col-md12 margin-bottom-30">
							...
							<div class="portlet portlet-bordered">
								...
								<div class="portlet-body">
									...
									<?php $abaInfoSuporte = 1275; include "abasSuporteConfig.php"; ?> 
