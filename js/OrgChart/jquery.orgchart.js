    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            if(opts.showControls){
                var buttonsHtml = "<div class='org-add-button'><i class='fas fa-plus'></i>"+opts.newNodeText+"</div><div class='org-del-button'><i class='fas fa-minus'></i></div>";
            }
            else{
                buttonsHtml = '';
            }
            return "<div class='node' name='"+name+"' description='"+description+"' node-id='"+this.data.id+"'>"+nameString+descString+buttonsHtml+"</div>";
        }
    }
