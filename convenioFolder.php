			...
			<div class="portlet portlet-bordered">
				...
				<div class="portlet-body">
					...
					<div class="push30"></div> 
						...
						<!--
						<div class="col-md-2">
							<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1097)?>&id=<?php echo fnEncode($cod_empresa)?>&tipo=<?php echo fnEncode('CAD')?>&idC=<?php echo fnEncode($cod_conveni)?>&pop=true" data-title="Convênio" class="tile tile-default shadow addBox" style="color: #2c3e50; border: none">
							...
							<div class="item">
								...
								<p style="height: 60px; margin: 5px 0 0 0;">Dados do Convênio</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>
						-->
						...
						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1563)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
						...
						<div class="col-md-2">  
							<a href="action.php?mod=<?php echo fnEncode(1344)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="notify-badge">4</span>
								<span class="fal fa-gavel fa-2x"></span>
							</div>
								<p style="height: 60px; margin: 5px 0 0 0;">Licitação</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>
						
						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1348)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="notify-badge" style="background: green;">1</span>
								<span class="fal fa-cogs fa-2x"></span>
							</div>
								<p style="height: 60px; margin: 5px 0 0 0;">Execução</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>
						
						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1352)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="notify-badge" style="background: green;">1</span>
								<span class="fal fa-copy fa-2x"></span>
							</div>
								<p style="height: 60px; margin: 5px 0 0 0;">Controle de Documentos</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>	
						...
						<div class="col-md-2">
							...
							<a href="action.php?mod=<?php echo fnEncode(1353)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>"class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="fal fa-tasks-alt fa-2x"></span>
							</div>
								<p style="height: 60px; margin: 5px 0 0 0;">Controle do Projeto</p>                            
								<div class="informer informer-default" style="color: #2c3e50;"></div>
							</a>  
						</div>	
						
						<div class="col-md-2">
							<a href="action.php?mod=<?php echo fnEncode(1354)?>&id=<?php echo fnEncode($cod_empresa)?>&idC=<?php echo fnEncode($cod_conveni)?>" class="tile tile-default shadow" style="color: #2c3e50; border: none">
							<div class="item">
								<span class="notify-badge">5</span>
								<span class="fal fa-money-check-alt fa-2x"></span>
							</div>
								<p style="height: 60px; margin: 5px 0 0 0;">Prestação de Contas</p>                            
								<div class="informer informer-default" style="color: #2c3e50;">
