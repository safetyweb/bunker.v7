						...
						<div class="col-md12 margin-bottom-30">
							...
							<div class="portlet portlet-bordered">
								...
								<div class="portlet-body">
									...
									$sql1 = "SELECT count(cod_empresa) TEMACESSO  FROM CONFIGURACAO_ACESSO WHERE cod_parcomu='14' AND LOG_STATUS='S' AND cod_empresa = $cod_empresa ";
									...
									<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
										...
										<div  class="col-sm-12"	style="padding-left: 0;">
											...
											<div class="col-xs-2" style="padding-left: 0;"> <!-- required for floating -->
											  ...
											  <ul class="vTab nav nav-tabs tabs-left text-center">
												...
												<li class="active vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1565)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1554)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1553)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1571)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
												...
												<li class="vTab">				
													<a href="javascript:void(0)" data-url="action.php?mod=<?php echo fnEncode(1555)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" onclick="mudaAba($(this).attr('data-url'))" data-toggle="tab">
											...
											<div class="col-xs-10 no-scroll">
												...
												<iframe frameborder="0" id="conteudoAba" src="action.php?mod=<?php echo fnEncode(1565)?>&id=<?php echo fnEncode($cod_empresa)?>&idc=<?=fnEncode($cod_campanha)?>&pop=true" style="width: 100%; min-height: 25vh;"></iframe>
