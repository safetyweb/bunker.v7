<?php 
	...
	$sql = "SELECT CP.DES_CAMPANHA, 
						   ...
						   ECA.COD_PERSONAS,
						   TE.COD_TEMPLATE,
						   TE.DES_TITULO AS TITULO_MSG,
						   TE.DES_TEMPLATE AS HTML 
					FROM CAMPANHA CP
					INNER JOIN PUSH_CONTROLE_AUX ECA ON ECA.COD_CAMPANHA = CP.COD_CAMPANHA
	...
	$sql = "SELECT $selectCliente,
				   ...
				   CP.VERSAO_SISTEMA
			FROM clientes C 
			INNER JOIN PUSH_CONTROLE EC ON EC.COD_CLIENTE = C.COD_CLIENTE
    ...
    // if($retornoDeb['cod_msg'] == 1){
    	...
    	$sqlControle = "INSERT INTO PUSH_LOTE(
		 				...
		 				UPDATE PUSH_CONTROLE SET DAT_ENVIO = '$dat_envio'
