<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		else
		{
			...
			$cod_subcatesac = fnLimpaCampoZero($_REQUEST['COD_SUBCATESAC']);
			$cod_tpsolicitacao = fnLimpaCampoZero($_REQUEST['COD_TPSOLICITACAO']);
			$des_subcatesac = fnLimpaCampo($_REQUEST['DES_SUBCATESAC']);
			$abv_subcatesac = fnLimpaCampo($_REQUEST['ABV_SUBCATESAC']);
			...
			if ($opcao != ''){ 
				...
				$sql = "INSERT INTO SAC_SUBCATEGOR(
						COD_TPSOLICITACAO,
						DES_SUBCATESAC,
						ABV_SUBCATESAC,
						DES_COR,
	    		...
	    		$sql = "DELETE FROM SAC_SUBCATEGOR WHERE COD_SUBCATESAC = $cod_subcatesac";
	    		...
	    		$sql = "UPDATE SAC_SUBCATEGOR SET 
			    		COD_TPSOLICITACAO='$cod_tpsolicitacao',
			    		DES_SUBCATESAC='$des_subcatesac',
			    		ABV_SUBCATESAC='$abv_subcatesac',
			    		DES_COR='$des_cor',
			    		DES_ICONE='$des_icone'

			    		WHERE COD_SUBCATESAC=$cod_subcatesac
			    		";
...
?>
						...
						<div class="col-md12 margin-bottom-30">
							...
							<div class="portlet portlet-bordered">
								...
								<div class="portlet-body">
									...
									<?php $abaInfoSuporte = 1431; include "abasSuporteConfig.php"; ?> 
								...
								<div class="login-form">
									...
									<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
												...
												<div class="row">
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm leitura" readonly="readonly" name="COD_SUBCATESAC" id="COD_SUBCATESAC" value="">
														</div>
													</div>
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm" name="DES_SUBCATESAC" id="DES_SUBCATESAC" maxlength="50" required>
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" class="form-control input-sm" name="ABV_SUBCATESAC" id="ABV_SUBCATESAC" maxlength="20" required>
															<div class="help-block with-errors"></div>
														</div>
													</div>
														...
														<div class="form-group">
															...
															<select class="chosen-select-deselect requiredChk" data-placeholder="Selecione o tipo" name="COD_TPSOLICITACAO" id="COD_TPSOLICITACAO">
																...
																<?php 
																		...
																		$sql = "SELECT COD_TPSOLICITACAO, DES_TPSOLICITACAO FROM SAC_TPSOLICITACAO";
																		$arrayQuery = mysqli_query($connAdmSAC->connAdm(),$sql);
																	
																		while ($qrStatus = mysqli_fetch_assoc($arrayQuery))
																		  {
																		  	?>
																		  	<option value="<?php echo $qrStatus['COD_TPSOLICITACAO']; ?>"><?php echo $qrStatus['DES_TPSOLICITACAO']; ?></option>
																		  	<?php } ?>
															</select>
															<div class="help-block with-errors"></div>
														</div>
										...
										<!--<input type="hidden" name="COD_SUBCATESAC" id="COD_SUBCATESAC" value="<?php echo $cod_plataf; ?>">-->
										...
										<div class="col-lg-12">
											...
											<div class="no-more-tables">
												...
												<tbody>
													...
													$sql = "SELECT SB.*, ST.DES_TPSOLICITACAO FROM SAC_SUBCATEGOR SB
															LEFT JOIN SAC_TPSOLICITACAO ST ON ST.COD_TPSOLICITACAO = SB.COD_TPSOLICITACAO";
													...
													while ($qrBuscaModulos = mysqli_fetch_assoc($arrayQuery))
													  ...
													  ?>
														<tr>
															...
															<td><?php echo $qrBuscaModulos['COD_SUBCATESAC']; ?></td>
															<td><?php echo $qrBuscaModulos['DES_TPSOLICITACAO']; ?></td>
															<td><?php echo $qrBuscaModulos['DES_SUBCATESAC']; ?></td>
															<td><?php echo $qrBuscaModulos['ABV_SUBCATESAC']; ?></td>
															<td align='center'><span style='color: <?php echo $qrBuscaModulos['DES_COR'];?>;' class='<?php  echo $qrBuscaModulos['DES_ICONE'];?>' ></td>
														</tr>

														<input type='hidden' id='ret_COD_SUBCATESAC_<?php echo $count; ?>' value='<?php echo $qrBuscaModulos['COD_SUBCATESAC']; ?>'>
														<input type='hidden' id='ret_COD_TPSOLICITACAO_<?php echo $count; ?>' value='<?php echo $qrBuscaModulos['COD_TPSOLICITACAO']; ?>'>
														<input type='hidden' id='ret_DES_SUBCATESAC_<?php echo $count; ?>' value='<?php echo $qrBuscaModulos['DES_SUBCATESAC']; ?>'>
														<input type='hidden' id='ret_ABV_SUBCATESAC_<?php echo $count; ?>' value='<?php echo $qrBuscaModulos['ABV_SUBCATESAC']; ?>'>
	...
	<script type="text/javascript">
		...
		function retornaForm(index){
			$("#formulario #COD_SUBCATESAC").val($("#ret_COD_SUBCATESAC_"+index).val());
			$("#formulario #COD_TPSOLICITACAO").val($("#ret_COD_TPSOLICITACAO_"+index).val()).trigger("chosen:updated");
			$("#formulario #DES_SUBCATESAC").val($("#ret_DES_SUBCATESAC_"+index).val());
			$("#formulario #ABV_SUBCATESAC").val($("#ret_ABV_SUBCATESAC_"+index).val());
