<?php
	...
	if( $_SERVER['REQUEST_METHOD']=='POST' )
	{
		...
		else
		{
			...
			$nom_bltempl = fnLimpaCampo($_POST['NOM_BLTEMPL']);
			$abv_bltempl = fnLimpaCampo($_POST['ABV_BLTEMPL']);
			$des_cor = fnLimpaCampo($_POST['DES_COR']);
			$des_icone = fnLimpaCampo($_POST['DES_ICONE']);
			$num_ordenac = fnLimpaCampoZero($_POST['NUM_ORDENAC']);
			...
			if ($opcao != ''){				
				...
				switch ($opcao)
				{
					case 'CAD':
						...
						$sql = "INSERT INTO BLOCO_COMUNICACAO(
										NOM_BLTEMPL,
										ABV_BLTEMPL,
										DES_COR,
										DES_ICONE,
					...
					case 'ALT':
						...
						$sql = "UPDATE BLOCO_COMUNICACAO SET
										NOM_BLTEMPL='$nom_bltempl',
										ABV_BLTEMPL='$abv_bltempl',
										DES_COR='$des_cor',
										DES_ICONE='$des_icone',
										COD_TPCOM=$cod_tpcom
								WHERE COD_BLTEMPL = $cod_bltempl";
					...
					case 'EXC':
						...
						$sql = "DELETE FROM BLOCO_COMUNICACAO
								WHERE COD_BLTEMPL = $cod_bltempl";
										...
										<div id="divId_sub">
											...
											<div class="no-more-tables">
												...
												<?php 
													...
													$sql = "SELECT * FROM BLOCO_COMUNICACAO ORDER BY NUM_ORDENAC";
													//fnEscreve($sql);
													$arrayQuery = mysqli_query($connAdm->connAdm(),$sql) or die(mysqli_error());
													...
													while ($qrBuscaModulos = mysqli_fetch_assoc($arrayQuery))
													  {														  
														...
														echo"
															<tr>
															  <td align='center'><span class='fal fa-equals grabbable' data-id='".$qrBuscaModulos['COD_BLTEMPL']."'></span></td>
															  ...
															  <td align='center'><span class='".$qrBuscaModulos['DES_ICONE']."' style='color:".$qrBuscaModulos['DES_COR']."'></td>															  
															</tr>
