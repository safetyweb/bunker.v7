	...
	<div class="portlet-body">
		...
		<div class="row">
			...
			?>
				...
				<div class="col-md-2">
					...
					<a href="#" class="tile tile-default shadow addBox" style="color: #2c3e50;" data-url="action.do?mod=<?php echo fnEncode(1040) ?>&id=<?php echo fnEncode($cod_empresa) ?>&idp=<?php echo fnEncode($qrLista['COD_TPCAMPA']) ?>&pop=true" data-title="Campanha / <?php echo $nom_empresa; ?>">
						<span style="margin: 20px 0 0 0;" class="<?php echo $qrLista['DES_ICONE']; ?> fa-1dot5x"></span>
		...
		<div class="row">
			...
			<div class="col-md-3">
				...
				<a class="btn btn-info btn-block addBox" data-url="action.do?mod=<?php echo fnEncode(1040) ?>&id=<?php echo fnEncode($cod_empresa) ?>&pop=true" data-title="Campanha / <?php echo $nom_empresa; ?>"><i class="fas fa-plus" aria-hidden="true" style="margin: 5px 0 5px 0;"></i> Criar Nova Campanha</a>
						...
						<div class="input-group activeItem">
							<div class="input-group-btn search-panel">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li><a href="#DES_CAMPANHA">Nome Campanha</a></li>
									<li><a href="#NOM_TPCAMPA">Tipo Campanha</a></li>
									<li><a href="#COD_CAMPANHA">Código</a></li>
								</ul>
							</div>
			...
			<div class="col-md-12">
				...
				<table class="table table-bordered table-striped table-hover tablesorter buscavel">
					<thead>
						<tr>
							<th>Código</th>
							<th class="sorter-text">Nome da Campanha</th>
							<th class="text-center sorter-text">Unidade</th>
							<th class="sorter-text">Tipo Campanha</th>
							<th class="sorter-text">Usuário Cad.</th>
...
<script type="text/javascript">
	...
	function RefreshCampanha(idEmp) {
		...
		$.ajax({
			type: "GET",
			url: "ajxRefreshCampanha.do",
			data: {
				ajx1: idEmp,
				LOG_CAMPUSU: log_campusu,
				LOG_CAMPVALIDA: log_campvalida,
				MODSAUTORIZADOS: modsAutorizados,
			},
			beforeSend: function() {
			...
			success: function(data) {
				$("#div_refreshCampanha").empty().append(data);
			},
			error: function() {
			...
			buttons: {
				"Sim": {
					...
					action: function() {
						$.ajax({
							type: "POST",
							url: "ajxRefreshCampanha.do?opcao=EXC",
							data: {
								COD_EMPRESA: idEmp,
