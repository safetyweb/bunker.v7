...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (isset($_SESSION['last_request']) && $_SESSION['last_request'] == $request) {
		...
		$des_logoini = fnLimpaCampo(@$_REQUEST['DES_LOGOINI']);
		$des_imgback = fnLimpaCampo(@$_REQUEST['DES_IMGBACK']);
		$des_bannerini = fnLimpaCampo(@$_REQUEST['DES_BANNERINI']);
		$des_imgbackini = fnLimpaCampo(@$_REQUEST['DES_IMGBACKINI']);
		...
		if ($opcao != '') {
			...
			if ($opcao == 'ALT') {
				...
				$sqlUpdate = "UPDATE TOTEM_APP SET 
								DES_LOGO = '$des_logo', 
								DES_LOGOINI = '$des_logoini', 
								DES_IMGBACK = '$des_imgback', 
								DES_BANNERINI = '$des_bannerini', 
								DES_IMGBACKINI = '$des_imgbackini', 
...
if (isset($qrBuscaSiteTotemApp)) {
	...
	$des_logoini = $qrBuscaSiteTotemApp['DES_LOGOINI'];
	$des_imgback = $qrBuscaSiteTotemApp['DES_IMGBACK'];
	$des_bannerini = $qrBuscaSiteTotemApp['DES_BANNERINI'];
	$des_imgbackini = $qrBuscaSiteTotemApp['DES_IMGBACKINI'];
					...
					<form data-toggle="validator" role="form2" method="POST" id="formulario" action="<?php echo $cmdPage; ?>">
							...
							<div class="col-md-3">
								...
								<div class="row">
									...
									<fieldset>
										...
										<div class="col-md-6">
											<label for="inputName" class="control-label">Banner do início</label>
											<div class="input-group">
												<span class="input-group-btn">
													<a type="button" name="btnBusca" id="btnBusca" style="height:35px;" class="btn btn-primary upload" idinput="DES_BANNERINI" extensao="img"><i class="fa fa-cloud-upload" aria-hidden="true"></i></a>
												</span>
												<input type="text" name="BANNERINI" id="BANNERINI" class="form-control input-sm" style="border-radius: 0 3px 3px  0;" maxlength="100" value="<?php echo fnBase64DecodeImg($des_bannerini); ?>">
												<input type="hidden" name="DES_BANNERINI" id="DES_BANNERINI" maxlength="100" value="<?php echo $des_bannerini; ?>">
											</div>
											<span class="help-block">Imagem da tela inicial(.jpg 1400px X 600px)</span>
										</div>

										<div class="col-md-6">
											<label for="inputName" class="control-label">Imagem de Fundo do início</label>
											<div class="input-group">
												<span class="input-group-btn">
													<a type="button" name="btnBusca" id="btnBusca" style="height:35px;" class="btn btn-primary upload" idinput="DES_IMGBACKINI" extensao="img"><i class="fa fa-cloud-upload" aria-hidden="true"></i></a>
												</span>
												<input type="text" name="IMGBACKINI" id="IMGBACKINI" class="form-control input-sm" style="border-radius: 0 3px 3px  0;" maxlength="100" value="<?php echo fnBase64DecodeImg($des_imgbackini); ?>">
												<input type="hidden" name="DES_IMGBACKINI" id="DES_IMGBACKINI" maxlength="100" value="<?php echo $des_imgbackini; ?>">
											</div>
											<span class="help-block">Fundo da tela inicial (.jpg 1400px X 600px)</span>
										</div>

										<div class="push10"></div>

										<div class="col-md-6">
											<label for="inputName" class="control-label">Logotipo do início</label>
											<div class="input-group">
												<span class="input-group-btn">
													<a type="button" name="btnBusca" id="btnBusca" style="height:35px;" class="btn btn-primary upload" idinput="DES_LOGOINI" extensao="img"><i class="fa fa-cloud-upload" aria-hidden="true"></i></a>
												</span>
												<input type="text" name="LOGOINI" id="LOGOINI" class="form-control input-sm" style="border-radius: 0 3px 3px  0;" maxlength="100" value="<?php echo fnBase64DecodeImg($des_logoini); ?>">
												<input type="hidden" name="DES_LOGOINI" id="DES_LOGOINI" maxlength="100" value="<?php echo $des_logoini; ?>">
											</div>
											<span class="help-block">Acima do banner (.jpg 1400px X 600px)</span>
										</div>
						...
						<div class="row">
							...
							<fieldset>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Ganho/Expiração na Home</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_EXPIRA" id="LOG_EXPIRA" class="switch switch-small" value="S" <?= $chk_expira ?>>
											<span></span>
										</label>
										<div class="push10"></div>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Coluna Dupla Menu</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_COLUNAS" id="LOG_COLUNAS" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_colunas ?>>
											<span></span>
										</label>
										<div class="push10"></div>
									</div>
								...
								<?php if ($cod_empresa == 19) { ?>
									...
									<div class="col-md-2">
										<div class="form-group">
											<label for="inputName" class="control-label">Gerar Token</label>
											<div class="push5"></div>
											<label class="switch switch-small">
												<input type="checkbox" name="LOG_TOKEN" id="LOG_TOKEN" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_token ?>>
												<span></span>
											</label>
										</div>
									</div>
									...
									<div class="col-md-2">
										<div class="form-group">
											<label for="inputName" class="control-label">Cadastro de Veículos</label>
											<div class="push5"></div>
											<label class="switch switch-small">
												<input type="checkbox" name="LOG_VEICULO" id="LOG_VEICULO" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_veiculo ?>>
												<span></span>
											</label>
										</div>
									</div>
								...
								<!-- <div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Banner no Menu</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_OFERTAS" id="LOG_OFERTAS" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_ofertas ?>>
											<span></span>
										</label>
									</div>
								</div> -->
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Minhas Ofertas</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_OFERTAS" id="LOG_OFERTAS" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_ofertas ?>>
											<span></span>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Jornal de Ofertas</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_JORNAL" id="LOG_JORNAL" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_jornal ?>>
											<span></span>
										</label>
										<div class="push10"></div>
									</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Minhas Compras</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_HABITO" id="LOG_HABITO" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_habito ?>>
											<span></span>
										</label>
										<div class="push10"></div>
									</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Meus Dados</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_DADOS" id="LOG_DADOS" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_dados ?>>
											<span></span>
										</label>
										<div class="push10"></div>
									</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_EXTRATO" id="LOG_EXTRATO" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_extrato ?>>
											<span></span>
										</label>
										<div class="push10"></div>
									</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Mensagens</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_MENSAGEM" id="LOG_MENSAGEM" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_mensagem ?>>
											<span></span>
										</label>
										<div class="push10"></div>
									</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_PREMIOS" id="LOG_PREMIOS" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_premios ?>>
											<span></span>
										</label>
										<div class="push10"></div>
									</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Parceiros</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_PARCEIROS" id="LOG_PARCEIROS" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_parceiros ?>>
											<span></span>
										</label>
										<div class="push10"></div>
									</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Endereços</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_ENDERECOS" id="LOG_ENDERECOS" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_enderecos ?>>
											<span></span>
										</label>
										<div class="push10"></div>
									</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Fale Conosco</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_COMUNICA" id="LOG_COMUNICA" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_comunica ?>>
											<span></span>
										</label>
										<div class="push5"></div>
										<span class="help-block"><?= $emailEmpresa ?></span>
									</div>
								</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Meus Amigos</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_AMIGOS" id="LOG_AMIGOS" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_amigos ?>>
											<span></span>
										</label>
										<div class="push10"></div>
									</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="inputName" class="control-label">Meus Prêmios</label>
										<div class="push5"></div>
										<label class="switch switch-small">
											<input type="checkbox" name="LOG_BRINDES" id="LOG_BRINDES" class="switch switch-small" value="S" onchange="toggleMenu(this)" <?= $chk_brindes ?>>
											<span></span>
										</label>
										<div class="push10"></div>
									</div>
											...
											<div class="row">
												...
												<div class="col-md-12">
													...
													<div class="mobile_wrap">
														...
														<div class="container_wrap fundoCel2 col-xs-12" style="background-color: #fff; height: 100%;">

															<div class="row" style="margin-bottom: 0px;">
																<div class="col-md-12 d-inline-flex space-between-centered" style=" padding: 0; margin-left: auto; margin-right: auto; margin-bottom: 0px;">
																	<img src="./images/nova_duque.png" width="100%" alt="">
																</div>

																<div class="col-md-12" style="border-radius: 15px 15px 0px 0px; margin-bottom: 0; background-color: <?= $cor_fullpag ?>;">

																	<div class="row" style="margin-bottom: 30px; margin-top: 15px;">
																		<div class="col-md-12" style="margin-bottom: 10px;">
																			<a href="javascript:void(0)" class="btn btn-primary btn-sm btn-block f14b" style="background-color: #fff; color: <?= $cor_fullpag ?>; border-color: #03000f;">Entrar</a>
																		</div>
																		<div class="col-md-12">
																			<a href="javascript:void(0)" class="btn btn-primary btn-sm btn-block f14b" style="background-color: <?= $cor_fullpag ?>; color: #fff; border-color: #fff;">Cadastrar-se</a>
																		</div>
																	</div>

																	<div class="row" style="margin-bottom: 0px; padding-bottom: 30px;">
											...
											<div class="row">
												...
												<div class="col-md-12">
													...
													<div class="mobile_wrap">
														...
														<div class="container-wrap col-xs-12 fundoCel1" style=" background-color: <?= $cor_fullpag ?>;">

															<div class="row fundoCel1" style="height: 60px; background-color: <?= $cor_fullpag ?>; ">
																<div class="col-md-12 d-inline-flex space-between-centered" style="color: <?= $cor_textfull ?>; padding: 15px;">
																	<span class="fal fa-angle-left fa-2x pull-left" style="width: 33%;"></span>
																	<span class="f14b text-center" style="width: 33%;">Faça seu login</span>
																	<span style="width: 33%;">
																		<?php if ($des_logo != '' && $des_logo != 0) { ?>
																			<img class="img-responsive pull-right" alt="" width="65px" src="./media/clientes/<?php echo $cod_empresa ?>/<?php echo $des_logo ?>">
																		<?php } else { ?>
																			<img class="img-responsive pull-right" alt="" width="65px" src="./media/clientes/marka_white_small.png">
																		<?php } ?>
																	</span>
																</div>
															</div>
															...
															<div class="row">
																...
																<div class="col-xs-12 fundoCel1 text-center" style=" color: <?= $cor_textfull ?>; background-color: <?= $cor_fullpag ?>;  border-radius: 0px; margin-bottom: 20px; overflow: wrap;">

																	<h4><?= $nom_empresa ?></h4>

																	<p class="f13 text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>

																</div>

															</div>

															<div class="row" id="bloco_login" style="border-radius: 15px 15px 0px 0px; margin-bottom: 0; margin-top:15px; background-color: #fff; padding-top: 22px;">

																<div class="col-md-12" style="margin-bottom: 15px;">
																	<div class="form-group">
																		<label class="required f14b">CPF/CNPJ</label>
																		<input type="text" class="form-control input-sm" value="CPF/CNPJ">
																	</div>
																</div>

																<div class="col-md-12" style="margin-bottom: 30px;">
																	<div class="form-group">
																		<label class="required f14b">Senha</label>
																		<input type="text" class="form-control input-sm" value="Senha">
																	</div>
																</div>

																<div class="col-md-12" style="margin-bottom: 30px;">
																	<div class="form-group">
																		<input id="keep" type="checkbox" value="1">
																		<label for="keep" class="f14b">Lembrar informações de login</label>
																	</div>
																</div>

																<div class="col-md-12" style="margin-bottom: 10px;">
																	<a href="javascript:void(0)" class="btn btn-primary btn-sm btn-block f14b" style="background-color: <?= $cor_fullpag ?>; color: #fff; border-color: <?= $cor_fullpag ?>;">Entrar</a>
																</div>
																<div class="col-md-12">
																	<a href="javascript:void(0)" class="btn btn-primary btn-sm btn-block f14b" style="background-color: #fff; color: <?= $cor_fullpag ?>; border-color: #03000f;">Esqueci minha senha</a>
																</div>


																<div class="col-md-12 text-center" style="margin-top:65px; margin-bottom: 70px;">
																	Não possui cadastro? <a href="javascript:void(0)" style="text-decoration: underline;">Cadastre-se</a>
																</div>
													...
													<div class="mobile_wrap">
														...
														<div class="container-wrap col-xs-12 fundoCel1" style=" background-color: <?= $cor_fullpag ?>;">
															...
															<div class="row fundoCel1" style="height: 60px; background-color: <?= $cor_fullpag ?>; ">
																<div class="col-md-12 d-inline-flex space-between-centered" style="color: <?= $cor_textfull ?>; padding: 15px;">
																	<span class="fal fa-angle-left fa-2x pull-left" style="width: 33%;"></span>
																	<span class="f14b text-center" style="width: 33%;">Início</span>
																	<span style="width: 33%;">
																		<?php if ($des_logo != '' && $des_logo != 0) { ?>
																			<img class="img-responsive pull-right" alt="" width="65px" src="./media/clientes/<?php echo $cod_empresa ?>/<?php echo $des_logo ?>">
																		<?php } else { ?>
															...
															<div class="row">
																...
																<div class="col-xs-12 fundoCel1" style=" color: <?= $cor_textfull ?>; background-color: <?= $cor_fullpag ?>;  width: 100%; border-radius: 0px; margin-bottom: 20px;">

																	<h4>Olá, Cleverson!</h4>

																	<p class="f13 text-muted">Saldo disponível</p>
																	<span class="f18b">R$1350,56</span>
																...
																<div class="col-xs-6" style="padding: 15px;">
																	<div class="bloco-saldo d-flex space-between-centered">
																		...
																		<span class="f16b">R$ 15,14</span>
																	</div>
																</div>
																<div class="col-xs-6" style="padding: 15px;">
																	<div class="bloco-saldo d-flex space-between-centered">
																		<span class="f14">Expirado</span><span class="fal fa-angle-right pull-right"></span>
																		<span class="f16b">R$ 00,00</span>
																	</div>
																</div>

																<div class="col-xs-12">
																	<div class="btn btn-info-mock btn-block btn-lg d-inline-flex d-centered" style="background-color: <?= $cor_backpag ?>; color: <?= $cor_fullpag ?>; border-color: <?= $cor_fullpag ?>;"><span class="fal fa-qrcode"></span>&nbsp;&nbsp;Gerar Tokens</div>
																</div>

															</div>

															<div class="row" style="border-radius: 15px 15px 0px 0px; margin-bottom: 0; margin-top:35px; background-color: #fff;">

																<p class="f12b" style="margin-top: 25px; margin-bottom: 25px; margin-left: 15px; font-weight: bold; font-size: 13px;">Funcionalidades</p>
	...
	$(document).ready(function() {
		...
		$("#LOG_LINHA").on("change", function() {
			if ($(this).prop('checked')) {
				...
				$("#COD_SEXOPES_chosen .chosen-single,#COD_PROFISS_chosen .chosen-single").removeClass("campo-linha").removeClass("shadow-linha");
				$("#bloco_cadastro,#bloco_login").find('.input-sm').removeClass("campo-linha").removeClass("shadow-linha");
			}
		});
		...
		$.ajax({
			...
			success: function(data) {
				...
				if (data.success) {
					...
					var pathLogo = 'media/clientes/<?php echo $cod_empresa ?>/' + data.nome_arquivo;
					//--------------------------------------------------
					$.alert({
						title: "Mensagem",
