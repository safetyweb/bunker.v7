    ...
    if (isset($_SESSION['last_request']) && $_SESSION['last_request'] == $request) {
        ...
        if ($opcao != '') {
            ...
            switch ($opcao) {
                ...
                case 'EXC':
                    $sql = "DELETE FROM ARTIGO_TOUR WHERE COD_ARTIGO = $cod_artigo;";
                    // fnEscreve($sql);
                    mysqli_query($connAdm->connAdm(), trim($sql));
...
if ($popUp == 'true') {
    ...
    $sql = "SELECT * FROM ARTIGO_TOUR WHERE COD_ARTIGO = $cod_artigo";
    $arrayQuery = mysqli_query($connAdm->connAdm(), $sql) or die(mysqli_error());
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="DES_ANEXO1" id="DES_ANEXO1" class="form-control input-sm" style="border-radius: 0 3px 3px  0;" maxlength="250" value="">
                                        </div>
                                        <span class="help-block"></span>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="DES_ANEXO2" id="DES_ANEXO2" class="form-control input-sm" style="border-radius: 0 3px 3px  0;" maxlength="250" value="">
                                        </div>
                                        <span class="help-block"></span>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="DES_ANEXO3" id="DES_ANEXO3" class="form-control input-sm" style="border-radius: 0 3px 3px  0;" maxlength="250" value="">
                                        </div>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <form name="formLista">
                                    ...
                                    <table class="table table-bordered table-striped table-hover table-sortable">
                                        ...
                                        <tbody>
                                            ...
                                            // $sql = "SELECT AT.*, CT.DES_CATEGOR FROM ARTIGO_TOUR AT
                                            //         LEFT JOIN CATEGORIA_TUTORIAL CT ON CT.COD_CATEGOR = AT.COD_CATEGOR";
                                            $sql = "SELECT AT.*, CT.DES_CATEGOR, ST.DES_SUBCATEGOR, M.NOM_MODULOS FROM ARTIGO_TOUR AT
                                                                LEFT JOIN CATEGORIA_TUTORIAL CT ON CT.COD_CATEGOR = AT.COD_CATEGOR
