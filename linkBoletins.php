...
?>
											...
											<div class="no-more-tables">
												...
												<?php
													...
													WHERE CR.COD_EMPRESA = $cod_empresa AND CR.COD_CONVENI = $cod_conveni
														AND IFNULL(CR.COD_RECEBIM_LOTE,0) <= 0";
													  ...
													  {														  
														...
														echo"
															<tr>
															  ...
															  <td class='text-center'>".$qrMedicao['COD_RECEBIM']."</td>
															  <td>".$qrMedicao['NRO_CONTRAT']."</td>
															  <td>".$qrMedicao['NOM_CLIENTE']."</td>
															  <td>".$qrMedicao['NUM_MEDICAO']."</td>
															  <td>".fnDataShort($qrMedicao['DAT_MEDICAO'])."</td>
															  <td class='text-right'>".fnValor($qrMedicao['VAL_TOTAL'],2)."</td>
															  <td class='text-right'>".fnValor($val_saldo,2)."</td>
															</tr>
															<input type='hidden' id='ret_IDC_".$count."' value='".fnEncode($qrMedicao['COD_RECEBIM'])."'>
															"; 
														  }											
	...
	//-----------------------------------------------------------------------------------
		...
		function retornaForm(index){
			...
			$('#formLista').attr('action', 'action.do?mod=<?php echo $DestinoPg; ?>&id=<?=fnEncode($cod_empresa)?>&idC='+$("#ret_IDC_"+index).val());					
			$('#formLista').submit();					
		}
