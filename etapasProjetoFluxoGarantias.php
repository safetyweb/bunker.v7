	...
	else
	{
		...
		if ($opcao != ''){
			...
			switch ($opcao)
			{
				...
				$sqlReordena = "SELECT MAX(NUM_ORDENAC) NUM_ORDEMTASK FROM TAREFA_PROJETO_CONTRATO WHERE COD_TAREFA = $cod_subtarefa";
				...
				if($qrOrdemtask[NUM_ORDEMTASK] != ""){
					...
					$sqlUpdtOrdem = "UPDATE TAREFA_PROJETO_CONTRATO SET
				...
				$sql = "INSERT INTO TAREFA_PROJETO_CONTRATO(
					COD_EMPRESA,
					COD_SISTEMA,
					COD_SUBTAREFA,
					NUM_ORDENAC,
				...
				<?php } else { ?>
					...
					<div class="portlet-body">
						...
						<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
							...
							<input type="hidden" name="NUM_CONTRATO" id="NUM_CONTRATO" value="<?=$num_contrato?>">
