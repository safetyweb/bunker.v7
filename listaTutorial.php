            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
              <div class="input-group activeItem">
                <div class="input-group-btn search-panel">
                  ...
                  <!-- <li class="divisor"><a href="#DES_ARTIGO">Sem filtro</a></li> -->
                  <!-- <li class="divider"></li> -->
                  <!-- <li><a href="#DES_ARTIGO">Artigo</a></li> -->
                ...
                <div class="input-group-btn" id="CLEARDIV" style="<?= $esconde ?>">
                  <button class="btn btn-outline form-control form-control-lg remove-side-borders search-bar" id="CLEAR" type="button">&nbsp;<span class="fal fa-times"></span></button>
                </div>
                <div class="input-group-btn">
                  <button type="submit" class="btn btn-outline form-control form-control-lg rounded-right search-bar" id="SEARCH">&nbsp;<span class="fal fa-search"></span></button>
                </div>
              </div>
            </div>
          ...
          <div id="databases" class="tab-pane fade in active">
            ...
            <div class="row">
              ...
              while ($qrCat = mysqli_fetch_assoc($arrayQuery)) {
                ...
                if ($isModAdm) {
                  //$tituloCategoria .= ($qrCat['LOG_PUBLICO'] == "S") ? " (Público)" : " (Privado)";
                }

              ?>
                <div class="col-md-4 item-bd">
                  <div class="col-md-12">
                    <center><span class="<?= $qrCat['DES_ICONE'] ?> fa-3x" style="color:<?= $qrCat['DES_COR'] ?>;"></span></center>
