...
<html lang="pt-br">
    ...
    <body class="bgColor" data-gr-c-s-loaded="true">
        ...
        <div class="container">
            ...
            <div class="push10"></div> 
            <a href="relTokens.php?secur=<?php echo $MENUSTARING;?>" class="btn btn-primary btn-block">Vendas Tokens</a>			
			<div class="push10"></div> 
            <a href="relTokensNOK.php?secur=<?php echo $MENUSTARING;?>" class="btn btn-primary btn-block">Vendas Tokens Inválidos</a>			
			<div class="push10"></div> 
