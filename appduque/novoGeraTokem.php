...
$cartao="select COD_CLIENTE,NUM_CARTAO from clientes where num_cartao='".$cod_cliente."' AND COD_EMPRESA = 19";
...
<html lang="pt-br">
    ...
    <body class="bgColor" data-gr-c-s-loaded="true">
        ...
        <div class="container text-center">
          ...
          <div class="col-xs-12">
            <p>Para obter seu desconto no momento do pagamento, apresente este código ao frentista</p>
          </div>
