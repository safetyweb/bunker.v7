	...
	if( $_SERVER['REQUEST_METHOD']=='POST' )
	{
		...
		else
		{
			...
			if ($opcao != ''){
				...
				$sql = "CALL SP_RELAT_SMS_CLIENTE($cod_empresa, $cod_campanha, '$pct_reserva', '$cod_personas', '$tipo')";
				//fnEscreve($sql);
...
<style>
									...
									<div class="login-form">
										...
										<form data-toggle="validator" role="form2" method="post" id="formulario" action="<?php echo $cmdPage; ?>">
											...
											<div class="row">
												...
												<div class="col-md-3 col-xs-4 text-center">
													<i class="fal fa-phone fa-2x">&nbsp; </i><span class="f17" id="CLIENTES_UNICOS_SMS"><?=fnValor($clientes_unicos_sms,0)?> &nbsp;&nbsp;<span class="f12 c1"><?=fnValor($pct_unicos_mail,2)?>%</span> </span> 
													<h5>Clientes Únicos Com Celular</h5>
												</div>

												<div class="col-md-3 col-xs-4 text-center">
													<i class="fal fa-phone-slash fa-2x">&nbsp; </i><span class="f17" id="TOTAL_CLIENTE_SMS_NAO"><?=fnValor($total_cliente_sms_nao,0)?> &nbsp;&nbsp;<span class="f12 c1"><?=fnValor($pct_sem_sms,2)?>%</span></span>  
	...
	<script type="text/javascript">
		...
		parent.$("#conteudoAba").css("height","200vh");
