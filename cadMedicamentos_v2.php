...
<script type="text/javascript">
	...
	function reloadPage(idPage) {
		...
		$.ajax({
			type: "POST",
			url: "ajxListaMedicamentos.do?opcao=paginar&idPage=" + idPage + "&itens_por_pagina=<?php echo $itens_por_pagina; ?>",
					...
					action: function() {
						...
						$.confirm({
							...
							content: function() {
								var self = this;
								return $.ajax({
									url: "ajxListaMedicamentos.do?opcao=exportar&nomeRel=" + nome + "&id=<?php echo fnEncode($cod_empresa); ?>",
									data: $('#formulario').serialize(),
									method: 'POST'
