...
?>
										...
										<div class="col-lg-12">
											...
											<div class="no-more-tables">
												...
												<?php 
													...
													$sql = "SELECT US.COD_USUARIO, UV.NOM_FANTASI, US.NOM_USUARIO FROM USUARIOS US
															LEFT JOIN WEBTOOLS.UNIDADEVENDA UV ON UV.COD_UNIVEND = US.COD_UNIVEND
															WHERE US.COD_EMPRESA = $cod_empresa
															AND US.LOG_ESTATUS = 'S'
															AND (US.COD_EXCLUSA IS NULL OR US.COD_EXCLUSA = 0) ORDER BY TRIM(US.NOM_USUARIO)";
													  ...
													  {														  
														...
														echo"
															<tr>
															  ...
															  <td>".$qrListaUsu['COD_USUARIO']."</td>
															  <td>".$qrListaUsu['NOM_FANTASI']."</td>
															  <td>".$qrListaUsu['NOM_USUARIO']."</td>

															</tr>
															<input type='hidden' id='ret_COD_USUARIO_".$count."' value='".fnEncode($qrListaUsu['COD_USUARIO'])."'>
															"; 
														  }											
	...
	<script type="text/javascript">
		...
		function retornaForm(index){
			...
			$('#formLista').attr('action', 'action.do?mod=<?php echo $DestinoPg; ?>&id=<?php echo fnEncode($cod_empresa); ?>&idU='+$("#ret_COD_UNIVEND_"+index).val());				
			$('#formLista').submit();	
