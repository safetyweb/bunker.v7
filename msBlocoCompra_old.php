...
$qtd_email = fnLimpaCampoZero($_REQUEST['QTD_EMAIL']);
$qtd_sms = fnLimpaCampoZero($_REQUEST['QTD_SMS']);
$qtd_wpp = fnLimpaCampoZero($_REQUEST['QTD_WPP']);
...
?>
  ...
  <div class="col-md-6">
    ...
    <h4>Detalhes da Venda <small>(Nº <?php echo 0; ?>)</small></h4>
    <div class="push20"></div>
    ...
    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control leituraOff" readOnly="readonly" name="NOM_CLIENTE" id="NOM_CLIENTE" tabindex="1" value="">
      </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control text-center leituraOff calcula money" name="VAL_DISPONIVEL" id="VAL_DISPONIVEL" tabindex="1" value="">
      </div>
...
// where usuarios.COD_EMPRESA = $cod_empresa AND COD_UNIVEND='$COD_UNIVEND'
...
?>					
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="form-group">
        ...
        <input type="text" class="form-control text-center calcula money"  name="VAL_RESGATE" id="VAL_RESGATE" tabindex="1" value="0,00" required >
      </div>
    </div>
...
?>					
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <a class="tile tile-info tile-valign">
        <div id="total_de_produtos"><?php echo fnValor(0, 2); ?></div>
        <input type="hidden" name="total_de_produtos" class="total_de_produtos" value="<?php echo fnValor(0, 2); ?>">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <a class="tile tile-primary tile-valign">
        <div id="total_da_venda"><?php echo fnValor((0), 2); ?></div>
        <input type="hidden" name="total_da_venda" class="total_da_venda" value="<?php echo fnValor(0, 2); ?>">
...
<!--<a href="" name="HOME2" id="HOME2" class="btn btn-info btn-lg btn-block" tabindex="5"><i class="fa fa-1x fa-home" aria-hidden="true"></i>&nbsp; Voltar Menu Principal </a>-->
      <a href="action.do?mod=<?php echo fnEncode(1240); ?>&id=<?php echo fnEncode($cod_empresa); ?>" name="HOME3" id="HOME3" class="btn btn-info btn-lg btn-block" tabindex="5"><i class="fa fa-1x fa-home" aria-hidden="true"></i>&nbsp; Voltar Menu Principal </a>
...
<input type="hidden" name="COD_ORCAMENTO" id="COD_ORCAMENTO" value="<?php echo 0; ?>">
