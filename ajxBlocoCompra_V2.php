...
$canal = 5;
//$teste = 1;
include './totem/cadastroClienteAtendente.php';
// CONSULTA NO INCLUDE RETORNA COD_CLIENTE UTILIZADO NA LINHA 89

// fnEscreve($cod_cliente);


//busca dados do cliente
$sql = "SELECT NOM_CLIENTE, NUM_CARTAO, NUM_CGCECPF, COD_CLIENTE FROM CLIENTES where COD_CLIENTE = $cod_cliente AND COD_EMPRESA = $cod_empresa ";
//fnEscreve($sql);
...
$cpf = $qrBuscaCliente['NUM_CGCECPF'];
...
if($cpf==0){$disable='readonly';}else{$disable='';} 
		...
		?>
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="form-group">
		                ...
		                <input type="text" class="form-control text-center" name="DES_CUPOM" id="DES_CUPOM" tabindex="1">
					</div>
				</div>
